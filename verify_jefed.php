            ...
            <div class="card-body">
                <div class="row d-flex my-auto">
                    <div class="col-md-12">
                        ...
                        <form action="scripts/ajax_jefed.php" method="post" enctype="multipart/form-data"
                            ...
                            <div id="steps-container">
                                        ...
                                        <div class="table-responsive" id="zoneTableWrapper">
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>ई-मेल आई.डी.</th>
                                                    <th>पता</th>
                                                    <th>शाखाओं की फोटो GPS टैग के संलग्न करें</th>
                                                </tr>
                                                </thead>
                                                <tbody id="zoneTbody">
                                                <?php
                                        ...
                                        <div class="table-responsive" id="prakhandTableWrapper">
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>ई-मेल आई.डी.</th>
                                                    <th>पता</th>
                                                    <th>अन्य कार्यालयों की फोटो GPS टैग के संलग्न करें</th>
                                                </tr>
                                                </thead>
                                ...
                                <!-- <div class="step"> -->
                                    ...
                                    $posts = [];
                                    $sql_posts = "SELECT * FROM master_des_jefed ORDER BY post_name ASC";
                            ...
                            <div id="success">
                                ...
                                <div class="col-sm-12 form-group my-auto" id="send_otp_button2" style="display: none">
                                    <button type="button" name="verify_otp_btn" id="verify_otp_btn"
                                            ...
                                            onClick="verify_otp_jefed($('#survey_id').val());">आगे प्रेषित करे
                                    </button>
                                </div>
                            </div>
                    </div>
...
<script>
    function save_draft() {
        ...
        data.append('id', 'submit_form_upcldf');
        data.append('term', 'b');
