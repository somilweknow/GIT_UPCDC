...
<div class="row">
                        ...
                        <form action="scripts/ajax_pcu.php" method="post" enctype="multipart/form-data" id="user_form"
                            ...
                            <div id="steps-container">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 form-group" id="committee_date_section"
                                                ...
                                                <input readonly type="date" name="committee_date" id="committee_date"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 form-group" id="liquidation_date_container"
                                                ...
                                                <input readonly type="date" tabindex="<?php echo $tab++; ?>"
                                            ...
                                            <div class="col-sm-3 form-group" id="liquidation_status"
                                                ...
                                                <input readonly type="text" tabindex="<?php echo $tab++; ?>"
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 form-group">
                                                        ...
                                                        <input readonly type="text" id="global_prakhand_count"
                                                            class="form-control"
                                            ...
                                            <table class="table table-bordered" id="officeContainer"
                                                ...
                                                <tbody class="office-block" data-zone-index="1"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 5px;">
                                                            <input readonly type="file" name="zone_image[]" class="form-control zone-image-input" onchange="previewImage(this)">
                                                            <img src="" class="zone-preview" style="max-height:60px;margin-top:5px;display:none;">
                                                            <input readonly type="hidden" name="zone_image_old[]" class="zone-image-old">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <table class="table table-bordered" id="prakhandContainer"
                                                ...
                                                <tbody id="prakhand-main-tbody">
                                                    <tr class="prakhand-row-template">
                                                        ...
                                                        <td>
                                                            <input readonly type="file" name="prakhand_image[]" class="form-control" onchange="previewImage(this)">
                                                            <img src="" class="zone-preview" style="max-height:60px;margin-top:5px;display:none;">
                                                            <input readonly type="hidden" name="prakhand_image_old[]" class="prakhand-image-old">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <table class="table table-bordered" id="otherOfficeContainer"
                                                ...
                                                <tbody id="other-office-main-tbody">
                                                    <tr class="other-office-row-template">
                                                        ...
                                                        <td>
                                                            <input readonly type="file" name="other_office_image[]" class="form-control" onchange="previewImage(this)">
                                                            <img src="" class="zone-preview" style="max-height:60px;margin-top:5px;display:none;">
                                                            <input readonly type="hidden" name="other_office_image_old[]" class="other-image-old">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <input readonly type="text" name="lifetime_member" id="lifetime_member"
                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                                    value="<?php echo $row_invoice['lifetime_member']; ?>">
                                          </div>
                                            <div class="col-sm-3 form-group">
                                                <label><b>(II) नाम-मात्रिक सदस्य</b></label>
                                                <input readonly type="text" name="nominal_member" id="nominal_member"
                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                                    value="<?php echo $row_invoice['nominal_member']; ?>">
                                            </div>
                                            <div class="col-sm-3 form-group">
                                                <label><b>(III) कृषक सदस्य की संख्या</b></label>
                                                <input readonly type="text" name="membership_fee" id="membership_fee"
                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                            ...
                                            <tbody>
                                                ...
                                                for ($i = 0; $i < 3; $i++) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select readonly name="sec_3_profit_loss_<?= $i + 1 ?>"
                                                                class="form-control"
                                                        ...
                                                        <td><input readonly type="text" name="sec_3_gross_amount_<?= $i + 1 ?>"
                                                                class="form-control chk_decimal"></td>
                                                        <td><input readonly type="text" name="sec_3_net_amount_<?= $i + 1 ?>"
                                                                class="form-control chk_decimal"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>संचित लाभ/हानि</td>
                                                        <td>
                                                            <select readonly name="sec_3_accumulated_<?= $i + 1 ?>"
                                                                class="form-control"
                                                                onchange="handleDropdownColorChange(this,'profit','#42ecf5','loss','#f28546');">
                                                                <option value="">--Select--</option>
                                                                <option value="profit">लाभ</option>
                                                        ...
                                                        <td><input readonly type="text" name="sec_3_acc_gross_amount_<?= $i + 1 ?>"
                                                                class="form-control chk_decimal"></td>
                                                        <td><input readonly type="text" name="sec_3_acc_net_amount_<?= $i + 1 ?>"
                                                                class="form-control chk_decimal"></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                ...
                                <!-- <div class="step"> -->
                                            ...
                                            <table class="table table-bordered table-striped" id="other_business_table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="business_matrix_row" id="business_row_<?php echo $i; ?>">
                                                        ...
                                                        <td>
                                                            <input readonly type="text" name="sec_2_1_2_value_<?php echo $i; ?>"
                                                                id="sec_2_1_2_value_<?php echo $i; ?>"
                                                                class="form-control chk_decimal"
                                                                value="<?php echo $row_2_1_2['sec_2_1_2_value_' . $i]; ?>">
                                                        </td>
                                                        <td>
                                                            <select readonly name="sec_2_1_2_profit_loss_<?php echo $i; ?>"
                                    ...
                                    <script>
                                        ...
                                        <tr class="business_matrix_row">
                                            <td>
                                                <select readonly name="sec_2_1_2_business_description_${id}" class="form-control">
                                                    <option value="">--select--</option>
                                                    <option value="cattle_feed">कैटल फीड</option>
                                                    <option value="any_other">अन्य</option>
                                                </select>
                                            </td>
                                            <td><input readonly type="text" name="sec_2_1_2_value_${id}" class="form-control chk_decimal"></td>
                                            <td>
                                                <select readonly name="sec_2_1_2_profit_loss_${id}" class="form-control">
                                                    <option value="">--select--</option>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <input readonly type="hidden" id="sec_6_2_id" value="<?php echo $count_6_2; ?>">                                        <div class="table-responsive">
                                                ...
                                                <tbody id="sec_6_2_tbody">
                                                    ...
                                                    ?>
                                                        <tr id="sec_6_2_row_<?php echo $i; ?>">
                                                            <td>
                                                                <select readonly name="sec_6_2_category_<?php echo $i; ?>" class="form-control"
                                                                ...
                                                                <div style="display:none;">
                                                                    ...
                                                                    <input readonly type="text" name="sec_6_2_post_name_<?php echo $i; ?>" id="sec_6_2_post_name_<?php echo $i; ?>"
                                                                    ...
                                                                    <select readonly name="sec_6_2_election_year_<?php echo $i; ?>" id="sec_6_2_election_year_<?php echo $i; ?>"
                                                                        class="form-control">
                                                                        <option value="">--Select--</option>
                                                                        <?php
                                                                        for ($y = 2022; $y >= 1975; $y--) {
                                                            ...
                                                            <td>
                                                                <select readonly name="sec_6_2_designation_<?php echo $i; ?>" class="form-control"
                                                                    onchange="color_change(this, 'yes', '#42ecf5', 'no', '#f28546');">
                                                                    <option value="">--select-- </option>
                                                            ...
                                                            <td>
                                                                <input readonly type="text" name="sec_6_2_name_<?php echo $i; ?>" id="sec_6_2_name_<?php echo $i; ?>"
                                                                    class="form-control"
                                                                    value="<?php echo isset($row_6_2['sec_6_2_name_' . $i]) ? $row_6_2['sec_6_2_name_' . $i] : ''; ?>">
                                                            </td>
                                                            <td>
                                                                <input readonly type="text" name="sec_6_2_father_name_<?php echo $i; ?>" id="sec_6_2_father_name_<?php echo $i; ?>"
                                                                    class="form-control"
                                                                    value="<?php echo isset($row_6_2['sec_6_2_father_name_' . $i]) ? $row_6_2['sec_6_2_father_name_' . $i] : ''; ?>">
                                                            </td>
                                                            <td>
                                                                <input readonly type="text" name="sec_6_2__mob_no_<?php echo $i; ?>" id="sec_6_2__mob_no_<?php echo $i; ?>"
    ...
    <script>
        function add_more_business() {
            ...
            var txt = '<div class="row" id="business_row_' + id + '">' +
                ...
                '<select readonly name="sec_2_1_2_profit_loss_' + id + '" id="sec_2_1_2_profit_loss_' + id + '" class="form-control">' +
                '<option value="">--select--</option>' +
                '<option value="लाभ">लाभ</option>' +
                '<option value="हानि">हानि</option>' +
                '</select>' +
       ...
       function sec_3_c_add_rowss() {
        ...
        var txt = '<div class="row mb-2 sec3c_row">' +
            ...
            '<div class="col-sm-2 form-group"><label>क्षेत्रफल (हेक्टेयर में)</label><input readonly type="text" name="sec_3_c_area_' + id + '" class="form-control"></div>' +
            '<div class="col-sm-2 form-group"><label>स्थान (समिति प्रांगण या अन्य स्थान)</label><select readonly name="sec_3_c_land_location_' + id + '" class="form-control"><option value="">--select--</option><option value="inpremise">समिति प्रांगण</option><option value="other">अन्य स्थान</option></select></div>' +
            '<div class="col-sm-2 form-group"><label>पहुच मार्ग का प्रकार</label><select readonly name="sec_3_c_paved_road_' + id + '" class="form-control"><option value="">--select--</option><option value="ordinary">कच्ची सड़क</option><option value="nh">नेशनल हाईवे</option><option value="sh">स्टेट हाईवे</option><option value="mdr">एम.डी.आर.</option><option value="odr">ओ.डी.आर.</option><option value="rural_road">ग्रामीण सड़क</option><option value="other">अन्य</option></select></div>' +
            '<div class="col-sm-2 form-group"><label>संस्था का फोटो GPS टैग के साथ संलग्न करे</label><input readonly type="file" name="sec_3_c_image_' + id + '" class="form-control"></div>' +
    ...
    <script>
        ...
        function sec_2_b_add_rows() {
            ...
            var row = '<tr><td>' + id + '</td><td><select readonly name="sec_2_b_type_' + id + '" id="sec_2_b_type_' + id + '" class="form-control"><option value="">Select</option><option value="शाखा">शाखा</option><option value="ट्रैनिंग सेंटर">ट्रैनिंग सेंटर</option><option value="जनपदीय कार्यालय">जनपदीय कार्यालय</option><option value="क्षेत्रीय कार्यालय">क्षेत्रीय कार्यालय</option><option value="अन्य कार्यालय">अन्य कार्यालय</option></select></td><td><input readonly type="text" name="sec_2_b_name_' + id + '" id="sec_2_b_name_' + id + '" class="form-control"></td><td><input readonly type="text" name="sec_2_b_division_' + id + '" id="sec_2_b_division_' + id + '" class="form-control"></td><td><input readonly type="text" name="sec_2_b_district_' + id + '" id="sec_2_b_district_' + id + '" class="form-control"></td><td><input readonly type="text" name="sec_2_b_tehsil_' + id + '" id="sec_2_b_tehsil_' + id + '" class="form-control"></td><td><input readonly type="text" name="sec_2_b_address_' + id + '" id="sec_2_b_address_' + id + '" class="form-control"></td><td><input readonly type="text" name="sec_2_b_mobile_' + id + '" id="sec_2_b_mobile_' + id + '" class="form-control"></td><td><input readonly type="text" name="sec_2_b_email_' + id + '" id="sec_2_b_email_' + id + '" class="form-control"></td><td><input readonly type="text" name="sec_2_b_pincode_' + id + '" id="sec_2_b_pincode_' + id + '" class="form-control"></td><td><input readonly type="text" name="sec_2_b_latitude_' + id + '" id="sec_2_b_latitude_' + id + '" class="form-control"></td><td><input readonly type="text" name="sec_2_b_longitude_' + id + '" id="sec_2_b_longitude_' + id + '" class="form-control"></td><td class="sec_2_b_rows text-end"><button type="button" class="btn btn-info btn-sm" onclick="sec_2_b_add_rows();">नई पंक्ति जोड़ें [+]</button></td></tr>';
    ...
    <script>
        function sec_6_2_add_rows() {
            ...
            var html = '<tr id="sec_6_2_row_' + count + '">' +
                ...
                '<td>' +
                '<select readonly name="sec_6_2_category_' + count + '" class="form-control">' +
                '<option value="">--select--</option>' +
                ...
                '<div style="display:none;">' +
                '<label>पद का नाम</label>' +
                '<input readonly type="text" name="sec_6_2_post_name_' + count + '" id="sec_6_2_post_name_' + count + '" class="form-control">' +

                '<label>निर्वाचन का वर्ष</label>' +
                '<select readonly name="sec_6_2_election_year_' + count + '" id="sec_6_2_election_year_' + count + '" class="form-control">' +
                '<option value="">--Select--</option>' +
                yearOptions +
                '</select>' +
                '</div>' +
                ...
                '<td>' +
                '<select readonly name="sec_6_2_designation_' + count + '" class="form-control">' +
                '<option value="">--select--</option>' +
                ...
                '<td>' +
                '<input readonly type="text" name="sec_6_2_name_' + count + '" id="sec_6_2_name_' + count + '" class="form-control">' +
                '</td>' +

                '<td>' +
                '<input readonly type="text" name="sec_6_2_father_name_' + count + '" id="sec_6_2_father_name_' + count + '" class="form-control">' +
                '</td>' +

                '<td>' +
                '<input readonly type="text" name="sec_6_2__mob_no_' + count + '" id="sec_6_2__mob_no_' + count + '" class="form-control" maxlength="10">' +
                '</td>' +
        ...
        function add_more_business() {
            ...
            var html = '<tr class="business_matrix_row" id="business_row_' + count + '">' +
                '<td>' +
                '<select readonly name="sec_2_1_2_business_description_' + count + '" id="sec_2_1_2_business_description_' + count + '" class="form-control">' +
                '<option value="">--select--</option>' +
                '<option value="cattle_feed">कैटल फीड</option>' +
                '<option value="any_other">अन्य</option>' +
                '</select>' +
                '</td>' +
                '<td>' +
                '<input readonly type="text" name="sec_2_1_2_value_' + count + '" id="sec_2_1_2_value_' + count + '" class="form-control chk_decimal">' +
                '</td>' +
                '<td>' +
                '<select readonly name="sec_2_1_2_profit_loss_' + count + '" id="sec_2_1_2_profit_loss_' + count + '" class="form-control">' +
                '<option value="">--select--</option>' +
                '<option value="लाभ">लाभ</option>' +
                '<option value="हानि">हानि</option>' +
                '</select>' +
    ...
    <script>
        ...
        function sec_6_2_add_rows_prefill(data){
            ...
            var html = '<tr id="sec_6_2_row_'+count+'">'+
                ...
                '<td>'+
                '<input readonly type="text" name="sec_6_2_name_'+count+'" class="form-control">'+
                '</td>'+

                '<td>'+
                '<input readonly type="text" name="sec_6_2_father_name_'+count+'" class="form-control">'+
                '</td>'+

                '<td>'+
                '<input readonly type="text" name="sec_6_2__mob_no_'+count+'" class="form-control">'+
                '</td>'+
