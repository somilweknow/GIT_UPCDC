			...
			<div class="card-body">
				<div class="row d-flex my-auto">
					<div class="col-md-12">
						...
						<form action="scripts/ajax_upcldf.php" method="post" enctype="multipart/form-data" id="user_form"
							name="user_form">
							<div id="steps-container">
								...
								<div class="step">
										...
										<h5> <img src="images/logo/2.png" alt="text" class="img-fluid stat-icon"
												style="height:50px; width:50px;"> 1.1 शीर्ष समिति के कार्यालय </h5><br>
										<div class="row">
											<div class="col-sm-12">
												<table class="table table-bordered table-striped table-hover" id="contact_table">
													<thead>
														<tr>
															<th>स०</th>
															<th>नाम</th>
													...
													<tbody id="contact_rows">
														<?php 
														$i = 1;
														foreach ($contact_rows as $r): 
														?>
														<tr id="contact_row_<?php echo $i; ?>">
															<td><?php echo $i; ?></td>
															<td><input type="text" name="contact_name[]" class="form-control" value="<?php echo htmlspecialchars($r['name']); ?>"></td>
															<td>
																<select class="form-control" name="division_id[]">
																	...
																	while ($data = mysqli_fetch_array($run)) {
																		$selected = ($r['division_id'] == $data['s_no']) ? 'selected' : '';
															...
															<td style="min-width:250px;">
																<?php
																$selected_districts = !empty($r['district_ids']) ? explode(',', $r['district_ids']) : [];
																?>
																<select class="form-control" name="district_name[<?php echo $i;?>][]" id="district_name_<?php echo $i;?>" multiple size="6" tabindex="<?php echo $tab++; ?>">
																<?php
																$query = "SELECT * FROM master_district ORDER BY district_name";
																$run = mysqli_query($db, $query);
																while ($data = mysqli_fetch_array($run)) {
																	$sel = in_array($data['s_no'], $selected_districts) ? ' selected="selected"' : '';
																	echo '<option value="' . $data['s_no'] . '"' . $sel . '>' . htmlspecialchars($data['district_name']) . '</option>';
																}
																?>
																</select>
															</td>
															<td><input type="text" name="address[]" class="form-control" value="<?php echo htmlspecialchars($r['address']); ?>"></td>
															<td><input type="text" name="mobile[]" class="form-control" value="<?php echo htmlspecialchars($r['mobile']); ?>"></td>
															<td><input type="text" name="email[]" class="form-control" value="<?php echo htmlspecialchars($r['email']); ?>"></td>
															<td><input type="text" name="pincode[]" class="form-control" value="<?php echo htmlspecialchars($r['pincode']); ?>"></td>
															<td><input type="text" name="latitude[]" class="form-control" value="<?php echo htmlspecialchars($r['latitude']); ?>"></td>
															<td><input type="text" name="longitude[]" class="form-control" value="<?php echo htmlspecialchars($r['longitude']); ?>"></td>
														</tr>
														<?php $i++; endforeach; ?>
													</tbody>
												</table>
												...
												<div class="row">
													<div class="col-md-12">
														<button type="button" class="btn btn-info" onclick="addContactRow()">नई पंक्ति जोड़े [+]</button>
														<input type="hidden" id="contact_row_count" value="<?php echo count($contact_rows); ?>">
													</div>
												</div>
											</div>
										</div>
									...
									<h5><img src="images/logo/7.png" alt="text" class="img-fluid stat-icon"
											style="height:50px; width:50px;"> 3.1 प्रबंध कमेटी</h5>
									<div class="col-sm-12">
                                        <div class="row">
									...
									<h4><img src="images/logo/3.png" alt="text" class="img-fluid stat-icon"
											style="height:50px; width:50px;"> 3.2 वित्तीय सूचना</h4>
									<div class="col-sm-12">
                                        <div class="row">
                                            <div class="col-sm-3 form-group">
									...
									<div class="col-sm-12">
										<div class="table-responsive">
											<table class="table table-bordered table-striped">
												<thead>
													<tr>
														<th rowspan="2">क्रं.</th>
														<th rowspan="2">पद</th>
														<th rowspan="2">स्वीकृत पद</th>
														<th rowspan="2">रिक्त पद</th>
														<th colspan="2">कार्यरत का विवरण</th>
														<th colspan="2">संविदा/आउट्सोर्स पर कार्यरत कार्मिक</th>
														<th></th>
													</tr>
													<tr>
														<th>नाम</th>
												...
												<tbody>
													<?php
													$sql = "SELECT * FROM master_post_upcldf ORDER BY id ASC";
													...
													?>
														<tr>
															...
															<td><input type="text" class="form-control" name="sanctioned_post[<?php echo $row['id']; ?>]" value="<?php echo htmlspecialchars($sanctioned_post); ?>"></td>
															<td><input type="text" class="form-control" name="vacant_post[<?php echo $row['id']; ?>]" value="<?php echo htmlspecialchars($vacant_post); ?>"></td>
															<td><input type="text" class="form-control" name="working_name[<?php echo $row['id']; ?>]" value="<?php echo htmlspecialchars($working_name); ?>"></td>
															<td><input type="text" class="form-control" name="working_period[<?php echo $row['id']; ?>]" value="<?php echo htmlspecialchars($working_period); ?>"></td>
															<td><input type="text" class="form-control" name="contract_no[<?php echo $row['id']; ?>]" value="<?php echo htmlspecialchars($contract_no); ?>"></td>
															<td><input type="text" class="form-control" name="contract_name[<?php echo $row['id']; ?>]" value="<?php echo htmlspecialchars($contract_name); ?>"></td>
														</tr>
													<?php } ?>
												</tbody>
											</table>
...
<script>
	function addContactRow() {
		let id = parseInt($("#contact_row_count").val());
		if (isNaN(id)) id = 0;
		id++;

		let divisionOptions = $($("#contact_rows select[name='division_id[]']:first")).html();
		let districtOptions = $($("#contact_rows select[multiple]:first")).html();

		let newRow = `
		<tr id="contact_row_${id}">
			<td>${id}</td>
			...
			<td>
				<select class="form-control" name="district_ids_${id}[]" multiple>
					${districtOptions}
				</select>
			</td>
		...
		$("#contact_rows").append(newRow);
		$("#contact_row_count").val(id);
	}
...
<script type="text/javascript" src="js/multistepform_upcldf.js?v=1">
