...
if(isset($_POST['district_name'])) {
	...
	if($msg==''){
		if($_POST['edit_sno']!=''){
			$sql = 'update master_district set 
			...
			$sql = 'insert into master_district (district_name, division_id, created_by, creation_time) values ("'.$_POST['district_name'].'", "'.$_POST['division_name'].'", "'.$_SESSION['username'].'", "'.date("Y-m-d H:i:s").'")';	
		}
...
if(isset($_GET['id'])){
	$sql = 'select * from master_district where sno='.$_GET['id'];
	$data = mysqli_fetch_assoc(execute_query($sql));
	$_POST['district_name']=$data['district_name'];
...
if(isset($_GET['del'])){
	...
	if(mysqli_num_rows($data)!=0){
		...
		$sql = 'delete from master_district where sno='.$_GET['del'];
		$data = execute_query($sql);
									...
									<div class="row">
										<div class="col-md-4 pr-1">
											<div class="form-group">
												...
												<input type="text" name="district_name" id="district_name" tabindex="<?php echo $tab++; ?>" class="form-control" placeholder="District Name" value="<?php echo $_POST['district_name']; ?>">
											</div>
										</div>
										<div class="col-md-4 pr-1">
											<div class="form-group">
												...
												<select name="division_name" id="division_name" tabindex="<?php echo $tab++; ?>" class="form-control">
													...
													while($row_division = mysqli_fetch_assoc($result_divison)){
														...
														if($_POST['division_name']==$row_division['sno']){
                            ...
                            <div class="card strpied-tabled-with-hover">
								...
								<table class="table table-hover table-striped">
									<thead>
										<?php
											$i=1;
											$sql = 'select master_district.sno as sno, district_name, division_name from master_district left join master_division on master_division.sno = division_id where 1=1';
											if(isset($_POST['submit'])){
												//print_r($_POST);
												if($_POST['dis_name']!='ALL'){
													$sql .= ' and `district_name` ="'.$_POST['dis_name'].'"';
												}
												...
												<div class="form-group">
													<label>District Name</label>
														...
														while($row_district = mysqli_fetch_assoc($result_district)){
															echo '<option value="'.$row_district['district_name'].'" ';														
