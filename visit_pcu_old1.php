				...
				<div class="card-body">
					<div class="row d-flex my-auto">
						<div class="col-md-12">
							...
							<form action="scripts/ajax_pcu.php" method="post" enctype="multipart/form-data" id="user_form" name="user_form">
							<?php echo $msg; ?>
                            <div id="steps-container">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <select name="liquidation" id="sec_1_liquidation"
                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                            ...
                                            <div class="col-sm-3 form-group">
                                                <label>क्या समिति पर स्वामित्व को लेकर कोई वाद (Litigation)
                                                    सिविल न्यायालय में विचाराधीन हैं?</label>
                                                <select name="sec_new_new_litigation"
                                                    ...
                                                    <option value="">--Select--</option>
                                                    <option value="yes" <?php echo ($row_new_plot['sec_new_new_litigation'] == 'yes') ? ' selected="selected"' : ''; ?>
                                                        style="background:#0f0">हाँ</option>
                                                    <option value="no" <?php echo ($row_new_plot['sec_new_new_litigation'] == 'no') ? ' selected="selected"' : ''; ?>
                                                        style="background:#f00">नहीं</option>
                                                </select>
                                            </div>

                                            <div class="col-sm-3 form-group"
                                                id="sec_new_new_dispute_details" style="display: none;">
                                                <label>विवाद का विवरण</label>
                                                <label><small>कृपया अधिकतम 200 शब्दों मे अपनी बात
                                                        रखे</small></label>
                                                <textarea name="sec_new_new_dispute_details"
                                                    tabindex="<?php echo $tab++ ?>"
                                                    id="sec_new_new_dispute_details"
                                                    class="form-control"><?php echo $row_new_plot['sec_new_new_dispute_details'] ?></textarea>
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3 form-group">
                                                <input type="text" name="total_members" id="total_members"
                                                    tabindex="<?php echo $tab++; ?>" class="form-control" readonly
                                                    value="<?php echo $row_invoice['total_members']; ?>">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <small><b>सदस्य समितियों कि सूची</b></small>
                                            <div class="col-sm-12">
                                ...
                                <div class="step">
										<h4> <img src="images/logo/4.png" alt="text" class="img-fluid stat-icon"
												style="height:50px; width:50px;"> 2. e-Dead Stock Register(ई-डेड स्टॉक
											रजिस्टर)</h4>
										<div class="row">
                                ...
                                <div class="step">
                                    <h4><img src="images/logo/3.png" class="img-fluid stat-icon"
                                            style="height:50px; width:50px;"> 4 वित्तीय सूचना</h4>
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <div class="col-sm-3 form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-2 form-group" id="sec_2_dividend_per">
                                                <label>कुल आय (लाख मे)</label>
                                                <input type="text" name="sec_3_dividend_per" id="sec_3_dividend_per"
                                                    tabindex="<?php echo $tab++; ?>" class="form-control chk_decimal"
                                                    data-type="7.III लाभांश को प्रतिशत मे भरे"
                                                    value="<?php echo $row_3_new_1['sec_3_dividend_per']; ?>">
                                            </div>
                                            <div class="col-sm-2 form-group" id="sec_2_dividend">
                                                <label>कुल व्यय (लाख मे)</label>
                                                <input type="text" name="sec_3_dividend_amt" id="sec_3_dividend_amt"
                                                    tabindex="<?php echo $tab++; ?>" class="form-control chk_decimal"
                                                    data-type="7.III लाभांश को धनराशि रु० लाख मे भरे"
                                                    value="<?php echo $row_3_new_1['sec_3_dividend_amt']; ?>">
                                ...
                                <div class="step">
                                    <h4><img src="images/logo/4.png" class="img-fluid stat-icon"
                                            style="height:50px; width:50px;"> 5. अन्य कार्य व व्यवसाय</h4>
                                    ...
                                    <div class="col-sm-12">
                                        <h5>
                                            6. सहकारी प्रबंध प्रशिक्षण केंद्र
                                        </h5>
                                ...
                                <div class="step">
                                    <h4><img src="images/logo/11.png" alt="text" class="img-fluid stat-icon"
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="row" id="sec_3" style="display: <?php echo $sec_3_display; ?>;">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3 form-group">
                                                                <label>समिति भूखंड की फोटो संलग्न करें</label>
                                                                <input type="file" accept=".jpg, .jpeg, .gif, .png, .bmp" name="society_photo"
                                                                    id="society_photo" tabindex="<?php echo $tab++; ?>" class="form-control">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3 form-group">
                                                    <label>खली पड़ी भूमि में हरे पेड़ो कि संख्या</label><input
                                                        type="text" name="sec_3_a_land_chauhaddi_south"
                                                        id="sec_3_a_land_chauhaddi_south"
                                                        tabindex="<?php echo $tab++; ?>" class="form-control"
                                                        value="<?php echo $row_3_1['south_side']; ?>">
                                                ...
                                                <div class="col-sm-3 form-group">
                                                    ...
                                                    <select name="sec_3_d_boundry" id="sec_3_d_boundry"
                                                        ...
                                                        <option value="no" <?php echo $row_3_1['sec_3_d_boundry'] == 'no' ? ' selected="selected" ' : ''; ?>
                                                            style="background:#f00">नहीं</option>
                                                    </select>
                                                </div>
                                            </div>
								...
								<div class="step">
									...
									<div class="col-sm-12">
										<div class="row">
														...
														<div class="row">
															...
															<div class="col-sm-4 form-group">
																...
																<select name="sec_8_internet_bill_paid"
																	...
																	<option value="">--select-- </option>
																	<option style="background:#0f0" value="yes" <?php echo $row_8['sec_8_internet_bill_paid'] == 'yes' ? 'selected="selected"' : ''; ?>>हाँ</option>

																	<option style="background:#f00" value="no" <?php echo $row_8['sec_8_internet_bill_paid'] == 'no' ? 'selected="selected"' : ''; ?>>नहीं</option>
											...
											<h5>(V) रेन वाटर हारवेस्टिंग कि उपलब्धता</h5>
											<div class="col-sm-12">
												<div class="row">
													<div class="col-sm-2 form-group">
														<label>रेन वाटर हारवेस्टिंग</label>
														<select class="form-control" id="sec_8_toilet_available"
															...
															<option value="">--Select--</option>
															<option style="background:#0f0" value="yes" <?php echo $row_8['sec_8_toilet_available'] == 'yes' ? 'selected="selected"' : ''; ?>>हाँ</option>
															<option style="background:#f00" value="no" <?php echo $row_8['sec_8_toilet_available'] == 'no' ? 'selected="selected"' : ''; ?>>नहीं</option>
														</select>
													</div>
...
<script>
    ...
    function sec_3_c_add_rows() {
        ...
        // Create new row HTML
        var rowHtml = '<div class="row sec_3_b_row mb-2" id="sec_3_b_row_'+count+'"><div class="col-sm-2 form-group"><label>श्रेणी</label><select class="form-control" id="sec_3_b_category_'+count+'" name="category_'+count+'" onchange="hide_show(this.value, \'#sec_3_b_postname_'+count+'\', \'yes\'); hide_show(this.value, \'#sec_3_b_year_'+count+'\', \'no\')"><option value="">--Select--</option><option value="yes">पदेन</option><option value="no">निर्वाचित</option><option value="1">नामित</option></select></div><div class="col-sm-2 form-group" id="sec_3_b_postname_'+count+'" style="display:none;"><label>पद का नाम</label><input type="text" class="form-control" name="post_name_'+count+'" id="post_name_'+count+'"></div><div class="col-sm-2 form-group" id="sec_3_b_year_'+count+'" style="display:none;"><label>निर्वाचन का वर्ष</label><select class="form-control" name="year_'+count+'" id="year_'+count+'"><option value="">--Select--</option>'+yearOptions+'</select></div><div class="col-sm-2 form-group"><label>पदनाम</label><select class="form-control" name="designation_'+count+'" id="designation_'+count+'"><option value="">--Select--</option><option value="अध्यक्ष">अध्यक्ष</option><option value="उपाध्यक्ष">उपाध्यक्ष</option><option value="संचालक">संचालक</option></select></div><div class="col-sm-2 form-group"><label>नाम</label><input type="text" class="form-control" name="name_'+count+'" id="name_'+count+'"></div><div class="col-sm-2 form-group"><label>पिता / पति का नाम</label><input type="text" class="form-control" name="father_'+count+'" id="father_'+count+'"></div><div class="col-sm-2 form-group"><label>मोबाईल नंबर</label><input type="text" class="form-control chk_mobile" name="mobile_'+count+'" id="mobile_'+count+'" maxlength="10"></div><div class="col-sm-2 form-group my-auto"><button type="button" class="btn btn-info" onclick="sec_3_c_add_rows()">नई पंक्ति जोड़े [+]</button></div></div>';
