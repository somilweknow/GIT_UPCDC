                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-2 form-group">
                                                                ...
                                                                <input type="date" name="sec_1_society_registration_date" id="sec_1_society_registration_date" tabindex="<?php echo $tab++; ?>" class="form-control" value="<?php echo $row_invoice['sec_1_society_registration_date']; ?>">
                                                            </div>
...
<script>
    function show_sides_of_land(val) {
        var container = document.getElementById('sides_display');
        ...
        var colSize = Math.ceil(12 / count);
        
        var html = '';
        for(var i=1; i<=count; i++) {
            html += '<div class="col-sm-' + colSize + ' form-group">';
            html += '<label>भुजा ' + i + ' की लम्बाई</label>';
            html += '<input type="text" name="sec_3_a_side_' + i + '" id="sec_3_a_' + i + '" class="form-control" value="">';
            html += '</div>';
        }
...
<script type="text/javascript" src="js/multistepform_handloom.js?v=1"></script>
