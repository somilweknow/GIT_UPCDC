...
$sql = "SELECT * FROM apex_work_profession_info WHERE survey_id='" . $row_invoice['sno'] . "'";
                        ...
                        <form action="scripts/ajax_upss.php" method="post" enctype="multipart/form-data" id="user_form"
                            ...
                            <div id="steps-container">
                                ...
                                <div class="step">
                                    ...
                                    <div class="col-sm-12">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        ...
                                                        <input readonly type="text" id="lat" disabled="disabled"
                                                            value="<?php echo $row_invoice['latitude']; ?>"
                                                            class="form-control">
                                                        <label>Longitude</label>
                                                        <input readonly type="text" id="long" disabled="disabled"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 form-group">
                                                <label>पैन न०</label>
                                                <input readonly type="text" name="pan_no" id="pan_no"
                                            ...
                                            <div class="col-sm-3 form-group">
                                                <label>टैन न०</label>
                                                <input readonly type="text" name="tan_no" id="tan_no"
                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                                    value="<?php echo ($row_invoice['tan_no'] ?? ''); ?>">
                                            </div>
                                            <div class="col-sm-3 form-group">
                                                <label>जी०एस०टी०एन० न०</label>
                                                <input readonly type="text" name="gst_no" id="gst_no"
                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                                    value="<?php echo ($row_invoice['gst_no'] ?? ''); ?>">
                                            </div>
                                            <div class="col-sm-3 form-group">
                                                <label>ई-मेल आई.डी.</label>
                                                <input readonly type="text" name="email_id" id="email_id"
                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                                    value="<?php echo ($row_invoice['email_id'] ?? ''); ?>">
                                            </div>
                                            <div class="col-sm-3 form-group">
                                                <label>दूरभाष न०</label>
                                                <input readonly type="text" name="mobile_number" id="mobile_number"
                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                                    value="<?php echo ($row_invoice['mobile_number'] ?? ''); ?>">
                                            </div>
                                            <div class="col-sm-3 form-group">
                                                <label>वेबसाइट</label>
                                                <input readonly type="text" name="website" id="website"
                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                            ...
                                            <?php if (!empty($row_invoice['photo_id'])) { ?>
                                                <div class="col-sm-2 form-group">
                                                    ...
                                                    <input readonly type="file" accept=".jpg, .jpeg, .gif, .png, .bmp"
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 form-group">
                                                        ...
                                                        <input readonly type="text" name="global_prakhand_count"
                                                    ...
                                                    <div class="col-md-3 form-group">
                                                        ...
                                                        <input readonly type="text" name="gas_service_count"
                                                    ...
                                                    <div class="col-md-3 form-group">
                                                        <label>4. यूनिट</label>
                                                        <input readonly type="text" name="unit_count" id="unit_count"
                                                            class="form-control"
                                                ...
                                                <tbody id="zoneTbody">
                                                    ...
                                                    if (!empty($zone_data)) {
                                                        foreach ($zone_data as $z) {
                                                            ...
                                                            ?>
                                                            <tr>
                                                                <td><input readonly type="text" name="zone_name[]"
                                                                        value="<?php echo $z['zone_name']; ?>"
                                                                        class="form-control"></td>

                                                                <td><input readonly type="text" name="zone_mobile[]"
                                                                        value="<?php echo $z['zone_mobile']; ?>"
                                                                        class="form-control"></td>

                                                                <td><input readonly type="text" name="zone_email[]"
                                                                        value="<?php echo $z['zone_email']; ?>"
                                                                        class="form-control"></td>

                                                                <td><input readonly type="text" name="zone_address[]"
                                                ...
                                                <tbody id="prakhandTbody">
                                                    ...
                                                    if (!empty($prakhand_data)) {
                                                        foreach ($prakhand_data as $p) {
                                                            ...
                                                            ?>
                                                            <tr>
                                                                <td><input readonly type="text" name="prakhand_name[]"
                                                                        value="<?php echo $p['prakhand_name']; ?>"
                                                                        class="form-control"></td>

                                                                <td><input readonly type="text" name="prakhand_mobile[]"
                                                                        value="<?php echo $p['prakhand_mobile']; ?>"
                                                                        class="form-control"></td>

                                                                <td><input readonly type="text" name="prakhand_email[]"
                                                                ...
                                                                <td>
                                                                    <input readonly type="file" name="prakhand_image[]"
                                                                        class="form-control">
                                                ...
                                                <tbody id="gasServiceTbody">
                                                    ...
                                                    if (!empty($gas_service_data)) {
                                                        foreach ($gas_service_data as $p) {
                                                            ...
                                                            ?>
                                                            <tr>
                                                                <td><input readonly type="text" name="gas_service_name[]"
                                                                        value="<?php echo $p['gas_service_name']; ?>"
                                                                        class="form-control"></td>

                                                                <td><input readonly type="text" name="gas_service_mobile[]"
                                                                        value="<?php echo $p['gas_service_mobile']; ?>"
                                                                        class="form-control"></td>

                                                                <td><input readonly type="text" name="gas_service_email[]"
                                                                        value="<?php echo $p['gas_service_email']; ?>"
                                                                        class="form-control"></td>

                                                                <td><input readonly type="text" name="gas_service_address[]"
                                                                        value="<?php echo $p['gas_service_address']; ?>"
                                                                        class="form-control"></td>

                                                                <td>
                                                                    <input readonly type="file" name="gas_service_image[]"
                                                                        class="form-control">
                                                ...
                                                <tbody id="unitTbody">
                                                    ...
                                                    if (!empty($unit_data)) {
                                                        foreach ($unit_data as $p) {
                                                            ...
                                                            ?>
                                                            <tr>
                                                                <td><input readonly type="text" name="unit_name[]"
                                                                        value="<?php echo $p['unit_name']; ?>"
                                                                        class="form-control"></td>

                                                                <td><input readonly type="text" name="unit_mobile[]"
                                                                        value="<?php echo $p['unit_mobile']; ?>"
                                                                        class="form-control"></td>

                                                                <td><input readonly type="text" name="unit_email[]"
                                                                        value="<?php echo $p['unit_email']; ?>"
                                                                        class="form-control"></td>

                                                                <td><input readonly type="text" name="unit_address[]"
                                                                        value="<?php echo $p['unit_address']; ?>"
                                                                        class="form-control">
                                                                </td>

                                                                <td>
                                                                    <input readonly type="file" name="unit_image[]" class="form-control">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select readonly name="sec_6_2_mgt_committee_is_elected"
                                            ...
                                            <div class="col-sm-3 form-group" id="election_year_block"
                                                ...
                                                <select readonly name="sec_6_2_election_year" id="sec_6_2_election_year"
                                                    class="form-control">
                                                    <option value="">--Select--</option>
                                                    <?php
                                                    for ($i = 2024; $i >= 1975; $i--) {
                                            ...
                                            <div class="col-sm-3 form-group" id="end_year_block" style="display:none;">
                                                ...
                                                <select readonly name="sec_6_2_end_year" id="sec_6_2_end_year"
                                                    class="form-control">
                                                    <option value="">--Select--</option>
                                                    <?php
                                                    for ($i = 2024; $i <= 2030; $i++) {
                                        ...
                                        <div id="sec_2_b">
                                            ...
                                            for ($i = 1; $i <= $row_6_2['count']; $i++) {
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3 form-group">
                                                        <label>नाम</label>
                                                        <input readonly type="text" name="sec_6_2_name_<?php echo $i; ?>"
                                                    ...
                                                    <div class="col-sm-3 form-group">
                                                        ...
                                                        <input readonly type="text" name="sec_6_2__mob_no_<?php echo $i; ?>"
                                        ...
                                        <input readonly type="hidden" name="sec_6_2_id" id="sec_6_2_id"
                                    ...
                                    <div id="staff_row_template" style="display:none;">
                                        <div class="staff_row border p-3 mb-3 rounded">
                                            <div class="row">
                                                <div class="col-md-3 form-group">
                                                    <label>पद</label>
                                                    <select readonly name="staff_post_name[]"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 form-group">
                                                    ...
                                                    <div style="display:flex; align-items:center; gap:10px;">
                                                        ...
                                                        <div style="flex:1;">
                                                            <input readonly type="file" name="staff_image[]"
                                                                class="form-control staff-image-input" accept="image/*">

                                                            <input readonly type="hidden" name="existing_staff_image[]"
                                ...
                                <!-- <div class="step"> -->
                                            ...
                                            <tbody id="sec_2_2_tbody">
                                                <?php for ($i = 1; $i <= $row_2_2['count']; $i++) { ?>
                                                    <tr id="sec_2_2_row_<?php echo $i; ?>">
                                                        <td>
                                                            <select readonly name="sec_2_2_year_<?php echo $i; ?>"
                                                        ...
                                                        <td>
                                                            <input readonly type="text" name="sec_2_2_amount_<?php echo $i; ?>"
                                                        ...
                                                        <td>
                                                            <input readonly type="text" name="sec_2_2_dept_supply_<?php echo $i; ?>"
                                                        ...
                                                        <td>
                                                            <input readonly type="text" name="sec_2_2_fert_sales_<?php echo $i; ?>"
                                                        ...
                                                        <td>
                                                            <input readonly type="text" name="sec_2_2_lpg_dist_<?php echo $i; ?>"
                                                        ...
                                                        <td>
                                                            <input readonly type="text" name="sec_2_2_cppl_anpl_<?php echo $i; ?>"
                                    ...
                                    <input readonly type="hidden" name="sec_2_2_id" id="sec_2_2_id"
                                            ...
                                            <tbody id="sec_2_3_tbody">
                                                <?php for ($i = 1; $i <= $row_2_3['count']; $i++): ?>
                                                    ...
                                                    <tr id="sec_2_3_row_lpg_<?= $i ?>">
                                                        <?php if ($i == 1): ?>
                                                            <td rowspan="4" class="align-middle text-center fw-bold"
                                                                ...
                                                                <select readonly name="sec_2_3_year_<?= $i ?>"
                                                                    id="sec_2_3_year_<?= $i ?>"
                                                        ...
                                                        <?php else: ?>
                                                            <td rowspan="4" class="align-middle text-center fw-bold"
                                                                id="sec_2_3_year_cell_<?= $i ?>">
                                                                <input readonly type="text" name="sec_2_3_year_<?= $i ?>"
                                                        ...
                                                        <?php endif; ?>
                                                        <td>एल०पी०जी०</td>
                                                        <td><input readonly type="text" name="sec_2_3_lpg_target_<?= $i ?>"
                                                                id="sec_2_3_lpg_target_<?= $i ?>"
                                                                class="form-control chk_number"
                                                                data-type="लक्ष्य अंकों में भरे"
                                                                value="<?= $row_2_3['sec_2_3_lpg_target_' . $i] ?>"></td>
                                                        <td><input readonly type="text" name="sec_2_3_lpg_business_<?= $i ?>"
                                                    ...
                                                    <tr id="sec_2_3_row_fert_<?= $i ?>">
                                                        <td>उर्वरक</td>
                                                        <td><input readonly type="text" name="sec_2_3_fert_target_<?= $i ?>"
                                                                id="sec_2_3_fert_target_<?= $i ?>"
                                                                class="form-control chk_number"
                                                                data-type="लक्ष्य अंकों में भरे"
                                                                value="<?= $row_2_3['sec_2_3_fert_target_' . $i] ?>"></td>
                                                        <td><input readonly type="text" name="sec_2_3_fert_business_<?= $i ?>"
                                                    ...
                                                    <tr id="sec_2_3_row_dept_<?= $i ?>">
                                                        ...
                                                        <td><input readonly type="text" name="sec_2_3_dept_target_<?= $i ?>"
                                                                id="sec_2_3_dept_target_<?= $i ?>"
                                                                class="form-control chk_number"
                                                                data-type="लक्ष्य अंकों में भरे"
                                                                value="<?= $row_2_3['sec_2_3_dept_target_' . $i] ?>"></td>
                                                        <td><input readonly type="text" name="sec_2_3_dept_business_<?= $i ?>"
                                                    ...
                                                    <tr id="sec_2_3_row_total_<?= $i ?>">
                                                        ...
                                                        <td><input readonly type="text" name="sec_2_3_total_target_<?= $i ?>"
                                                                id="sec_2_3_total_target_<?= $i ?>"
                                                                class="form-control chk_number"
                                                                data-type="लक्ष्य अंकों में भरे"
                                                                value="<?= $row_2_3['sec_2_3_total_target_' . $i] ?>"></td>
                                                        <td><input readonly type="text" name="sec_2_3_total_business_<?= $i ?>"
                                    ...
                                    <input readonly type="hidden" name="sec_2_3_id" id="sec_2_3_id"
                                        value="<?= $row_2_3['count'] ?>">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h5
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 form-group">
                                            ...
                                            <input readonly type="text" name="sec_3_gratuity_retired" class="form-control"
                                                value="<?php echo $row_3_new_1['sec_3_gratuity_retired']; ?>">
                                        </div>
                                        <div class="col-sm-3 form-group">
                                            <label>नकदीकरण (सेवानिवृत्त कर्मचारियों की)</label>
                                            <input readonly type="text" name="sec_3_encashment_retired" class="form-control"
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody id="sec_2_4_price_support">
                                                    ...
                                                    <?php for ($i = 1; $i <= $row_2_4['count']; $i++) { ?>
                                                        ...
                                                        <tr>
                                                            <td rowspan="3">
                                                                <input readonly type="text" name="sec_2_4_year_<?php echo $i; ?>"
                                                            ...
                                                            <?php if ($i == $row_2_4['count']) { ?>
                                                                ...
                                                                <td rowspan="3" class="text-center my-auto" id="sec_2_4_rows">
                                                                    ...
                                                                    <input readonly type="hidden" name="sec_2_4_id" id="sec_2_4_id"
                                                ...
                                                <tbody>
                                                    ...
                                                    for ($i = 1; $i <= $count; $i++) {
                                                        ...
                                                        <tr class="business_matrix_row">
                                                            <td>
                                                                <select readonly name="business_year_<?php echo $i; ?>"
                                                                    class="form-control">
                                                            ...
                                                            <td>
                                                                <input readonly type="text" name="business_target_<?php echo $i; ?>"
                                                                    class="form-control"
                                                            ...
                                                            <td class="text-center">
                                                                <?php if ($i == $count) { ?>
                                                                    <button type="button" class="btn btn-info btn-sm"
                                                                        ...
                                                                        [+]</button>
                                                                    <input readonly type="hidden" name="other_business_id"
                                                ...
                                                <div id="sec_3_c">
                                                    <?php for ($i = 1; $i <= $row_3_5['sec_3_c_id']; $i++) { ?>
                                                        <div class="row mb-2 sec3c_row">
                                                            ...
                                                            <div class="col-sm-2 form-group">
                                                                <label>जनपद</label>
                                                                <select readonly name="sec_3_c_district_<?php echo $i; ?>"
                                                                    class="form-control">
                                                            ...
                                                            <div class="col-sm-2 form-group">
                                                                ...
                                                                <input readonly type="file" name="sec_3_c_image_<?php echo $i; ?>"
                            ...
                            <div id="success">
                                ...
                                <div class="col-sm-12 form-group my-auto" id="send_otp_button2" style="display: none">
                                    <button type="button" name="verify_otp_btn" id="verify_otp_btn"
                                        ...
                                        onClick="verify_otp_upss($('#survey_id').val());">आगे प्रेषित करे
                                    </button>
                                </div>
                            </div>
                    </div>
...
<script>
    ...
    function add_more_business() {
        ...
        var txt = '<div class="row" id="business_row_' + id + '">' +
            ...
            '<select readonly name="sec_2_1_2_business_description_' + id + '" id="sec_2_1_2_business_description_' + id + '" class="form-control">' +
            '<option value="">--select--</option>' +
            ...
            '<input readonly type="text" name="sec_2_1_2_value_' + id + '" id="sec_2_1_2_value_' + id + '" class="form-control chk_decimal" data-type=" 7.3.I वार्षिक टर्नोवर को धनराशि रु० लाख मे भरे">' +
            '</div>' +
            ...
            '<input readonly type="hidden" name="other_business_id" id="other_business_id" value="' + id + '">' +
            '</div>' +
            '</div>';
...
<script>
    function other_land_add_row() {
        ...
        txt += '<select readonly name="other_land_district_' + id + '" id="other_land_district_' + id + '" class="form-control" onchange="fill_other_tehsil(this.value,' + id + ')">';
        txt += '<?php echo $district_options_js; ?>'; // PHP district options for JS
        txt += '</select></div>';

        txt += '<div class="col-sm-3 form-group"><label>2. तहसील</label>';
        txt += '<select readonly name="other_land_tehsil_' + id + '" id="other_land_tehsil_' + id + '" class="form-control">';
        txt += '<option value="">--Select--</option>';
        txt += '</select></div>';

        txt += '<div class="col-sm-3 form-group"><label>3. शहरी / ग्रामीण</label><select readonly name="other_land_area_type_' + id + '" id="other_land_area_type_' + id + '" class="form-control"><option value="">-- चयन --</option><option>शहरी</option><option>ग्रामीण</option></select></div>';

        txt += '<div class="col-sm-3 form-group"><label>4. भूमि क्षेत्रफल (हे.)</label><input readonly type="text" name="other_land_land_area_' + id + '" id="other_land_land_area_' + id + '" class="form-control"></div>';

        txt += '<div class="col-sm-3 form-group"><label>5. स्वामित्व</label><select readonly name="other_land_ownership_' + id + '" id="other_land_ownership_' + id + '" class="form-control other_owner_select" data-row="' + id + '"><option value="">-- चयन --</option><option>संस्था स्वामित्व</option><option>पट्टा (लीज)</option><option>अन्य</option></select></div>';

        txt += '<div class="col-sm-3 form-group" id="other_owner_div_' + id + '" style="display:none;"><label>6. किसके स्वामित्व में है?</label><input readonly type="text" name="other_land_other_owner_' + id + '" id="other_land_other_owner_' + id + '" class="form-control"></div>';

        txt += '<div class="col-sm-3 form-group"><label>7. भूमि की स्थिति</label><select readonly name="other_land_land_status_' + id + '" id="other_land_land_status_' + id + '" class="form-control land_status_select" data-row="' + id + '"><option value="">-- चयन --</option><option>खली पड़ी है</option><option>निर्माण</option><option>विवादित है</option></select></div>';

        txt += '<div class="col-sm-3 form-group" id="construct_div_' + id + '" style="display:none;"><label>8. निर्माण के प्रकार</label><select readonly name="other_land_construction_' + id + '" id="other_land_construction_' + id + '" class="form-control"><option value="">-- चयन --</option><option>ऑफिस स्पेस</option><option>किराये पर</option><option>जर्जर निर्माण</option><option>अन्य</option></select></div>';
        ...
        txt += '<select readonly name="other_land_location_mode_' + id + '" id="other_land_location_mode_' + id + '" class="form-control location_mode_select" data-row="' + id + '">';
        ...
        txt += '<div class="row">';
        txt += '<div class="col-sm-6 form-group"><label>Latitude</label><input readonly type="text" name="other_land_latitude_' + id + '" id="other_land_latitude_' + id + '" class="form-control other_lat"></div>';
        txt += '<div class="col-sm-6 form-group"><label>Longitude</label><input readonly type="text" name="other_land_longitude_' + id + '" id="other_land_longitude_' + id + '" class="form-control other_lon"></div>';
        txt += '</div>';
        txt += '</div>';
        ...
        txt += '<input readonly type="hidden" name="other_land_count" id="other_land_count" value="' + id + '">';
        txt += '</div>';
...
<script>
    function business_matrix_add_row() {
        ...
        let html = `
            <tr class="business_matrix_row">
                <td>
                    <select readonly name="business_year_${id}" class="form-control">
                        ${fyOptions}
                    </select>
                </td>
                <td>
                    <input readonly type="text" name="business_description_${id}" class="form-control">
                </td>
                <td>
                    <input readonly type="text" name="business_turnover_${id}" class="form-control">
                </td>
                <td>
                    <input readonly type="text" name="business_target_${id}" class="form-control">
                </td>
                <td>
                    <input readonly type="text" name="business_achievement_${id}" class="form-control">
                </td>
                <td class="text-center">
                    <button type="button" class="btn btn-danger btn-sm"
    ...
    <div class="row mb-2 sec3c_row">
        ...
        <div class="col-sm-2 form-group">
            <label>जनपद</label>
            <select readonly name="sec_3_c_district_${id}" class="form-control">
                <option value="">--Select--</option>
        ...
        <div class="col-sm-2 form-group">
            <label>क्षेत्रफल (हेक्टेयर में)</label>
            <input readonly type="text" name="sec_3_c_area_${id}" class="form-control">
        </div>

        <div class="col-sm-2 form-group">
            <label>पहुच मार्ग का प्रकार</label>
            <select readonly name="sec_3_c_paved_road_${id}" class="form-control">
                <option value="">--select--</option>
                <option value="ordinary">कच्ची सड़क</option>
                <option value="nh">नेशनल हाईवे</option>
                <option value="sh">स्टेट हाईवे</option>
        ...
        <div class="col-sm-2 form-group">
            <label>स्थान</label>
            <select readonly name="sec_3_c_land_location_${id}" class="form-control">
                <option value="">--select--</option>
                <option value="inpremise">समिति प्रांगण</option>
                <option value="other">अन्य स्थान</option>
            </select>
    ...
    function updateOfficeRows(count) {
        ...
        if (count > current) {
            for (var i = current; i < count; i++) {
                ...
                row.innerHTML = `
                <td><input readonly type="text" name="zone_name[]" class="form-control" placeholder="क्षेत्रीय कार्यालय का नाम"></td>
                <td><input readonly type="text" name="zone_mobile[]" class="form-control" placeholder="क्षेत्रीय कार्यालय का दूरभाष न०"></td>
                <td><input readonly type="text" name="zone_email[]" class="form-control" placeholder="क्षेत्रीय कार्यालय का ई-मेल आई.डी."></td>
                <td><input readonly type="text" name="zone_address[]" class="form-control" placeholder="क्षेत्रीय कार्यालय का पता"></td>
                <td><input readonly type="file" name="zone_image[]" class="form-control"></td>
            `;
            }
        }
    ...
    function updateSeparatePrakhandRows(count) {
        ...
        if (count > current) {
            for (var i = current; i < count; i++) {
                ...
                row.innerHTML = `
                <td><input readonly type="text" name="prakhand_name[]" class="form-control" placeholder="जिला कार्यालय का नाम"></td>
                <td><input readonly type="text" name="prakhand_mobile[]" class="form-control" placeholder="जिला कार्यालय का दूरभाष"></td>
                <td><input readonly type="text" name="prakhand_email[]" class="form-control" placeholder="जिला कार्यालय का ईमेल"></td>
                <td><input readonly type="text" name="prakhand_address[]" class="form-control" placeholder="जिला कार्यालय का पता"></td>
                <td><input readonly type="file" name="prakhand_image[]" class="form-control"></td>
            `;
            }
        }
    ...
    function updateGasServiceRows(count) {
        ...
        if (count > current) {
            for (var i = current; i < count; i++) {
                ...
                row.innerHTML = `
                <td><input readonly type="text" name="gas_service_name[]" class="form-control" placeholder="सहकारी गैस सर्विस का नाम"></td>
                <td><input readonly type="text" name="gas_service_mobile[]" class="form-control" placeholder="सहकारी गैस सर्विस का दूरभाष"></td>
                <td><input readonly type="text" name="gas_service_email[]" class="form-control" placeholder="सहकारी गैस सर्विस का ईमेल"></td>
                <td><input readonly type="text" name="gas_service_address[]" class="form-control" placeholder="सहकारी गैस सर्विस का पता"></td>
                <td><input readonly type="file" name="gas_service_image[]" class="form-control"></td>
            `;
            }
        }
    ...
    function updateUnitRows(count) {
        ...
        if (count > current) {
            for (var i = current; i < count; i++) {
                ...
                row.innerHTML = `
                <td><input readonly type="text" name="unit_name[]" class="form-control" placeholder="यूनिट का नाम"></td>
                <td><input readonly type="text" name="unit_mobile[]" class="form-control" placeholder="यूनिट का दूरभाष"></td>
                <td><input readonly type="text" name="unit_email[]" class="form-control" placeholder="यूनिट का ईमेल"></td>
                <td><input readonly type="text" name="unit_address[]" class="form-control" placeholder="यूनिट का पता"></td>
                <td><input readonly type="file" name="unit_image[]" class="form-control"></td>
            `;
            }
        }
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (typeof businessData !== "undefined" && businessData.length > 0) {
            ...
            <tr class="business_matrix_row">
                <td>
                    <select readonly name="business_year_${rowNumber}" class="form-control">
                        <option value="">---वित्तीय वर्ष---</option>
                        ${yearOptions}
                    </select>
                </td>
...
<script>
    ...
    function sec_2_2_add_rows() {
        ...
        var tr = '<tr id="sec_2_2_row_' + id + '">'
            + '<td><select readonly name="sec_2_2_year_' + id + '" id="sec_2_2_year_' + id + '" class="form-control">'
            ...
            + '</select></td>'
            + '<td><input readonly type="text" name="sec_2_2_amount_' + id + '" id="sec_2_2_amount_' + id + '" class="form-control chk_number" data-type="धनराशि अंकों में भरे"></td>'
            + '<td><input readonly type="text" name="sec_2_2_dept_supply_' + id + '" id="sec_2_2_dept_supply_' + id + '" class="form-control chk_number" data-type="विभागीय आपूर्ति अंकों में भरे"></td>'
            + '<td><input readonly type="text" name="sec_2_2_wheat_purchase_' + id + '" id="sec_2_2_wheat_purchase_' + id + '" class="form-control chk_number" data-type="गेहूँ खरीद अंकों में भरे"></td>'
            + '<td><input readonly type="text" name="sec_2_2_paddy_purchase_' + id + '" id="sec_2_2_paddy_purchase_' + id + '" class="form-control chk_number" data-type="धान खरीद अंकों में भरे"></td>'
            + '<td><input readonly type="text" name="sec_2_2_fert_sales_' + id + '" id="sec_2_2_fert_sales_' + id + '" class="form-control chk_number" data-type="उर्वरक बिक्री अंकों में भरे"></td>'
            + '<td><input readonly type="text" name="sec_2_2_fert_transport_' + id + '" id="sec_2_2_fert_transport_' + id + '" class="form-control chk_number" data-type="उर्वरक परिवहन अंकों में भरे"></td>'
            + '<td><input readonly type="text" name="sec_2_2_lpg_dist_' + id + '" id="sec_2_2_lpg_dist_' + id + '" class="form-control chk_number" data-type="एलपीजी वितरण अंकों में भरे"></td>'
            + '<td><input readonly type="text" name="sec_2_2_trifed_simfed_' + id + '" id="sec_2_2_trifed_simfed_' + id + '" class="form-control chk_number" data-type="ट्राईफेड/सिमफेड अंकों में भरे"></td>'
            + '<td><input readonly type="text" name="sec_2_2_cppl_anpl_' + id + '" id="sec_2_2_cppl_anpl_' + id + '" class="form-control chk_number" data-type="सीपीपीएल/एएनपीएल अंकों में भरे"></td>'
    ...
    function sec_2_3_add_rows() {
        ...
        var tr = ''
            ...
            + '<select readonly name="sec_2_3_year_' + id + '" id="sec_2_3_year_' + id + '" class="form-control text-center">'
            + '<option value="">वर्ष चुनें</option>'
            + '<option value="2020-21">2020-21</option>'
            + '<option value="2021-22">2021-22</option>'
            + '<option value="2022-23">2022-23</option>'
            ...
            + '</select>'
            + '<td>एल०पी०जी०</td>'
            + '<td><input readonly type="text" name="sec_2_3_lpg_target_' + id + '" id="sec_2_3_lpg_target_' + id + '" class="form-control chk_number" data-type="लक्ष्य अंकों में भरे"></td>'
            + '<td><input readonly type="text" name="sec_2_3_lpg_business_' + id + '" id="sec_2_3_lpg_business_' + id + '" class="form-control chk_number" data-type="व्यवसाय अंकों में भरे"></td>'
            ...
            + '<td>उर्वरक</td>'
            + '<td><input readonly type="text" name="sec_2_3_fert_target_' + id + '" id="sec_2_3_fert_target_' + id + '" class="form-control chk_number" data-type="लक्ष्य अंकों में भरे"></td>'
            + '<td><input readonly type="text" name="sec_2_3_fert_business_' + id + '" id="sec_2_3_fert_business_' + id + '" class="form-control chk_number" data-type="व्यवसाय अंकों में भरे"></td>'
            + '</tr>'
            // Dept Supply row
            + '<tr id="sec_2_3_row_dept_' + id + '">'
            + '<td>विभागीय आपूर्ति</td>'
            + '<td><input readonly type="text" name="sec_2_3_dept_target_' + id + '" id="sec_2_3_dept_target_' + id + '" class="form-control chk_number" data-type="लक्ष्य अंकों में भरे"></td>'
            + '<td><input readonly type="text" name="sec_2_3_dept_business_' + id + '" id="sec_2_3_dept_business_' + id + '" class="form-control chk_number" data-type="व्यवसाय अंकों में भरे"></td>'
            + '</tr>'
            // Total row
            + '<tr id="sec_2_3_row_total_' + id + '">'
            + '<td><strong>योग</strong></td>'
            + '<td><input readonly type="text" name="sec_2_3_total_target_' + id + '" id="sec_2_3_total_target_' + id + '" class="form-control chk_number" data-type="लक्ष्य अंकों में भरे"></td>'
            + '<td><input readonly type="text" name="sec_2_3_total_business_' + id + '" id="sec_2_3_total_business_' + id + '" class="form-control chk_number" data-type="व्यवसाय अंकों में भरे"></td>'
            + '</tr>';
    ...
    function sec_2_4_add_rows() {
        ...
        var txt = '';
        txt += '<tr>';
        txt += '<td rowspan="3"><input readonly type="text" name="sec_2_4_year_' + id + '" id="sec_2_4_year_' + id + '" class="form-control"></td>';
        txt += '<td>गेहूं खरीद</td>';
        txt += '<td><input readonly type="text" name="sec_2_4_wheat_target_' + id + '" class="form-control chk_number"></td>';
        txt += '<td><input readonly type="text" name="sec_2_4_wheat_business_' + id + '" class="form-control chk_number"></td>';
        txt += '<td rowspan="3" id="sec_2_4_rows" class="text-center"><button type="button" class="btn btn-info" onclick="sec_2_4_add_rows()">नई पंक्ति जोड़ें [+]</button><input readonly type="hidden" name="sec_2_4_id" id="sec_2_4_id" value="' + id + '"></td>';
        txt += '</tr>';
        txt += '<tr>';
        txt += '<td>धान खरीद</td>';
        txt += '<td><input readonly type="text" name="sec_2_4_paddy_target_' + id + '" class="form-control chk_number"></td>';
        txt += '<td><input readonly type="text" name="sec_2_4_paddy_business_' + id + '" class="form-control chk_number"></td>';
        txt += '</tr>';
        txt += '<tr>';
        txt += '<td><strong>योग</strong></td>';
        txt += '<td><input readonly type="text" name="sec_2_4_total_target_' + id + '" class="form-control chk_number"></td>';
        txt += '<td><input readonly type="text" name="sec_2_4_total_business_' + id + '" class="form-control chk_number"></td>';
        txt += '</tr>';
