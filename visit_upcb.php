                                            ...
                                            द्वारा परीक्षण कर 10 तारीख तक अनुमोदन करना आवश्यक है।
                                                ...
                                                <div?php echo $msg; ?>
                                                    ...
                                                    <div class="col-sm-12">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8 form-group" style="margin: 9px;"
                                                                        ...
                                                                        <input type="text" id="" name=""
                                                                            tabindex="<?php echo $tab++; ?>" readonly
                                                                            value="उत्तर प्रदेश को ऑपरेटिव बैंक लि0">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-8">
                                                        ...
                                                        <h5> <img src="images/logo/2.png" alt="text" class="img-fluid stat-icon"
                                                                style="height:50px; width:50px;"> 1.2 शाखाएँ / क्षेत्रीय कार्यालय / वेतन कार्यालय </h5><br>
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <select name="sec_2_stock_insurance"
                                                                                        ...
                                                                                        <option value="no">क्षेत्रीय कार्यालय</option>
                                                                                        <option value="no">वेतन कार्यालय </option>
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <table class="table table-bordered table-striped table-hover">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td></td>
                                                                <td>i) डेस्कटाप कंप्यूटर - Desktop / Laptop (CPU, Monitor, Keyboard,
                                                                    Mouse)
                                                                </td>
                                ...
                                <div class="step">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-12" id="sec_2_pds_tornover"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3 form-group">
                                                    <label><b>(IV) भारतीय बीज सहकारी समिति</b></label>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3 form-group">
                                                    <label><b>(V) राष्ट्रीय सहकारी ऑर्गेनिक्स लिमिटेड</b></label>
                                                    <select name="sec_3_seed" id="sec_3_seed"
                                                        tabindex="<?php echo $tab++; ?>" class="form-control"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3 form-group">
                                                    <label><b>(VI) राष्ट्रीय सहकारी निर्यात लिमिटेड</b></label>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3 form-group">
                                                <label><b>(VII) क्या जन सेवा केंद्र (CSC) संचालित है ?</b></label>
                                            ...
                                            <div class="col-sm-3 form-group" id="sec_3_csc_amt"
                                                style="<?php echo $displayStyle_sec_new_3_csc; ?>">
                                                <label>व्यवसाय धनराशि (रु० लाख मे)</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-2 form-group">
                                                            ...
                                                            <select class="form-control " type="checkbox" id="sec_2_guard"
                                                                ...
                                                                <!-- <style>size="4" style="height:auto;"</style> -->
