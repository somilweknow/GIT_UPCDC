...
function page_sidebar($id = '')
{
	...
	<div class="sidebar" data-color="blue" data-image="images/sidebar-5.jpg" style="z-index: 999;">
		...
		<div class="sidebar-wrapper">
			...
			<ul class="nav">
				<li routerlinkactive="active" class="nav-item active"><a class="nav-link" href="index_3.php"><i
							class="fa fa-chart-pie"></i>
						<p>डैशबोर्ड</p>
					</a>
					<?php if (
						isset($_SESSION['user_type']) && $_SESSION['user_type'] == 'maker'
						&& !empty($_SESSION['apex_id'])
					): ?>

					<li routerlinkactive="active" class="nav-item active">
						<a class="nav-link" href="apex_designation_mapping.php?apex_id=<?php echo $_SESSION['apex_id']; ?>">
							<i class="fas fa-users"></i>
							<p>Master Designation</p>
						</a>
					</li>
				<?php endif; ?>
				<?php
			...
			<div class="container-fluid">
				<div class="navbar-wrapper">
					<a class="navbar-brand page-title" href="#"
						style="font-size:24px; color:#F83A3D"><?php if ($id == 'super') {
							echo '<img src="images/upcoop_logo.jpg" style="height:50px; border-radius:50%; border: 2px solid; margin-right:15px;">सहकारिता विभाग सर्वेक्षण, उत्तर प्रदेश';
						} else {
							echo $GLOBALS['title'];
						} ?></a>
				</div>
						...
						<li class="nav-item dropdown">
							<a class="" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
								aria-expanded="false" href="#"><button class="btn btn-info"><i class="fa fa-user-lock"></i>
									<?php echo $_SESSION['username']; ?></button></a>&nbsp;
		...
		<footer class="footer">
			<div class="container-fluid">
				...
				<p class="copyright text-center">
					...
					<a href="http://www.webprotechnologies.com" target="_blank"><img src="images/logo2.gif"
							style="height:20px;" class="img-rounded">WebPro Technologies</a>
				</p>
			</div>
		</footer>
	</div>
