...
if (isset($_POST['id']) && $_POST['id'] === 'dr_review') {
    ...
    $r = execute_query("UPDATE sangrah_sahkari_deyo_daily_collection
...
?>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" style="font-size:12px; text-align:center;">
                                                ...
                                                <tr>
                                                    ...
                                                    <th rowspan="2" id="deyo_action_col_head" style="display:none;">कार्यवाही</th>
                                                </tr>
                                                <tr>
    ...
    <script>
        ...
        function loadPastData() {
            ...
            xhr.onload = function () {
                ...
                try {
                    ...
                    var actionHead = document.getElementById('deyo_action_col_head');
                    ...
                    rows.forEach(function (r) {
                        ...
                        if (isDr) {
                            actionCell =
                                '<td>' +
                                '<textarea id="deyo_remark_' + distId + '" class="form-control form-control-sm mb-1" rows="1" placeholder="टिप्पणी (वैकल्पिक)" style="min-width:140px;">' + (r.dr_remark || '') + '</textarea>' +
                                '<button class="btn btn-success btn-sm mr-1" onclick="submitDeyoReview(' + distId + ',\'' + pdate + '\',\'approved\')">✔ स्वीकृत</button>' +
                                '<button class="btn btn-danger btn-sm" onclick="submitDeyoReview(' + distId + ',\'' + pdate + '\',\'rejected\')">✘ अस्वीकृत</button>' +
                                '</td>';
                        }
        ...
        function submitDeyoReview(districtId, entryDate, status) {
            var remark = '';
            var el = document.getElementById('deyo_remark_' + districtId);
