...
// }
        ?>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8 form-group" style="margin: 9px;"   id="sec_1_institute_name_container">
                                                                        ...
                                                                        <input type="text" id="" name="" tabindex = "<?php echo $tab++; ?>" readonly value="हथकरघा एवं वस्त्रोद्योग विभाग, उ०प्र०">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-8">
                                    ...
                                    <div class="step">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="step">  
                                                ...
                                                style="height:50px; width:50px;"> 4 (II). समिति द्वारा की जा रही मशीनों का विवरण</h5>
                                                    <div class="col-sm-3 form-group">
                                                        <label>1. पोएरलूम</label>
                                                        <input type="text" name="sec_2_1_2_value_<?php echo $i; ?>"
                                                            id="sec_2_1_2_value_<?php echo $i; ?>"
                                                            tabindex="<?php echo $tab++; ?>" class="form-control"
                                                            value="<?php echo $row_2_1_2['sec_2_1_2_value_' . $i]; ?>">
            ...
            <script type="text/javascript" src="js/multistepform_handloom.js?v=1">
