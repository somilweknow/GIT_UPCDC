                            ...
                            <div id="steps-container">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="hidden" id="society_code"
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <input type="text"
                                                    name="sec_2_1_2_value_<?php echo $i; ?>"
                                            ...
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <select name="sec_1_profit_loss_<?php echo $i; ?>"
                                                    id="sec_1_profit_loss_<?php echo $i; ?>"
                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                                    onchange="color_change(this, 'profit', '#42ecf5', 'loss', '#f28546');">
                                                    <option value="">--Select--</option>
                                                    <option value="profit">लाभ</option>
                                            ...
                                            <div class="col-sm-2 form-group my-auto" id="add_business_row">
                                                <button type="button" class="btn btn-info" onClick="add_more_business();">
                                                    नईं पंक्ति जोड़े [+]
                                                </button>
                                ...
                                <div class="step">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <div class="col-sm-4 form-group">
                                                <label>इण्टरनेट कनेक्शन है या नहीं ?</label>
...
<script type="text/javascript" src="js/multistepform_sericulture.js?v=1">
