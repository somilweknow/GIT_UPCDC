                                ...
                                <div class="step">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="hidden" id="apex_code" name="apex_code" value="<?php echo $row_invoice['apex_id']; ?>">
                                                <div class="row">
                                                    <div class="col-md-2">
                                        ...
                                        <div class="row human_row mb-2">
                                            <div class="col-md-4">
                                                ...
                                                <select name="prakhand_name" id="prakhand_name"
                                                    ...
                                                    } elseif (!empty($existing_row['prakhand_id'])) {
                                                        $selected_prakhand_id = $existing_row['prakhand_id'];
                                                    }
