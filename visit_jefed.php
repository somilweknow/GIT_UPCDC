                            ...
                            <div id="success">
                                <div class="mt-5 text-center">
                                    ...
                                    <button class="btn btn-info"
                                            onclick="window.open('preview_jefed.php?exdid=<?php echo $_GET['exdid']; ?>', '_blank');">प्रपत्र
    ...
    function updateOfficeRows(count) {
        ...
        if (count > current) {
            for (var i = current; i < count; i++) {
                ...
                row.innerHTML = `
                <td><input type="text" name="zone_name[]" class="form-control"></td>
                <td><input type="text" name="zone_mobile[]" class="form-control"></td>
                <td><input type="text" name="zone_email[]" class="form-control"></td>
                <td><input type="text" name="zone_address[]" class="form-control"></td>
    ...
    function updateSeparatePrakhandRows(count) {
        ...
        if (count > current) {
            for (var i = current; i < count; i++) {
                ...
                row.innerHTML = `
                <td><input type="text" name="prakhand_name[]" class="form-control" placeholder="प्रखण्ड का नाम"></td>
                <td><input type="text" name="prakhand_mobile[]" class="form-control" placeholder="प्रखण्ड का दूरभाष"></td>
                <td><input type="text" name="prakhand_email[]" class="form-control" placeholder="प्रखण्ड का ईमेल"></td>
                <td><input type="text" name="prakhand_address[]" class="form-control" placeholder="प्रखण्ड का पता"></td>
