    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                            ...
                            <div id="steps-container">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select name="sec_3_profit_loss_<?= $suffix ?>"
                                                                    ...
                                                                    <option value="">--Select--</option>
                                                                    <option value="profit" <?php echo isset($row_3_new_1['sec_3_profit_loss_' . $suffix]) && $row_3_new_1['sec_3_profit_loss_' . $suffix] == 'profit' ? 'selected' : ''; ?>>लाभ</option>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select name="sec_3_accumulated_<?= $suffix ?>"
                                                                    ...
                                                                    onchange="handleDropdownColorChange(this,'profit','#42ecf5','loss','#f28546');">
                                                                    <option value="">--Select--</option>
                                                                    <option value="profit" <?php echo isset($row_3_new_1['sec_3_accumulated_' . $suffix]) && $row_3_new_1['sec_3_accumulated_' . $suffix] == 'profit' ? 'selected' : ''; ?>>लाभ</option>
                                ...
                                <div class="step">
                                    ...
                                    <h4><img src="images/logo/11.png" alt="text" class="img-fluid stat-icon"
                                            style="height:50px; width:50px;"> 3.1. मुख्यालय पर कार्यरत अधिकारियों का विवरण
                                    </h4>
                ...
                <div class="step">
                    <div?php echo $msg; ?>
                        ...
                        <h4><img src="images/logo/1.png" alt="text" class="img-fluid stat-icon"
                                style="height:45px; width:45px;"> 7. क्षेत्रीय कार्यालय</h4>
                        <div class="col-sm-12">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8 form-group" style="margin: 9px;"
                                            ...
                                            <input type="text" id="" name="" tabindex="<?php echo $tab++; ?>" readonly
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <table class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody id="regional_staff_tbody">
                                            <?php for ($i = 1; $i <= 5; $i++): ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td>
                                                        <select name="sec_2_stock_insurance_<?php echo $i; ?>"
                                                            class="form-control">
                                                            <option value="">--select--</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-info"
                                                onClick="add_regional_staff_row()">
                                                नई पंक्ति जोड़े [+]
                                            </button>
                                            <input type="hidden" name="sec_3_b_id" id="regional_staff_count_id"
                                ...
                                <script>
                                    function add_regional_staff_row() {
                                        var countInput = document.getElementById('regional_staff_count_id');
                                        var currentCount = parseInt(countInput.value);
                                        if (isNaN(currentCount)) currentCount = 0;

                                        // Handle the initial hardcoded rows (msg from dev: verify if this logic is needed based on saved state)
                                        if (currentCount < 5) currentCount = 5;

                                        var newId = currentCount + 1;
                                        countInput.value = newId;

                                        var html = `
                                            <tr>
                                                <td>${newId}</td>
                                                <td>
                                                    <select name="sec_2_stock_insurance_${newId}" class="form-control">
                                                        <option value="">--select--</option>
                                                        <option value="yes">क्षेत्रीय प्रबन्धक </option>
                                                        <option value="no">आकिक</option>
                                                        <option value="no">सहायक आकिक </option>
                                                        ...
                                                        <option value="no">सहयोगी</option>
                                                        <option value="no">अन्य कार्यरत संवर्ग</option>
                                                        <option value="no">संविदा/आउटसोर्स पर कार्यरत कार्मिक का नाम</option>
                                                    </select>
                                                </td>
                                                <td><input type="text" name="sec_1_2_name${newId}" class="form-control"></td>
                                                <td><input type="text" name="sec_1_2_division${newId}" class="form-control"></td>
                                            </tr>
                                            `;

                                        var tbody = document.getElementById('regional_staff_tbody');
                                        if (tbody) {
                                            tbody.insertAdjacentHTML('beforeend', html);
                                        }
                                    }
                ...
                <div class="step">
                    ...
                    <div class="mb-2 text-right">
                        <button type="button" class="btn btn-info" id="addYearRowBtn" onclick="addFinancialYearRow()">
                            नई पंक्ति जोड़ें [+]
                        </button>
                    </div>

                    <script>
                        // Define global variable on window to ensure it persists
                        window.financialYearCount = 3;

                        // Define global function on window
                        window.addFinancialYearRow = function () {
                            window.financialYearCount++;

                            var startYear = 2022 + (window.financialYearCount - 1);
                            var endYear = startYear + 1;
                            var yearLabel = startYear + "-" + endYear.toString().slice(-2);

                            // Try selecting using jQuery if available, otherwise vanilla JS
                            var tbody = $("#financialMatrixTable tbody");
                            if (tbody.length === 0) {
                                tbody = document.querySelector("#financialMatrixTable tbody");
                            }
                            ...
                            var html = `
                                <tr>
                                    ...
                                    <td>वार्षिक लाभ/हानि</td>
                                    <td>
                                        <select name="sec_3_profit_loss_${window.financialYearCount}" class="form-control"
                                            onchange="handleDropdownColorChange(this,'profit','#42ecf5','loss','#f28546');">
                                            <option value="">--Select--</option>
                                            <option value="profit">लाभ</option>
                                            <option value="loss">हानि</option>
                                    ...
                                    <td>
                                        <input type="text" name="sec_3_gross_amount_${window.financialYearCount}" class="form-control chk_decimal">
                                    </td>
                                    <td>
                                        <input type="text" name="sec_3_net_amount_${window.financialYearCount}" class="form-control chk_decimal">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>संचित लाभ/हानि</td>
                                    <td>
                                        <select name="sec_3_accumulated_${window.financialYearCount}" class="form-control"
                                            onchange="handleDropdownColorChange(this,'profit','#42ecf5','loss','#f28546');">
                                            <option value="">--Select--</option>
                                            <option value="profit">लाभ</option>
                                            <option value="loss">हानि</option>
                                    ...
                                    <td>
                                        <input type="text" name="sec_3_acc_gross_amount_${window.financialYearCount}" class="form-control chk_decimal">
                                    </td>
                                    <td>
                                        <input type="text" name="sec_3_acc_net_amount_${window.financialYearCount}" class="form-control chk_decimal">
                                    </td>
                                </tr>
                            `;
                        ...
                        // Helper function for color change - simplified
                        window.handleDropdownColorChange = function (selectElement, yesValue, yesColor, noValue, noColor) {
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><textarea name="sec_6_v_rep_details" class="form-control" rows="2"></textarea>
                                    </td>
                                </tr>
            ...
            <div class="step">
                ...
                <h4><img src="images/logo/1.png" alt="text" class="img-fluid stat-icon"
                        style="height:45px; width:45px;"> 9. सहकारी प्रशिक्षण केंद्र का विवरण</h4>
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="40%"><input type="text" name="sec_13_address" class="form-control"
                                                tabindex="<?php echo $tab++; ?>"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="date" name="sec_13_principal_joining_date" class="form-control"
                                                tabindex="<?php echo $tab++; ?>"></td>
                                        <td colspan="2"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="sec_13_room_count" class="form-control"
                                                tabindex="<?php echo $tab++; ?>"></td>
                                        <td><b>क्षमता</b></td>
                                        <td><input type="number" name="sec_13_room_capacity" class="form-control"
                                                tabindex="<?php echo $tab++; ?>"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="number" name="sec_13_hostel_count" class="form-control"
                                                tabindex="<?php echo $tab++; ?>"></td>
                                        <td><b>क्षमता</b></td>
                                        <td><input type="number" name="sec_13_hostel_capacity" class="form-control"
                                                tabindex="<?php echo $tab++; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td><b>पुस्तकालय संख्या</b></td>
                                        <td><input type="number" name="sec_13_library_count" class="form-control"
                                                tabindex="<?php echo $tab++; ?>"></td>
                                        <td><b>क्षमता</b></td>
                                        <td><input type="number" name="sec_13_library_capacity" class="form-control"
                                                tabindex="<?php echo $tab++; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td><b>कम्प्यूटर लैब संख्या</b></td>
                                        <td><input type="number" name="sec_13_computer_lab_count" class="form-control"
                                                tabindex="<?php echo $tab++; ?>"></td>
                                        <td><b>क्षमता</b></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="sec_13_faculty_count" class="form-control"
                                                tabindex="<?php echo $tab++; ?>"></td>
                                        <td colspan="2"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="text" name="sec_13_training_subjects" class="form-control"
                                                tabindex="<?php echo $tab++; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td><b>प्रशिक्षण सत्र अवधि</b></td>
                                        <td><input type="text" name="sec_13_training_duration" class="form-control"
                                                tabindex="<?php echo $tab++; ?>"></td>
                                        <td colspan="2"></td>
                                    </tr>
                                    <tr>
                                        <td><b>प्रशिक्षार्थियों की संख्या</b></td>
                                        <td><input type="number" name="sec_13_trainees_count" class="form-control"
                                                tabindex="<?php echo $tab++; ?>"></td>
                                        <td colspan="2"></td>
                                    </tr>
                                    <tr>
                                        <td><b>विभागीय प्रशिक्षार्थियों की संख्या</b></td>
                                        <td><input type="number" name="sec_13_dept_trainees_count" class="form-control"
                                                tabindex="<?php echo $tab++; ?>"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="sec_13_dept_training_fee" class="form-control"
                                                tabindex="<?php echo $tab++; ?>"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="sec_13_dept_hostel_fee" class="form-control"
                                                tabindex="<?php echo $tab++; ?>"></td>
                                        <td><b>गैर विभागीय हॉस्टल शुल्क</b></td>
                                        <td><input type="number" name="sec_13_non_dept_hostel_fee" class="form-control"
                                                tabindex="<?php echo $tab++; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td><b>निर्माण वर्ष</b></td>
                                        <td><input type="number" name="sec_13_construction_year" class="form-control"
                                                tabindex="<?php echo $tab++; ?>"></td>
                                        <td><b>संचालन वर्ष</b></td>
                                        <td><input type="number" name="sec_13_operation_year" class="form-control"
                                                tabindex="<?php echo $tab++; ?>"></td>
                                    </tr>
                                </tbody>
                            </table>
        ...
        <div class="row">
            ...
            <div class="col-sm-8 form-group my-auto">
                <button type="button" name="verify_otp_btn" id="verify_otp_btn" tabindex="<?php echo $tab++; ?>"
                    class="btn btn-info" onClick="verify_otp($('#survey_id').val(), '', $('#user_otp').val());">वेरिफाई
                    करें</button>
                <button type="button" name="send_otp_btn" id="send_otp_btn" tabindex="<?php echo $tab++; ?>"
