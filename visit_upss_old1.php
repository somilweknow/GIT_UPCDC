                            ...
                            <div id="steps-container">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8 form-group" style="margin: 9px;"
                                                        ...
                                                        <input type="text" name="apex_name" id="apex_name"
                                                            tabindex="<?php echo $tab++; ?>" readonly
                                                            value="उ०प्र० उपभोक्ता सहकारी संघ"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="step">
                                    <h4><img src="images/logo/7.png" alt="text" class="img-fluid stat-icon"
                                            style="height:50px; width:50px;"> 3.प्रबंध कमेटी / संचालक मण्डल</h4>
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <div class="col-sm-3 form-group" id="sec_6_2_election_year">
                                                <label>निर्वाचन कि तिथि</label>
                                    ...
                                    <h4>
                                        ...
                                        2. संघ के प्रदेश में क्षेत्रीय / जिला कार्यालय, यूनिट एवं एल०पी०जी० सर्विस
                                    </h4>
                                            ...
                                            <div class="row yearly_business_row mt-2">
                                                ...
                                                <div class="col-sm-3 form-group">
                                                    ...
                                                    <input type="text" 
                                                        ...
                                                        id="sec_7_business_name_<?php echo $i; ?>" 
                                                        class="form-control"
                                                ...
                                                <div class="col-sm-3 form-group">
                                                    ...
                                                    <input type="text" 
                                                        ...
                                                        id="sec_7_annual_target_<?php echo $i; ?>" 
                                                        class="form-control"
                                                ...
                                                <div class="col-sm-3 form-group">
                                                    ...
                                                    <input type="text" 
                                                        ...
                                                        id="sec_7_achievement_<?php echo $i; ?>" 
                                                        class="form-control"
                                    ...
                                    <div id="sec_8_stock">
                                        ...
                                        ?>
                                            <div class="row stock_row mt-2">
                                                ...
                                                <div class="col-sm-3 form-group">
                                                    <label>31 मार्च 2023 को समापन स्टॉक</label>
                                                ...
                                                <div class="col-sm-3 form-group">
                                                    <label>31 मार्च 2024 को अंतिम स्टॉक</label>
                                                    <input type="text" name="final_stock_<?php echo $i; ?>" id="final_stock_<?php echo $i; ?>"
                                                        class="form-control"
                                                        value="<?php echo $stock_rows[$i]['final_stock'] ?? ''; ?>">
                                                </div>
                                                <div class="col-sm-3 form-group">
                                                    <label>बुक वैल्यू</label>
                                                    <input type="text" name="final_book_<?php echo $i; ?>" id="final_book_<?php echo $i; ?>"
                                                        class="form-control chk_number"
                                                        value="<?php echo $stock_rows[$i]['final_book_value'] ?? ''; ?>">
                                                </div>
                                ...
                                <div class="step">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <h5>(I) भवन/सम्पत्ति/गोदाम का स्वामित्व </h5>
                                                <div class="col-sm-3 form-group">
                                                ...
                                                <div id="sec_3_rented"
                                                    ...
                                                    <div class="col-sm-3 form-group">
                                                     ...
                                                     <div class="col-sm-3 form-group">
                                                        <label>खाली पड़ी भूमी का विवरण</label><input
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3 form-group">
                                                        <label> रैन्वॉटर हार्वेस्टिंग </label>
...
<script>
    ...
    function sec_6_2_add_rows() {
        ...
        id = id + 1;
        $("#sec_2_b_rows").remove();
        var txt = '<div class="row"><div class="col-sm-2 form-group"><label>नाम</label><input type="text" name="sec_6_2_name_' + id + '" id="sec_6_2_name_' + id + '" class="form-control chk_text" data-type="नाम शब्दों में भरे"></div><div class="col-sm-2 form-group"><label>पदनाम</label><select class="form-control" id="sec_6_2_designation_' + id + '" name="sec_6_2_designation_' + id + '"><option value="">--Select--</option><option value="अध्यक्ष">अध्यक्ष</option><option value="उपाध्यक्ष">उपाध्यक्ष</option><option value="संचालक">संचालक</option></select></div><div class="col-sm-2 form-group"><label>निर्वाचन क्षेत्र</label><input type="text" name="sec_6_2_father_name_' + id + '" id="sec_6_2_father_name_' + id + '" class="form-control chk_text"></div><div class="col-sm-2 form-group"><label>मोबाईल नंबर</label><input type="text" name="sec_6_2__mob_no_' + id + '" id="sec_6_2__mob_no_' + id + '" class="form-control chk_mobile" data-minlength="10" data-maxlength="10" data-type="10 अंकों मे भरे"></div><div class="col-sm-2 form-group my-auto" id="sec_2_b_rows"><button type="button" class="btn btn-info" onclick="sec_6_2_add_rows();">नई पंक्ति जोड़े [+]</button></div></div>';
        $("#sec_2_b").append(txt);
        $("#sec_6_2_id").val(id);
    }
