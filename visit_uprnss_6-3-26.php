                        ...
                        <form action="scripts/ajax_uprnss.php" method="post" enctype="multipart/form-data"
                            ...
                            <div id="steps-container">
                                ...
                                <div class="step">
                                   ...
                                   <h5 style="background: linear-gradient(135deg, #e3f2fd 0%, #bbdefb 100%); padding: 12px 20px; border-radius: 8px; font-weight: bold; color: #1565c0; margin: 20px 0 15px 0; border-left: 4px solid #1976d2;"> 2.1. मानव सम्पदा </h5>
                                        ...
                                        <table class="table table-bordered table-hover" id="human_resource_table">
                                            <thead class="table-light" style="background-color: #b8daff;">
                                                <tr>
                                                    ...
                                                    <th style="width: 10%; color: #000; white-space: nowrap;">
                                                    </th>
                                                </tr>
                                            </thead>
                                                            ...
                                                            <div class="row mb-2 sec3c_row">
                                                                ...
                                                                <div class="col-sm-1 form-group my-auto">
                                                                    <?php if ($i == $row_3_5['sec_3_c_id']) { ?>
                                                                        <button type="button" class="btn btn-info" onclick="sec_3_c_add_rows();">नई पंक्ति जोड़ें [+]</button>
                                                                    <?php } else { ?>
...
// --------------------------------------2 START--------------------------------------
    function sec_6_2_add_rows() {
        ...
        id = id + 1;
        $("#sec_2_b_rows").remove();
      var txt = `<div class="row align-items-end mt-2">
