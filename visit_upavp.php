                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <select name="sec_3_is_map" id="sec_3_is_map" class="form-control"
                                                    tabindex="<?php echo $tab++; ?>" onchange="handleDropdownColorChange(this, 'yes', '#42ecf5', 'no', '#f28546');
                                                hide_show(this.value, '#sec_3_map_accept_1', 'yes');">
                                                    <option value="">--Select--</option>
                                            ...
                                            <div class="col-sm-3 form-group" id="sec_3_map_accept_1"
                                                style="display: none;">
                                        ...
                                        <div class="row" id="sec_3" style="display: <?php echo $sec_3_display; ?>;">
                                            <div class="col-sm-12">
                                                ...
                                                if (empty($sides_data)) {
                                                    ?>
                                                <div id="sides_display" style="display: none;" class="row"></div>
                                                <?php
                                                } else {
                                                ...
                                                <div class="col-md-12">
                                                    <div id="building_rows">
                                                        ...
                                                        <div class="row mb-2 building-row"
                                                            data-index="<?php echo $i; ?>">
                                                            <div class="col-sm-3 form-group">
                                                                <label>क्षेत्रफल (हेक्टेयर में)</label>
                                                                <input type="text"
                                                                    name="sec_3_flat_area_<?php echo $i; ?>"
                                                    ...
                                                    <button type="button" class="btn btn-success mt-2"
                                                        id="add_row_btn">+ नया पंक्ति जोड़ें</button>
                                                </div>

                                                <h5>(IV) वर्तमान मे अवशेष भूमि का विवरण</h5>
                                                <div id="sec_3_c_land_details">
                                                    <?php for ($i = 1; $i <= $row_3_c['count']; $i++) { ?>
                                                    <div class="row">
                                                        <div class="col-sm-3 form-group">
                                                            <label>क्षेत्रफल (हेक्टेयर में)</label>
                                                            <input type="text" name="sec_3_c_area_<?php echo $i; ?>"
                                                                id="sec_3_c_area_<?php echo $i; ?>"
                                                                tabindex="<?php echo $tab++; ?>"
                                                                class="form-control chk_number"
                                                                value="<?php echo $row_3_c['sec_3_c_area_' . $i]; ?>">
                                                        </div>

                                                        <div class="col-sm-3 form-group">
                                                            <label>भूमि की स्थिति (उपजाऊ / बंजर)</label>
                                                            <select name="sec_3_c_land_status_<?php echo $i; ?>"
                                                                id="sec_3_c_land_status_<?php echo $i; ?>"
                                                                tabindex="<?php echo $tab++; ?>" class="form-control">
                                                                <option value="">--select--</option>
                                                                <option value="fertile" <?php echo ($row_3_c['sec_3_c_land_status_' . $i] == 'fertile') ? 'selected' : ''; ?>>उपजाऊ</option>
                                                                <option value="barren" <?php echo ($row_3_c['sec_3_c_land_status_' . $i] == 'barren') ? 'selected' : ''; ?>>बंजर</option>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-3 form-group">
                                                            ...
                                                            <select name="sec_3_c_land_location_<?php echo $i; ?>"
                                                                ...
                                                                tabindex="<?php echo $tab++; ?>" class="form-control">
                                                                <option value="">--select--</option>
                                                                <option value="inpremise" <?php echo ($row_3_c['sec_3_c_land_location_' . $i] == 'inpremise') ? 'selected' : ''; ?>>समिति
                                                                    प्रांगण</option>
                                                                <option value="other" <?php echo ($row_3_c['sec_3_c_land_location_' . $i] == 'other') ? 'selected' : ''; ?>>अन्य स्थान</option>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-2 form-group">
                                                            <label>टिप्पणी</label>
                                                            <input type="text"
                                                                name="sec_3_c_land_remark_<?php echo $i; ?>"
                                                                id="sec_3_c_land_remark_<?php echo $i; ?>"
                                                                tabindex="<?php echo $tab++; ?>" class="form-control"
                                                                value="<?php echo $row_3_c['sec_3_c_land_remark_' . $i]; ?>">
                                                        </div>

                                                        <?php if ($i == $row_3_c['count']) { ?>
                                                        <div class="col-sm-1 form-group my-auto" id="sec_3_c_land_rows">
                                                            <button type="button" class="btn btn-info"
                                                                onclick="sec_3_c_land_add_rows()">नई पंक्ति जोड़े
                                                                [+]</button>
                                                            <input type="hidden" name="sec_3_c_land_id"
                                                                id="sec_3_c_land_id"
                                                                value="<?php echo $row_3_c['count']; ?>">
                                                        </div>
                                                        <?php } ?>
                                                    </div>
                                                    <?php } ?>
                                                ...
                                                <div class="col-sm-3 form-group">
                                                    <label>भूमि की स्थिति (उपजाऊ /बंजर)</label>
                                                    <select name="sec_3_c_vacant_land_status_<?php echo $i; ?>"
                                                        id="sec_3_c_vacant_land_status_<?php echo $i; ?>"
                                                        tabindex="<?php echo $tab++; ?>" class="form-control">
                                                        <option value="">--select--</option>
                                                        <option value="fertile" <?php if (!empty($row_3_5) && $row_3_5['sec_3_c_vacant_land_status_' . $i] == 'fertile')
                                                            echo 'selected'; ?>>अच्छा</option>
                                                        <option value="barren" <?php if (!empty($row_3_5) && $row_3_5['sec_3_c_vacant_land_status_' . $i] == 'barren')
                                                            echo 'selected'; ?>>खराब</option>
                                                    </select>
                                                </div>
                                                    ...
                                                    <div class="col-sm-2 form-group" id="access_road"
                                                        ...
                                                        <select name="sec_6_paved_road" id="sec_6_paved_road"
                                                            ...
                                                            <option value="mdr" <?php if ($row_2_1['sec_6_paved_road'] == 'mdr')
                                                                echo 'selected'; ?>>एम.डी.आर. (मेजर डिस्ट्रिक्ट रोड)</option>
                                                            <option value="odr" <?php if ($row_2_1['sec_6_paved_road'] == 'odr')
                                                                echo 'selected'; ?>>ओ.डी.आर. (ऑर्डिनरी डिस्ट्रिक्ट ROAD)</option>
...
<script>
    ...
    <div class="row">
        ...
        <div class="col-sm-2 form-group">
            <label>टिप्पणी</label>
            <input type="text" name="sec_3_c_land_remark_${new_id}" id="sec_3_c_land_remark_${new_id}" tabindex="1" class="form-control">
        </div>
