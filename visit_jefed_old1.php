                            ...
                            <div id="steps-container">
                                ...
                                <div class="step">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row human_row mb-2">
                                            <div class="col-md-4">
                                                <label>प्रखण्ड</label>
                                                <select class="form-control " id="prakhand_name" name="prakhand_name"
                                                    value="yes" tabindex="<?php echo $tab++; ?>">
                                                    <option value="">--Select--</option>
                                                    <option value="yes">लखनऊ प्रखण्ड</option>
                                                    <option value="yes">बरेली प्रखण्ड</option>
                                                </select>
                                            </div>
                                        </div>
                                        <h5>
                                ...
                                <div class="step">
                                    <h5><img src="images/logo/7.png" alt="text" class="img-fluid stat-icon"
                                            style="height:50px; width:50px;"> 1.2 समिति की प्रबंध कमेटी</h5>
                                    <div class="col-sm-12">
                                        <div class="row">
