        ...
        <div class="card">
            <div class="card-body">
                                        ...
                                        <div class="row">
                                         ...
                                         <h5>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3 form-group">
                                                            ...
                                                            <input type="text" id="global_other_office_count" class="form-control"
                                                ...
                                                <table class="table table-bordered" id="officeContainer" style="width: 100%; table-layout: fixed;">
                                                    <thead>
                                                        <tr class="office-block-header bg-light">
                                                            <th width="15%" style="color: black; font-weight: bold;">शाखाओं का नाम</th>
                                                            <th width="15%" style="color: black; font-weight: bold;">शाखाओं का दूरभाष न०</th>
                                                            <th width="20%" style="color: black; font-weight: bold;">शाखाओं का ई-मेल आई.डी.</th>
                                                            <th width="20%" style="color: black; font-weight: bold;">शाखाओं का पता</th>
                                                            <th width="100%" style="color: black; font-weight: bold;">शाखाओं की फोटो संलग्न करें</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody class="office-block" data-zone-index="1" style="border-top: 2px solid #dee2e6;">
                                                        <tr>
                                                            <td style="padding: 5px;">
                                                                <input type="text" name="zone_name[]" class="form-control zone-name" placeholder="शाखाओं का नाम">
                                                            </td>
                                                            <td style="padding: 5px;">
                                                                <input type="text" name="zone_mobile[]" class="form-control zone-mobile" placeholder="शाखाओं का दूरभाष">
                                                            </td>
                                                            <td style="padding: 5px;">
                                                                <input type="text" name="zone_email[]" class="form-control zone-email" placeholder="शाखाओं का ई-मेल">
                                                            </td>
                                                            <td style="padding: 5px;">
                                                                <input type="text" name="zone_address[]" class="form-control zone-address" placeholder="शाखाओं का पता">
                                                            </td>
                                                            <td style="padding: 5px;">
                                            ...
                                            <div class="table-responsive" id="prakhandTableWrapper" style="display:none; margin-top: 15px;">
                                                <h6 class="text-primary mb-2"> ट्रेनिंग सेंटर का विवरण</h6>
                                                <table class="table table-bordered" id="prakhandContainer" style="width: 100%; table-layout: fixed;">
                                                    <thead>
                                                        <tr class="bg-light">
                                                            <th width="15%" style="color: black; font-weight: bold;">ट्रेनिंग सेंटर का नाम</th>
                                                            <th width="15%" style="color: black; font-weight: bold;">ट्रेनिंग सेंटर का दूरभाष न०</th>
                                                            <th width="20%" style="color: black; font-weight: bold;">ट्रेनिंग सेंटर का ई-मेल आई.डी.</th>
                                                            <th width="20%" style="color: black; font-weight: bold;">ट्रेनिंग सेंटर का पता</th>
                                                            <th width="100%" style="color: black; font-weight: bold;">ट्रेनिंग सेंटर की फोटो</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody id="prakhand-main-tbody">
                                                        <tr class="prakhand-row-template">
                                                            <td><input type="text" name="prakhand_name[]" class="form-control" placeholder="ट्रेनिंग सेंटर का नाम"></td>
                                                            <td><input type="text" name="prakhand_mobile[]" class="form-control" placeholder="ट्रेनिंग सेंटर का दूरभाष"></td>
                                                            <td><input type="text" name="prakhand_email[]" class="form-control" placeholder="ट्रेनिंग सेंटर का ई-मेल"></td>
                                                            <td><input type="text" name="prakhand_address[]" class="form-control" placeholder="ट्रेनिंग सेंटर का पता"></td>
                                                            <td><input type="file" name="prakhand_image[]" class="form-control"></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            <div class="table-responsive" id="otherOfficeTableWrapper" style="display:none; margin-top: 15px;">
                                                <h6 class="text-primary mb-2">अन्य कार्यालयों का विवरण</h6>
                                                <table class="table table-bordered" id="otherOfficeContainer" style="width: 100%; table-layout: fixed;">
                                                    <thead>
                                                        <tr class="bg-light">
                                                            <th width="15%" style="color: black; font-weight: bold;">अन्य कार्यालयों का नाम</th>
                                                            <th width="15%" style="color: black; font-weight: bold;">अन्य कार्यालयों का दूरभाष न०</th>
                                                            <th width="20%" style="color: black; font-weight: bold;">अन्य कार्यालयों का ई-मेल आई.डी.</th>
                                                            <th width="20%" style="color: black; font-weight: bold;">अन्य कार्यालयों का पता</th>
                                                            <th width="100%" style="color: black; font-weight: bold;">अन्य कार्यालयों की फोटो</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody id="other-office-main-tbody">
                                                        <tr class="other-office-row-template">
                                                            <td><input type="text" name="other_office_name[]" class="form-control" placeholder="अन्य कार्यालयों का नाम"></td>
                                                            <td><input type="text" name="other_office_mobile[]" class="form-control" placeholder="अन्य कार्यालयों का दूरभाष"></td>
                                                            <td><input type="text" name="other_office_email[]" class="form-control" placeholder="अन्य कार्यालयों का ई-मेल"></td>
                                                            <td><input type="text" name="other_office_address[]" class="form-control" placeholder="अन्य कार्यालयों का पता"></td>
                                                            <td><input type="file" name="other_office_image[]" class="form-control"></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                ...
                                <!-- <div class="step"> -->
                                    <h4>
                                        <img src="images/logo/6.png" alt="text" class="img-fluid stat-icon"
                                            style="height:50px; width:50px;"> 5. मानव संपदा
                                    </h4>
                                    <div class="col-sm-12">
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped">
                                                <thead style="background-color: #b8daff; color: white;">
                                                    <tr>
                                                        <th rowspan="2" style="vertical-align: middle; text-align: center;">क्रं.</th>
                                                        <th rowspan="2" style="vertical-align: middle; text-align: center;">पद</th>
                                                        <th rowspan="2" style="vertical-align: middle; text-align: center;">स्वीकृत पद</th>
                                                        <th rowspan="2" style="vertical-align: middle; text-align: center;">रिक्त पद</th>
                                                        <th colspan="2" style="text-align: center;">कार्यरत का विवरण</th>
                                                        <th colspan="2" style="text-align: center;">संविदा/आउट्सोर्स पर कार्यरत कार्मिक</th>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <?php for ($i = 1; $i <= $row_3_5['sec_3_c_id']; $i++) { ?>
                                                            <div class="row mb-2 sec3c_row">
                                                                ...
                                                                <div class="col-sm-3 form-group">
                                                                    ...
                                                                    <input type="file" name="sec_3_c_image_<?php echo $i; ?>" class="form-control">
                                                                </div>
                ...
                <div id="q-box__buttons" class="text-center w-100 my-4">
                    <button id="prev-btn" class="btn btn-info mr-2" type="button" onClick="save_draft()">Previous</button>
                    <button id="next-btn" class="btn btn-success mr-2" type="button" onClick="save_draft()">Next</button>
                    <button id="submit-btn" class="btn btn-danger mr-2" type="submit" onClick="save_draft()">Submit</button>
