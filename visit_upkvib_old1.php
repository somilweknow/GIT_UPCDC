...
if (isset($_GET['exdid'])) {
    ...
    if (mysqli_num_rows($result_sec_6_2_1) > 0) {
        ...
        while ($row_section_6_2_1 = mysqli_fetch_assoc($result_sec_6_2_1)) {
            ...
            $row_6_2['sec_6_2__aadhar_no_' . $d] = $row_section_6_2_1['aadhar_no'];
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8 form-group" style="margin: 9px;"
                                                        ...
                                                        <input type="text" name="apex_name" id="apex_name"
                                                            tabindex="<?php echo $tab++; ?>" readonly
                                                            value="खादी तथा ग्रामोद्योग विभाग"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <select name="gram_panchayat[]" id="gram_panchayat" tabindex="2"
                                                    ...
                                                    <?php
                                                    $query = 'select * from gram_panchayt where block_sno="' . $row_invoice['block_id'] . '"';
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($posts as $row) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select class="form-control" name="education[<?= $row['id']; ?>]">
                                                                    <option value="">-- चयन करें --</option>
                                                                    <option value="इंटरमीडिएट" <?= ($education === 'इंटरमीडिएट') ? 'selected' : ''; ?>>इंटरमीडिएट</option>
                                                                    <option value="स्नातक" <?= ($education === 'स्नातक') ? 'selected' : ''; ?>>स्नातक</option>
                                                                    <option value="परास्नातक" <?= ($education === 'परास्नातक') ? 'selected' : ''; ?>>परास्नातक</option>
                                                                </select>
                                                            </td>
                                                            <td>
                                                                <select class="form-control" name="computer_exp[<?= $row['id']; ?>]">
                                                                    <option value="">-- चयन करें --</option>
                                                                    <option value="CCC" <?= ($computer_exp === 'CCC') ? 'selected' : ''; ?>>CCC</option>
                                                                    <option value="O-Level या समकक्ष" <?= ($computer_exp === 'O-Level या समकक्ष') ? 'selected' : ''; ?>>
                                                                        O-Level या समकक्ष
                                                                    </option>
                                                                    <option value="नहीं है" <?= ($computer_exp === 'नहीं है') ? 'selected' : ''; ?>>नहीं है</option>
                                                                </select>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
												...
												for ($i = 1; $i <= $row_6_2['count']; $i++) {
													...
													<div class="row">
														...
														<div class="col-sm-2 form-group">
															...
															<input type="text" name="sec_6_2__aadhar_no_<?php echo $i; ?>"
																id="sec_6_2__aadhar_no_<?php echo $i; ?>"
																tabindex="<?php echo $tab++; ?>" class="form-control chk_mobile"
																data-minlength="12" data-maxlength="12"
																data-type="4.II 12 अंकों मे भरे"
																value="<?php echo $row_6_2['sec_6_2__aadhar_no_' . $i]; ?>">
														</div>
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div id="sec_2_nirmit_godown">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-2 form-group">
                                                                <label>भवन किस श्रोत बना है</label>
                                                                <input type="text"
...
<script>
    ...
    function sec_3_c_add_rows() {
        ...
        var txt = '<div class="row"><div class="col-sm-3 form-group"><label>क्षेत्रफल (हेक्टेयर में)</label><input type="text" name="sec_3_c_length_' + id + '" id="sec_3_c_length_' + id + '" class="form-control chk_number" data-type="क्षेत्रफल हेक्टेयर में मे लिखे"></div><div class="col-sm-3 form-group"><label>भूमि की स्थिति (उपजाऊ /बंजर)</label><select name="sec_3_c_vacant_land_status_' + id + '" id="sec_3_c_vacant_land_status_' + id + '" class="form-control"><option value="">--select-- </option><option value="fertile">उपजाऊ </option><option value="barren">बंजर </option></select></div><div class="col-sm-3 form-group"><label>स्थान (समिति प्रांगण या अन्य स्थान)</label><select name="sec_3_c_land_location_' + id + '" id="sec_3_c_land_location_' + id + '" class="form-control"><option value="">--select-- </option><option value="inpremise">समिति प्रांगण </option><option value="other">अन्य स्थान </option></select></div><div class="col-sm-2 form-group my-auto" id="sec_3_c_rows"><button type="button" class="btn btn-info" onClick="sec_3_c_add_rows();">नई पंक्ति जोड़े</button><input type="hidden" name="sec_3_c_id" id="sec_3_c_id" value="' + id + '"></div></div>';
    ...
    function sec_6_2_add_rows() {
        ...
        for (var i = 1; i <= id; i++) {
            if ($("#sec_2_b_name_" + i).val() == '' || $("#sec_6_2_father_name_" + i).val() == '' || $("#sec_6_2__mob_no_" + i).val() == '' || $("#sec_6_2__aadhar_no_" + i).val() == '') {
                alert("पंक्ति संख्या " + i + " खाली है");
    ...
    function sec_2_nirmit_godown_add_rows() {
        ...
        txt += '<div class="col-sm-2 form-group"><label>लम्बाई (मीटर में)</label><input type="text" name="sec_3_b_storage_capacity_' + id + '" id="sec_3_b_storage_capacity_' + id + '" class="form-control"></div>';
        txt += '<div class="col-sm-2 form-group"><label>चौड़ाई (मीटर में)</label><input type="text" name="sec_3_b_godown_year_' + id + '" id="sec_3_b_godown_year_' + id + '" class="form-control"></div>';

        
        txt += '<div class="col-sm-2 form-group"><label>भवन का प्रकार</label><select name="sec_3_b_godown_status_' + id + '" id="sec_3_b_godown_status_' + id + '" class="form-control"><option value="">--select--</option><option value="good">अच्छा</option><option value="repairable">खराब/मरम्मत योग्य</option><option value="discarded">जर्जर/निष्प्रयोज्य्य</option></select></div>';
        txt += '<div class="col-sm-2 form-group"><label>भवन किस श्रोत बना है</label><input type="text" name="sec_3_b_godown_type_of_fund_' + id + '" id="sec_3_b_godown_type_of_fund_' + id + '" class="form-control chk_text" data-type="योजना का नाम शब्दों में भरे"></div>';
