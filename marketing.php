...
<script>
  ...
  function renderSamitiFields(status, defaults) {
    ...
    // Accept both code values and Hindi labels
    ...
    if (isActive) {
      html += `
        ...
        <div><label class="form-label">सचिव का नाम</label>
          <input type="text" name="secretary_name" class="form-control" value="<?= h($form['secretary_name'] ?? '') ?>">

        </div>
        <div><label class="form-label">सचिव का मो० न०</label>
        <input type="text" name="secretary_mob" class="form-control" value="<?= h($form['secretary_mob'] ?? '') ?>">
        </div>
        <div><label class="form-label">सचिव का मेल-आईडी</label>
        <input type="text" name="secretary_email" class="form-control" value="<?= h($form['secretary_email'] ?? '') ?>">
        </div>
        <div><label class="form-label">समिति की स्थिति</label>
          <input type="text" name="samiti_status" class="form-control" value="${val('samiti_status')}">
        </div>
        <div><label class="form-label">समिति के अध्यक्ष का नाम</label>
          <input type="text" name="chairmain_name" class="form-control" value="${val('chairmain_name')}">
      ...
      html += `
        ...
        <div><label class="form-label">सचिव का नाम</label>
          <input type="text" name="secretary_name" class="form-control" value="${val('secretary_name')}" >
        </div>
        <div><label class="form-label">सचिव का मो० न०</label>
          <input type="text" name="secretary_mob" class="form-control" value="${val('secretary_mob')}" >
        </div>
        <div><label class="form-label">सचिव का मेल-आईडी</label>
          <input type="text" name="secretary_email" class="form-control" value="${val('secretary_email')}">
        </div>
         <div><label class="form-label">समिति की स्थिति</label>
          <input type="text" name="samiti_status" class="form-control" value="${val('samiti_status')}">
        </div>
  ...
  document.addEventListener('DOMContentLoaded', () => {
    // Insert: keep blank; Edit: if empty, default to active
    let initStatus = INIT.status && INIT.status.trim() !== '' ? INIT.status : '';
    if (IS_EDIT && initStatus === '') initStatus = 'active';
