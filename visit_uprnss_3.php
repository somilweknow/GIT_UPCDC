...
$row_3_new_1 = [
    'sec_3_profit_loss_1' => '', 'sec_3_profit_loss_amount_1' => '', 'sec_3_accumulated_1' => '', 'sec_3_accumulated_amount_1' => '',
    'sec_3_profit_loss_2' => '', 'sec_3_profit_loss_amount_2' => '', 'sec_3_accumulated_2' => '', 'sec_3_accumulated_amount_2' => '',
    'sec_3_profit_loss_3' => '', 'sec_3_profit_loss_amount_3' => '', 'sec_3_accumulated_3' => '', 'sec_3_accumulated_amount_3' => '',
    'sec_3_financial_audit_year' => '', 'sec_3_audit_grading' => '', 'sec_3_compliance_status' => '', 'sec_3_agm_year' => '',
    'sec_3_dividend_year' => '', 'sec_3_dividend_per' => '', 'sec_3_dividend_amt' => '', 'sec_3_santulan_patra' => ''
];
$row_2_1_2 = ['count' => 1, 'sec_2_1_2_business_description_1' => '', 'sec_2_1_2_value_1' => ''];
$human_rows = [['post_id' => '', 'sanctioned_post' => '', 'vacant_post' => '']];
$row_new_plot = [
    'sec_3_ownership' => '', 'sec_new_plot_area' => '', 'sec_new_plot_revenue_status' => '', 'sec_new_plot_reason_for_not_record' => '',
    'sec_new_plot_practices_if_not' => '', 'sec_new_plot_gata_no' => '', 'sec_3_building_area' => '', 'sec_3_building_rent' => '',
    'sec_3_remark' => '', 'sec_new_remarks' => ''
];
...
$row_2_1 = [
    'sec_6_access_road' => '', 'sec_6_paved_road' => '', 'sec_6_2_truck_not_reach' => '', 'sec_8_plot_frontage' => '',
    'investment' => '', 'loan' => '', 'msp' => '', 'msp_comm' => '', 'subscribers' => '', 'pds' => '', 'total_business' => '',
    'last_year_profit_loss' => '', 'last_year_pl_amount' => '', 'seq_year_profit_loss' => '', 'seq_year_pl_amount' => '',
    'financial_audit_year' => '', 'approach_road_photo' => '', 'construction_status' => '', 'approach_road' => '',
    'distance_from_approach_road' => '', 'electric_connection' => '', 'electric_connection_proposal' => '', 'internet_connectivity' => '',
    'sec_7_electrical_connection' => '', 'sec_7_electrical_connection_working' => '', 'sec_7_if_yes' => '', 'sec_8_internet_connection' => ''
];
$row_other_land = [
    'count' => 1, 'other_land_district_1' => '', 'other_land_tehsil_1' => '', 'other_land_area_type_1' => '', 'other_land_land_area_1' => '',
    'other_land_ownership_1' => '', 'other_land_other_owner_1' => '', 'other_land_land_status_1' => '', 'other_land_construction_1' => '',
    'other_land_other_construct_1' => '', 'other_land_address_1' => '', 'other_land_latitude_1' => '', 'other_land_longitude_1' => '', 'other_land_location_mode_1' => ''
];
$row_8 = [
    'sec_8_electrical_connection' => '', 'sec_8_electrical_connection_working' => '', 'sec_8_bill_paid_yes_no' => '',
    'sec_8_electricity_not_available_reason' => '', 'sec_8_electricity_not_available_remark' => '', 'sec_8_bill_not_paid_month' => '',
    'sec_8_outstanding_amount' => '', 'sec_8_solar_connection' => '', 'sec_8_solar_work_status' => '', 'sec_8_solar_bill_paid' => '',
    'sec_8_solar_rooftop' => '', 'sec_8_solar_remark' => '', 'sec_8_solar_date' => '', 'sec_8_internet_connection' => '',
    'sec_8_internet_service_provider' => '', 'sec_8_internet_bill_paid' => '', 'sec_8_select_internet_operator' => '',
    'internet_not_bill_paid_month' => '', 'sec_8_internet_outstanding_amount' => '', 'sec_8_narrow_tubes' => '',
    'sec_8_water_tank' => '', 'sec_8_samarsabel' => '', 'sec_8_handpump' => '', 'sec_8_internet_active' => ''
];
...
#business_matrix_table td.text-center button {
    ...
    width: 100%;         /* Optional: button fills the cell width */
    border-radius: 0.5rem; /* Rounded edges to match inputs */
}
.table-striped thead {
...
<!-- ------------------------------------------------4th start --------------------------------- -->
                                            <div class="step">
                                                ...
                                                <div class="col-sm-12">
                                                    <div id="business_matrix">
                                                        <div class="row mb-1">
                                                            <div class="col-sm-2"><label class="form-label">वर्ष</label></div>
                                                            <div class="col-sm-3"><label class="form-label">व्यवसाय का विवरण</label></div>
                                                            <div class="col-sm-2"><label class="form-label">वार्षिक टर्नओवर</label></div>
                                                            <div class="col-sm-3">
                                                                <div class="row g-1">
                                                                    <div class="col-6"><label class="form-label">लक्ष्य</label></div>
                                                                    <div class="col-6"><label class="form-label">उपलब्धि</label></div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        for ($i = 1; $i <= $count; $i++) {
                                                        ?>
                                                        <div class="row mb-2 business_matrix_row">
                                                            <div class="col-sm-2 form-group">
                                                                <input type="text" name="business_year_<?php echo $i; ?>" class="form-control" value="<?php echo $row_2_1_2['business_year_' . $i] ?? ''; ?>">
                                                            </div>
                                                            <div class="col-sm-3 form-group">
                                                                <input type="text" name="business_description_<?php echo $i; ?>" class="form-control" value="<?php echo $row_2_1_2['sec_2_1_2_business_description_' . $i] ?? ''; ?>">
                                                            </div>
                                                            <div class="col-sm-2 form-group">
                                                                <input type="text" name="business_turnover_<?php echo $i; ?>" class="form-control" value="<?php echo $row_2_1_2['sec_2_1_2_value_' . $i] ?? ''; ?>">
                                                            </div>
                                                            <div class="col-sm-3 form-group">
                                                                <div class="row g-1">
                                                                    <div class="col-6">
                                                                        <input type="text" name="business_target_<?php echo $i; ?>" class="form-control" value="<?php echo $row_2_1_2['business_target_' . $i] ?? ''; ?>">
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <input type="text" name="business_achievement_<?php echo $i; ?>" class="form-control" value="<?php echo $row_2_1_2['business_achievement_' . $i] ?? ''; ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-1 form-group my-auto">
                                                                <?php if ($i == $count) { ?>
                                                                    <button type="button" class="btn btn-info" onclick="business_matrix_add_row();">+</button>
                                                                    <input type="hidden" name="other_business_id" id="other_business_id" value="<?php echo $count; ?>">
                                                                <?php } else { ?>
                                                                    <button type="button" class="btn btn-danger" onclick="$(this).closest('.business_matrix_row').remove();">-</button>
                                                                <?php } ?>
                                                            </div>
                                                        </div>
                                                        <?php } ?>
                                            ...
                                            function business_matrix_add_row() {
                                                ...
                                                <div class="row mb-2 business_matrix_row">
                                                    <div class="col-sm-2 form-group">
                                                        <input type="text" name="business_year_${id}" class="form-control">
                                                    </div>
                                                    <div class="col-sm-3 form-group">
                                                    ...
                                                    <div class="col-sm-3 form-group">
                                                        <div class="row g-1">
                                                            <div class="col-6">
                                                                <label class="form-label mb-0">लक्ष्य</label>
                                                                <input type="text" name="business_target_${id}" class="form-control">
                                                            </div>
                                                            <div class="col-6">
                                                                <label class="form-label mb-0">उपलब्धि</label>
                                                ...
                                                `;
                                                document.getElementById('business_matrix').insertAdjacentHTML('beforeend', html);
                                            }
                                            </script>
                                ...
                                <!----------------5th start-------------------------------------------------------->
                                        ...
                                        <div class="step">
                                        <h4>
                                            <img src="images/logo/6.png" alt="text" class="img-fluid stat-icon" style="height:50px; width:50px;">
                                            5. मानव सम्पदा
                                        </h4>
                                        ...
                                        <div id="human_resource_rows">
                                            <div class="row human_row mb-2 align-items-end">
                                                ...
                                                <div class="col-md-3 form-group">
                                                    <label>पद</label>
                                                    <select name="post_id[]" class="form-control" onchange="updateStaffSection(this)">
                                                        <option value="">--Select--</option>
                                                ...
                                                <div class="col-md-3 form-group">
                                                    ...
                                                    <input type="number" name="sanctioned_post[]" class="form-control" onchange="updateStaffSection(this)">
                                                </div>
                                        ...
                                        <div id="staff_section" style="display:none;" class="mt-3">
                                            ...
                                            <div class="d-flex justify-content-end mt-3">
                                                <button type="button" class="btn btn-primary btn-sm me-3" onclick="uploadDocument()" style="margin-right:1rem;">Upload Document</button>
                                                <button type="button" class="btn btn-success btn-sm" onclick="downloadExcel()" style="height: 40px;">Download Excel</button>
                                            </div>
                                        </div>
                                        ...
                                        <div id="staff_row_template" style="display:none;">
                                            <div class="staff_row border p-3 mb-3 rounded">
                                                <div class="row">
                                                    <div class="col-md-3 form-group">
                                                        <label>पद</label>
                                                        <input type="text" name="staff_post_name[]" class="form-control staff_post_name" readonly>
                                                    </div>
                                                    <div class="col-md-3 form-group">
                                                        <label>नाम</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <button type="button" class="btn btn-info btn-block mt-2"
                                                    onClick="getLocation();">लोकेशन रिफ्रेश करें</button>
                                                    <div class="blinking-text">(संस्था का लोकेशन मोबाईल से भरे)*</div>
                                            </div>
