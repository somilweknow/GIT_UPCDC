                            ...
                            <div class="row d-flex my-auto">
                                ...
                                <div class="step">
                                    ...
                                    <div class="col-sm-12">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8 form-group" style="margin: 9px;"   id="sec_1_institute_name_container">
                                                                        ...
                                                                        <input type="text" id="" name="" tabindex = "<?php echo $tab++; ?>" readonly value="दुग्धशाला विकास विभाग, उ०प्र०">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-8">
                                        ...
                                        <div class="col-sm-12">
                                            <small><b>सदस्यों का विवरण</b></small><br>
                                            <div class="row">
                                                <div class="col-sm-3 form-group">
                                                    <label>पंजीकरण के समय सदस्यों कि संख्या :</label>
                                                ...
                                                <div class="col-sm-3 form-group">
                                                    <label>वर्तमान में सदस्यो की संख्या</label>
                                        ...
                                        <div class="col-sm-12">
                                            <small><b> नए बनाये गए सदस्यों की संख्या :</b></small>
                                            <div class="row">
                                                <div class="col-sm-3 form-group">
                                                    <label>01 अप्रैल से भारती किये गए सदस्यों कि संख्या :</label>
                                                    <input type="text" name="sec_1_active members_no"
                                                        id="sec_1_active members_no" tabindex="<?php echo $tab++; ?>"
                                                        class="form-control" value="<?php echo $row_2_1['msp']; ?>">
                                                </div>
                                        ...
                                        <div class="col-sm-6">
                                            <small><b>कुल सदस्यों की संख्या :</b></small>
                                            <div class="row">
                                ...
                                <!----------------5th start-------------------------------------------------------->
                                            <div class="step">
                                                <h4><img src="images/logo/6.png" alt="text" class="img-fluid stat-icon"
                                                        style="height:50px; width:50px;"> 3 (I) मानव सम्पदा</h4>
                                                <div class="col-sm-12">
                                ...
                                <div class="step">
                                    <h4><img src="images/logo/11.png" alt="text" class="img-fluid stat-icon"
                                            style="height:50px; width:50px;"> 4. समिति भवन/सम्पत्ति का विवरण</h2>
                                        <div class="col-sm-12">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="col-sm-3 form-group">
                                ...
                                <!-- <!---------------7th Start
                                            <div class="step">
                                                <h4><img src="images/logo/8.png" alt="text" class="img-fluid stat-icon"
                                                        style="height:50px; width:50px;"> 6. सुविधाएं </h4>
                                                <h5>(I) सुविधाएं</h5>
                                                <div class="col-sm-12"> 
                                                 <div class="row">
                                                <div class="col-sm-4 form-group">
                                ...
                                <div class="step">
                                    <h4><img src="images/logo/12.png" alt="text" class="img-fluid stat-icon"
                                            style="height:50px; width:50px;"> 7. कंप्यूटरीकरण की स्थिति </h4>
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="row">
                                                ...
                                                <h4><img src="images/logo/10.png" alt="text" class="img-fluid stat-icon"
                                                        style="height:50px; width:50px;"> 8. निरीक्षण स्थिति</h4>
                                                <div class="row">
                                                    <div class="col-sm-2 form-group">
