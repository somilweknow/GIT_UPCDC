                                            ...
                                            <div class="office-block border p-3 mb-3 rounded" data-index="1">
                                               ...
                                               <div class="row">
                                                    ...
                                                    <div class="col-md-3 form-group">
                                                        ...
                                                        <div class="blinking-text mt-2">(मुख्यालय का लोकेशन मोबाईल से भरे)*</div>
                                                    </div>
                                                    <!-- <div class="col-md-10" id="map_container">
                                                        <iframe id="googlemap"
                                                            src="https://maps.google.com/maps?q=<?php echo $row_invoice['latitude'] . ',' . $row_invoice['longitude']; ?>&hl=en&z=13&amp;output=embed"
...
<!-- ------------------------------------------------4th start --------------------------------- -->
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="business_matrix_row">
                                                                    ...
                                                                    <td class="text-center">
                                                                        <?php if ($i == $count) { ?>
                                                                            <button type="button" class="btn btn-info btn-sm" onclick="business_matrix_add_row();">+</button>
                                            ...
                                            function business_matrix_add_row() {
                                                ...
                                                `;
                                                document.getElementById('business_matrix').querySelector('tbody').insertAdjacentHTML('beforeend', html);
                                            }
                                            </script>
