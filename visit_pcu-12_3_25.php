                        ...
                        <form action="scripts/ajax_pcu.php" method="post" enctype="multipart/form-data" id="user_form"
                            ...
                            <div id="steps-container">
                                ...
                                <div class="col-sm-12">
                                                        ...
                                                        <tr id="sec_6_2_row_<?php echo $i; ?>">
                                                            <td>
                                                                <select name="sec_6_2_category_<?php echo $i; ?>" class="form-control"
                                                                    ...
                                                                    <option value="">--select-- </option>
                                                                    <option value="yes" <?php echo (isset($row_6_2['sec_6_2_category_' . $i]) && $row_6_2['sec_6_2_category_' . $i] == 'yes') ? 'selected' : ''; ?>>पदेन</option>
                                                                    <option value="yes" <?php echo (isset($row_6_2['sec_6_2_category_' . $i]) && $row_6_2['sec_6_2_category_' . $i] == 'yes') ? 'selected' : ''; ?>>निर्वाचित</option>
                                                                    <option value="no" <?php echo (isset($row_6_2['sec_6_2_category_' . $i]) && $row_6_2['sec_6_2_category_' . $i] == 'no') ? 'selected' : ''; ?>>नामित</option>
                                                                </select>
                                    ...
                                    $posts = [];
                                    $sql_posts = "SELECT * FROM master_posts_pcu ORDER BY sno ASC";
                                    ...
                                    <div id="staff_section" style="display:none;" class="mt-3">
                                        <h5 style="background: linear-gradient(135deg, #e3f2fd 0%, #bbdefb 100%); padding: 12px 20px; border-radius: 8px; font-weight: bold; color: #1565c0; margin: 20px 0 15px 0; border-left: 4px solid #1976d2;">कर्मचारी विवरण</h5>
                                            ...
                                            <div class="row">
                                               ...
                                               <div class="col-md-3 form-group">
                                                    ...
                                                    <select name="staff_qualification[]" class="form-control">
                                                        <option value="">--Select--</option>
                                                        <option value="इंटरमीडिएट">इंटरमीडिएट</option>
                                                        ...
                                                        <?php for ($i = 1; $i <= $row_3_5['sec_3_c_id']; $i++) { ?>
                                                            <div class="row mb-2 sec3c_row">
                                                                ...
                                                                <div class="col-sm-2 form-group">
                                                                    ...
                                                                    <select name="sec_3_c_paved_road_<?php echo $i; ?>" id="sec_3_c_paved_road_<?php echo $i; ?>" class="form-control">
                                                                        <option value="">--select--</option>
                                                                ...
                                                                <div class="col-sm-2 form-group">
                                                                    ...
                                                                    <select name="sec_3_c_land_location_<?php echo $i; ?>" id="sec_3_c_land_location_<?php echo $i; ?>" class="form-control">
                                                                        <option value="">--select-- </option>
                                                                ...
                                                                <div class="col-sm-1 form-group my-auto">
                                                                    <?php if ($i == $row_3_5['sec_3_c_id']) { ?>
                                                                        <button type="button" class="btn btn-info" onclick="sec_3_c_add_rowss();">नई पंक्ति जोड़ें [+]</button>
                                                                    <?php } else { ?>
    ...
    <script>
        function sec_6_2_add_rows() {
            ...
            var html = '<tr id="sec_6_2_row_' + count + '">' +
                '<td>' +
                '<select name="sec_6_2_category_' + count + '" class="form-control" onchange="color_change(this, \'yes\', \'#42ecf5\', \'no\', \'#f28546\');">' +
                '<option value="">--select-- </option>' +
                ...
                '</td>' +
                '<td>' +
                '<select name="sec_6_2_designation_' + count + '" class="form-control" onchange="color_change(this, \'yes\', \'#42ecf5\', \'no\', \'#f28546\');">' +
                '<option value="">--select-- </option>' +
