...
if (isset($_POST['submit'])) {
    ...
    if ($username !== '' && $password !== '') {
        ...
        $sql = "SELECT u.*, t.type_name  FROM ncd_users u JOIN ncd_user_type t ON u.type_id = t.id WHERE u.u_name = '$username' AND u.u_pass = '$password' AND u.is_active = 1 LIMIT 1";
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            ...
            $sql_session = "INSERT INTO session
    (user_type, user_id, user, otp_verification, s_start_date, s_start_time, last_active, s_id, admin_remarks)
    VALUES
    (
        '" . $row['type_name'] . "',
        '" . $row['id'] . "',
        ...
        'ncd_login'
            ...
            $_SESSION['session_insert_id'] = mysqli_insert_id($db);
