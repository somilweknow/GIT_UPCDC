										...
										<div class="row">
											<div class="col-md-4">
												<div class="row">
													...
													<div class="col-sm-8">बी-पैक्स<?php echo $row_info['society_name']; ?></div>
												</div>
												<div class="row">
													<div class="col-md-4">
														<h6>मण्डल : </h6>
												...
												<div class="row">
													...
													<div class="col-md-8">
														<?php echo $row_info['society_type_id']; ?>
													</div>
												</div>
												<div class="row">
													<div class="col-md-4">
													...
													<div class="col-md-8">
														<?php echo $row_info['mobile_number']; ?>
													</div>
												</div>
											</div>
											<div class="col-md-8">
