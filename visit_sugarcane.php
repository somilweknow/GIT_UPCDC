                            ...
                            <div class="row d-flex my-auto">
                                ...
                                <div class="step">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8 form-group" style="margin: 9px;"   id="sec_1_institute_name_container">
                                                                        ...
                                                                        <input type="text" id="" name="" tabindex = "<?php echo $tab++; ?>" readonly value="सरकारी गन्ना एवं चीनी मिल समितिया, उ०प्र०">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-2 form-group">
                                                                ...
                                                                <input type="text" name="sec_1_society_registration_date" id="sec_1_society_registration_date" tabindex="<?php echo $tab++; ?>" class="form-control" value="<?php echo $row_invoice['sec_1_society_registration_date']; ?>" readonly>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <!-- <div class="col-sm-3 form-group" id="sec_1_dispute_details"
                                                                style="display: none;">
                                                                <label>विवाद का विवरण</label>
                                                                <textarea name="sec_1_dispute_details" id="sec_1_dispute_details"
                                                                    class="form-control"
                                                                    rows="2"><?php echo isset($row_invoice['dispute_details']) ? htmlspecialchars($row_invoice['dispute_details']) : ''; ?></textarea>
                                                            </div> -->
                                        ...
                                        <div class="col-sm-12">
                                            <small><b>(I) कृषक सदस्यों का विवरण :</b></small><br>
                                            <div class="row">
                                                <div class="col-sm-3 form-group">
                                                    <label>सक्रिय सदस्यो की संख्या</label>
                                                    <input type="text" name="sec_1_active members_no"
                                                        id="sec_1_active members_no" tabindex="<?php echo $tab++; ?>"
                                                        class="form-control" value="<?php echo $row_2_1['msp']; ?>">
                                                </div>
                                                <div class="col-sm-3 form-group">
                                                    <label>निष्क्रिय सदस्यो की संख्या</label>
                                                    <input type="text" name="sec_1_inactive members_no"
                                                        id="sec_1_inactive members_no" tabindex="<?php echo $tab++; ?>"
                                                        class="form-control"
                                                        value="<?php echo $row_2_1['msp_comm']; ?>">
                                                </div>
                                                <div class="col-sm-3 form-group">
                                                    <label>कुल कृषक सदस्यों की संख्या</label>
                                                    <input type="text" name="sec_1_total_farmers"
                                                        id="sec_1_total_farmers" tabindex="<?php echo $tab++; ?>"
                                        ...
                                        <div class="col-sm-12">
                                            <small><b> (II) अकृषक सदस्यों की संख्या :</b></small>
                                            <div class="row">
                                                <div class="col-sm-3 form-group" id="total_farmers_container">
                                                    <input type="text" name="sec_1_total_farmers"
                                                        id="sec_1_total_farmers" tabindex="<?php echo $tab++; ?>"
                                                        class="form-control"
                                                        value="<?php echo $row_2_1['msp_comm']; ?>">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4 form-group">
                                                    ...
                                                    <input type="text" name="sec_1_new members" id="sec_1_new members"
                                                        tabindex="<?php echo $tab++; ?>" class="form-control"
                                                        value="<?php echo $row_2_1['msp_comm']; ?>">
                                                </div>
                                                <div class="col-sm-4 form-group">
                                                    <label>01-अप्रैल-2024 से प्राप्त अंशधन </label>
                                                    <input type="text" name="sec_1_share_capital"
                                                        id="sec_1_share_capital" tabindex="<?php echo $tab++; ?>"
                                                        class="form-control"
                                                        value="<?php echo $row_2_1['msp_comm']; ?>">
                                                </div>
                                                <div class="col-sm-4 form-group">
                                                    <label>01-अप्रैल-2024 से निष्क्रिय से सक्रिय किए गए सदस्यों की
                                                        संख्या</label>
                                                    <input type="text" name="sec_1_inactive_to_active"
                                                        id="sec_1_inactive_to_active" tabindex="<?php echo $tab++; ?>"
                                                        class="form-control"
                                                        value="<?php echo $row_2_1['msp_comm']; ?>">
                                                </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-2 form-group">
                                                    <input type="text" name="sec_1_loan" id="sec_1_loan"
                                        ...
                                        <div class="col-sm-12">
                                            <small><b> (V) कुल परिवारों कि संख्या :</b></small>
                                            <div class="row">
                                                <div class="col-sm-2 form-group">
                                                    <input type="text" name="sec_1_loan" id="sec_1_loan"
                                                        tabindex="<?php echo $tab++; ?>" class="form-control"
                                ...
                                <!----------------2.1 start-------------------------------------------------------->
                                            <div class="step">
                                                <h4> <img src="images/logo/4.png" alt="text" class="img-fluid stat-icon"
                                                        style="height:50px; width:50px;"> 2. E-Stock Register(ई-स्टॉक रजिस्टर)</h4>
                                                <div class="col-sm-12">
                                                    <!-- <div class="row">
                                            <div class="col-sm-4 form-group">
                                                <label>क्या ट्रैडिंग स्टॉक का बीमा हुआ है ?</label>
                                                <select name="sec_2_stock_insurance" class="form-control" onchange="color_change(this, 'yes', '#42ecf5', 'no', '#f28546');">
                                                    <option value="">--select-- </option>
                                                    <option value="yes">हाँ</option>
                                                    <option value="no">नहीं</option>
                                                </select>
                                                    ...
                                                    <table class="table table-bordered table-striped table-hover">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <th>1.</th>
                                                                <th>कंप्यूटर इंफ्रास्ट्रक्चर - Computer Infrastructure</th>
                                                                <th><input type="text" name="computer_infra_2023"
                                                                        class="form-control"></th>
                                                                <th><input type="text" name="computer_infra_value_2023"
                                                                        class="form-control"></th>
                                                                <th><input type="text" name="computer_infra_4" class="form-control">
                                                                </th>
                                                                <th><input type="text" name="computer_infra_value_4"
                                                                        class="form-control"></th>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>i) डेस्कटाप कंप्यूटर - Desktop (CPU, Monitor, Keyboard, Mouse)
                                                                </td>
                                                                ...
                                                                <td><input type="text" name="desktop_value_4" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>ii) प्रिंटर - Printer</td>
                                                                ...
                                                                <td><input type="text" name="printer_value_4" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>iv) कैमरा - Camera</td>
                                                                ...
                                                                <td><input type="text" name="camera_value_4" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>v) यू0पी0एस0 - UPS</td>
                                                                ...
                                                                <td><input type="text" name="ups_value_4" class="form-control"></td>
                                                            </tr>

                                                            <tr>
                                                                <th>2.</th>
                                                                <th>फर्निचर एवं अन्य समान - Furniture</th>
                                                                <th><input type="text" name="pmksk_infra_2023" class="form-control">
                                                                </th>
                                                                <th><input type="text" name="pmksk_value_2023" class="form-control">
                                                                </th>
                                                                <th><input type="text" name="pmksk_infra_4" class="form-control">
                                                                </th>
                                                                <th><input type="text" name="pmksk_value_4" class="form-control">
                                                                </th>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>i) एल0ई0डी0 टीवी - LED</td>
                                                                <td><input type="text" name="led_2023" class="form-control"></td>
                                                                <td><input type="text" name="led_value_2023" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="led_4" class="form-control"></td>
                                                                <td><input type="text" name="led_value_4" class="form-control"></td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>ii) कुर्सी - Chair</td>
                                                                <td><input type="text" name="chair_2023" class="form-control"></td>
                                                                <td><input type="text" name="chair_value_2023" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="chair_4" class="form-control"></td>
                                                                <td><input type="text" name="chair_value_4" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>iii) मेज्‌ - Table</td>
                                                                <td><input type="text" name="table_2023" class="form-control"></td>
                                                                <td><input type="text" name="table_value_2023" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="table_4" class="form-control"></td>
                                                                <td><input type="text" name="table_value_4" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>iv) इंट्री गेट - Fabricated Gate</td>
                                                                <td><input type="text" name="gate_2023" class="form-control"></td>
                                                                <td><input type="text" name="gate_value_2023" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="gate_4" class="form-control"></td>
                                                                <td><input type="text" name="gate_value_4" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>v) रैक - Rack</td>
                                                                <td><input type="text" name="rack_2023" class="form-control"></td>
                                                                <td><input type="text" name="rack_value_2023" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="rack_4" class="form-control"></td>
                                                                <td><input type="text" name="rack_value_4" class="form-control">
                                                                </td>
                                                            </tr>

                                                            <tr>
                                                                <th>3.</th>
                                                                <th>कृषि उपकरण - Agriculture Instruments/Implements</th>
                                                                <th><input type="text" name="agri_instru_2023" class="form-control">
                                                                </th>
                                                                <th><input type="text" name="agri_value_2023" class="form-control">
                                                                </th>
                                                                <th><input type="text" name="agri_instru_4" class="form-control">
                                                                </th>
                                                                <th><input type="text" name="agri_value_4" class="form-control">
                                                                </th>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>i) पावर स्प्रेयर - Power Sprayer Machine (Motorized/Battery
                                                                    Operated)</td>
                                                                <td><input type="text" name="sprayer_2023" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="sprayer_value_2023"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="sprayer_4" class="form-control"></td>
                                                                <td><input type="text" name="sprayer_value_4" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>ii) पावर टिल्लर - Power tiller</td>
                                                                <td><input type="text" name="tiller_2023" class="form-control"></td>
                                                                <td><input type="text" name="tiller_value_2023"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="tiller_4" class="form-control"></td>
                                                                <td><input type="text" name="tiller_value_4" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>iii) ड्रोन - Drone</td>
                                                                <td><input type="text" name="drone_2023" class="form-control"></td>
                                                                <td><input type="text" name="drone_value_2023" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="drone_4" class="form-control"></td>
                                                                <td><input type="text" name="drone_value_4" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>iv) एलेक्ट्रोनिक माप मशीन - Electronic Weighing Machine</td>
                                                                <td><input type="text" name="weighing_machine_3"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="weighing_machine_value_3"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="weighing_machine_4"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="weighing_machine_value_4"
                                                                        class="form-control"></td>
                                                            </tr>

                                                            <tr>
                                                                <th>4</th>
                                                                <th>पी0ओ0एस0 - POS Machine</th>
                                                                <td><input type="text" name="pos_machine_3" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="pos_machine_value_3"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="pos_machine_4" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="pos_machine_value_4"
                                                                        class="form-control"></td>
                                                            </tr>

                                                            <tr>
                                                                <th>5</th>
                                                                <th>न्यूनतम समर्थन मूल्य (एम0एस0पी) से जुडे‌ समान - Items Related to
                                                                    Purchase (MSP)</th>
                                                                <td><input type="text" name="msp_items_3" class="form-control"></td>
                                                                <td><input type="text" name="msp_items_value_3"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="msp_items_4" class="form-control"></td>
                                                                <td><input type="text" name="msp_items_value_4"
                                                                        class="form-control"></td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>i) पी0ओ0पी0 मशीन - POP Machine</td>
                                                                <td><input type="text" name="pop_machine_3" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="pop_machine_value_3"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="pop_machine_4" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="pop_machine_value_4"
                                                                        class="form-control"></td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>ii) छलना - Chalana</td>
                                                                <td><input type="text" name="chalana_3" class="form-control"></td>
                                                                <td><input type="text" name="chalana_value_3" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="chalana_4" class="form-control"></td>
                                                                <td><input type="text" name="chalana_value_4" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>iii) पावर डस्टर - Power Duster</td>
                                                                <td><input type="text" name="power_duster_3" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="power_duster_value_3"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="power_duster_4" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="power_duster_value_4"
                                                                        class="form-control"></td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>iv) विनोविंग फैन - Winnowing Fan</td>
                                                                <td><input type="text" name="winnowing_fan_3" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="winnowing_fan_value_3"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="winnowing_fan_4" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="winnowing_fan_value_4"
                                                                        class="form-control"></td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>v) नमी मापने का यंत्र - Moisture Meter</td>
                                                                <td><input type="text" name="moisture_meter_3" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="moisture_meter_value_3"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="moisture_meter_4" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="moisture_meter_value_4"
                                                                        class="form-control"></td>
                                                            </tr>

                                                            <!-- <tr>
                                                    <th>6</th>
                                                    <th>फर्नीचर - Furniture</th>
                                                    <td><input type="text" name="furniture_3" class="form-control"></td>
                                                    <td><input type="text" name="furniture_value_3" class="form-control"></td>
                                                    <td><input type="text" name="furniture_4" class="form-control"></td>
                                                    <td><input type="text" name="furniture_value_4" class="form-control"></td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td>i) कुर्सी - Chair</td>
                                                    <td><input type="text" name="furniture_chair_3" class="form-control"></td>
                                                    <td><input type="text" name="furniture_chair_value_3" class="form-control"></td>
                                                    <td><input type="text" name="furniture_chair_4" class="form-control"></td>
                                                    <td><input type="text" name="furniture_chair_value_4" class="form-control"></td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td>ii) टेबल - Table</td>
                                                    <td><input type="text" name="furniture_table_3" class="form-control"></td>
                                                    <td><input type="text" name="furniture_table_value_3" class="form-control"></td>
                                                    <td><input type="text" name="furniture_table_4" class="form-control"></td>
                                                    <td><input type="text" name="furniture_table_value_4" class="form-control"></td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td>iii) रैक - Rack</td>
                                                    <td><input type="text" name="furniture_rack_3" class="form-control"></td>
                                                    <td><input type="text" name="furniture_rack_value_3" class="form-control"></td>
                                                    <td><input type="text" name="furniture_rack_4" class="form-control"></td>
                                                    <td><input type="text" name="furniture_rack_value_4" class="form-control"></td>
                                                </tr> -->

                                                            <tr>
                                                                <th>7</th>
                                                                <th>फिक्सचर - Fixture</th>
                                                                <td><input type="text" name="fixture_3" class="form-control"></td>
                                                                <td><input type="text" name="fixture_value_3" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="fixture_4" class="form-control"></td>
                                                                <td><input type="text" name="fixture_value_4" class="form-control">
                                                                </td>
                                                            </tr>

                                                            <tr>
                                                                <th>8</th>
                                                                <th>अलमारी - Almirah</th>
                                                                <td><input type="text" name="almirah_3" class="form-control"></td>
                                                                <td><input type="text" name="almirah_value_3" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="almirah_4" class="form-control"></td>
                                                                <td><input type="text" name="almirah_value_4" class="form-control">
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <th>9</th>
                                                                <th>तिजोरी - Safe</th>
                                                                <td><input type="text" name="safe_3" class="form-control"></td>
                                                                <td><input type="text" name="safe_value_3" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="safe_4" class="form-control"></td>
                                                                <td><input type="text" name="safe_value_4" class="form-control">
                                                                </td>
                                                            </tr>

                                                            <tr>
                                                                <th>10</th>
                                                                <th>अन्य - Miscellaneous</th>
                                                                <td><input type="text" name="miscellaneous_3" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="miscellaneous_value_3"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="miscellaneous_4" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="miscellaneous_value_4"
                                                                        class="form-control"></td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>i) सोलर सेट - Solar</td>
                                                                <td><input type="text" name="solar_set_3" class="form-control"></td>
                                                                <td><input type="text" name="solar_set_value_3"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="solar_set_4" class="form-control"></td>
                                                                <td><input type="text" name="solar_set_value_4"
                                                                        class="form-control"></td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>ii) ए0सी0 - AC</td>
                                                                <td><input type="text" name="ac_3" class="form-control"></td>
                                                                <td><input type="text" name="ac_value_3" class="form-control"></td>
                                                                <td><input type="text" name="ac_4" class="form-control"></td>
                                                                <td><input type="text" name="ac_value_4" class="form-control"></td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>iii) हीटर - Heater</td>
                                                                <td><input type="text" name="heater_3" class="form-control"></td>
                                                                <td><input type="text" name="heater_value_3" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="heater_4" class="form-control"></td>
                                                                <td><input type="text" name="heater_value_4" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                            ...
                                                            <tr>
                                                                <td></td>
                                                                <td>vi) अन्य कोई मूल्यवान वस्तु - Any Other Valuable Item</td>
                                                                <td><input type="text" name="valuable_item_3" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="valuable_item_value_3"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="valuable_item_4" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="valuable_item_value_4"
                                                                        class="form-control"></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table class="table table-bordered table-striped table-hover">
                                                        <tbody>
                                                            <tr>
                                                                <th colspan="7">SCRAPPED (निषप्रयोज)</th>
                                                            </tr>
                                                            <thead>
                                                                <tr>
                                                                    <th>S.No.</th>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>1</td>
                                                                <td><input type="text" name="item_name_1" class="form-control"></td>
                                                                <td><input type="text" name="item_description_1"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="scheme_name_1" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>2</td>
                                                                <td><input type="text" name="item_name_2" class="form-control"></td>
                                                                <td><input type="text" name="item_description_2"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="scheme_name_2" class="form-control">
                                                                </td>
                                                            <tr>
                                                                <td>3</td>
                                                                <td><input type="text" name="item_name_3" class="form-control"></td>
                                                                <td><input type="text" name="item_description_3"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="scheme_name_3" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>4</td>
                                                                <td><input type="text" name="item_name_4" class="form-control"></td>
                                                                <td><input type="text" name="item_description_4"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="scheme_name_4" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>5</td>
                                                                <td><input type="text" name="item_name_5" class="form-control"></td>
                                                                <td><input type="text" name="item_description_5"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="scheme_name_5" class="form-control">
                                                                </td>
                                                            <tr>
                                                                <td>6</td>
                                                                <td><input type="text" name="item_name_6" class="form-control"></td>
                                                                <td><input type="text" name="item_description_6"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="scheme_name_6" class="form-control">
                                                                </td>
                                                            <tr>
                                                                <td>7</td>
                                                                <td><input type="text" name="item_name_7" class="form-control"></td>
                                                                <td><input type="text" name="item_description_7"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="scheme_name_7" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>8</td>
                                                                <td><input type="text" name="item_name_8" class="form-control"></td>
                                                                <td><input type="text" name="item_description_8"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="scheme_name_8" class="form-control">
                                                                </td>
                                                            <tr>
                                                                <td>9</td>
                                                                <td><input type="text" name="item_name_9" class="form-control"></td>
                                                                <td><input type="text" name="item_description_9"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="scheme_name_9" class="form-control">
                                                                </td>
                                                            <tr>
                                                                <td>10</td>
                                                                <td><input type="text" name="item_name_10" class="form-control">
                                                                </td>
                                                                <td><input type="text" name="item_description_10"
                                                                        class="form-control"></td>
                                                                <td><input type="text" name="scheme_name_10" class="form-control">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table><br><br>
                                                    ...
                                                    <table class="table table-bordered table-striped table-hover">
                                                        <tbody>
                                                            <tr>
                                                                <th colspan="7">FY-24-25 Purchase</th>
                                                            </tr>
                                                            <thead>
                                                                <tr>
                                                                    <th>S.No.</th>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td><input type="date" name="date_1" class="form-control"></td>
                                                                <td><input type="text" name="purchase_value_1" class="form-control">
                                                                </td>
                                                                <td><input type="number" name="quantity_1" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>2</td>
                                                                ...
                                                                <td><input type="date" name="date_2" class="form-control"></td>
                                                                <td><input type="text" name="purchase_value_2" class="form-control">
                                                                </td>
                                                                <td><input type="number" name="quantity_2" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>3</td>
                                                                ...
                                                                <td><input type="date" name="date_3" class="form-control"></td>
                                                                <td><input type="text" name="purchase_value_3" class="form-control">
                                                                </td>
                                                                <td><input type="number" name="quantity_3" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>4</td>
                                                                ...
                                                                <td><input type="date" name="date_4" class="form-control"></td>
                                                                <td><input type="text" name="purchase_value_4" class="form-control">
                                                                </td>
                                                                <td><input type="number" name="quantity_4" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>5</td>
                                                                ...
                                                                <td><input type="date" name="date_5" class="form-control"></td>
                                                                <td><input type="text" name="purchase_value_5" class="form-control">
                                                                </td>
                                                                <td><input type="number" name="quantity_5" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>6</td>
                                                                ...
                                                                <td><input type="date" name="date_6" class="form-control"></td>
                                                                <td><input type="text" name="purchase_value_6" class="form-control">
                                                                </td>
                                                                <td><input type="number" name="quantity_6" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>7</td>
                                                                ...
                                                                <td><input type="date" name="date_7" class="form-control"></td>
                                                                <td><input type="text" name="purchase_value_7" class="form-control">
                                                                </td>
                                                                <td><input type="number" name="quantity_7" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>8</td>
                                                                ...
                                                                <td><input type="date" name="date_8" class="form-control"></td>
                                                                <td><input type="text" name="purchase_value_8" class="form-control">
                                                                </td>
                                                                <td><input type="number" name="quantity_8" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>9</td>
                                                                ...
                                                                <td><input type="date" name="date_9" class="form-control"></td>
                                                                <td><input type="text" name="purchase_value_9" class="form-control">
                                                                </td>
                                                                <td><input type="number" name="quantity_9" class="form-control">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>10</td>
                                                                ...
                                                                <td><input type="date" name="date_10" class="form-control"></td>
                                                                <td><input type="text" name="purchase_value_10"
                                                                        class="form-control"></td>
                                                                <td><input type="number" name="quantity_10" class="form-control">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                ...
                                <div class="step">
                                    ...
                                    <div class="col-sm-12">
                                        <?php
                                        $count_2_1_2 = !empty($row_2_1_2['count']) ? (int)$row_2_1_2['count'] : 1;
                                        for ($i = 1; $i <= $count_2_1_2; $i++) {
                                            ?>
                                        <div class="row">
                                            <div class="col-sm-3 form-group">
                                            ...
                                            <div class="step">
                                                ...
                                                <div class="col-sm-12">
                                                    <table class="table table-bordered table-striped table-hover">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>कंप्युटर का अनुभव</th>
                                                                <th>अनुमोदन स्तर</th>
                                                                <th>नियुक्ति वर्ष</th>
                                                                <th>प्रबंध समिति का प्रस्ताव संख्या एवं दिनांक</th>
                                                                <th>कार्मिक प्रकार</th>
                                                                <th>यदि अस्थाई हैं, तो आउटसोर्स/दैनिक/संविदा</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <!-- Secretary -->
                                                            <tr>
                                                                <td>1. सचिव</td>
                                                                <td>
                                                                    <select class="form-control" id="sec_2_secretary"
                                                                        name="sec_2_secretary" onChange="toggleSections(this)">
                                                                        <option value="">--Select--</option>
                                                                        <option value="yes">कैडर सचिव</option>
                                                                        <option value="no">प्रभारी सचिव</option>
                                                                    </select>
                                                                </td>
                                                                <td><input type="text" name="sec_2_name" class="form-control"
                                                                        placeholder=""></td>
                                                                <td><input type="text" name="sec_2_father_name" class="form-control"
                                                                        placeholder=""></td>
                                                                <td><input type="text" name="sec_2_address" class="form-control"
                                                                        placeholder=""></td>
                                                                <td><input type="text" name="sec_2_birth_date" class="form-control"
                                                                        placeholder=""></td>
                                                                <td>
                                                                    <select class="form-control"
                                                                        name="sec_2_education_qualification"
                                                                        id="sec_2_education_qualification">
                                                                        <option value="">--Select--</option>
                                                                ...
                                                                <td>
                                                                    <select class="form-control" name="sec_2_computer_qualification"
                                                                        id="sec_2_computer_qualification">
                                                                        <option value="">--Select--</option>
                                                                        <option value="1">CCC</option>
                                                                        <option value="2">O-Level या समकक्ष</option>
                                                                    </select>
                                                                </td>
                                                                <td>
                                                                    <select class="form-control" name="sec_2_approval_level"
                                                                        id="sec_2_approval_level">
                                                                        <option value="">--Select--</option>
                                                                        <option value="ARCS">AR</option>
                                                                        <option value="ADO">DR/JR</option>
                                                                        <option value="none">कोई नहीं</option>
                                                                    </select>
                                                                </td>
                                                                <td>
                                                                    <select name="sec_2_appointment_date"
                                                                        id="sec_2_appointment_date" class="form-control">
                                                                        <option value="">--Select--</option>
                                                                    <?php for ($i = 2022; $i >= 1975; $i--): ?>
                                                                            <option value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                                    <?php endfor; ?>
                                                                    </select>
                                                                </td>
                                                                <td><input type="text" name="sec_2_additional_approval_level"
                                                                        class="form-control" placeholder="">
                                                                </td>
                                                                <td>
                                                                    <select class="form-control" name="sec_2_employee_type"
                                                                        id="sec_2_employee_type"
                                                                        onchange="hide_show(this.value, '#sec_111', '2')">
                                                                        <option value="">--Select--</option>
                                                                ...
                                                                <td>
                                                                    <select class="form-control" name="sec_111" id="sec_111"
                                                                        style="display:none;">
                                                                        <option value="">--Select--</option>
                                                                        <option value="outsourced">आउटसोर्स</option>
                                                                        <option value="daily">दैनिक</option>
                                                                        <option value="contract">संविदा</option>
                                                                    </select>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td>2.लेखाकार</td>
                                                                <td>
                                                                    <select class="form-control" id="acc_secretary"
                                                                        name="acc_secretary" onChange="toggleSections(this)">
                                                                        <option value="">--Select--</option>
                                                                        <option value="yes">हैं</option>
                                                                        <option value="no">नहीं</option>
                                                                    </select>
                                                                </td>
                                                                <td><input type="text" name="acc_name" class="form-control"
                                                                        placeholder=""></td>
                                                                <td><input type="text" name="acc_father_name" class="form-control"
                                                                        placeholder=""></td>
                                                                <td><input type="text" name="acc_address" class="form-control"
                                                                        placeholder=""></td>
                                                                <td><input type="text" name="acc_birth_date" class="form-control"
                                                                        placeholder=""></td>
                                                                <td>
                                                                    <select class="form-control" name="acc_education_qualification"
                                                                        id="acc_education_qualification">
                                                                        <option value="">--Select--</option>
                                                                        <option value="intermediate">इंटरमीडिएट</option>
                                                                        <option value="graduate">स्नातक</option>
                                                                        <option value="postgraduate">परास्नातक</option>
                                                                ...
                                                                <td>
                                                                    <select class="form-control" name="acc_approval_level"
                                                                        id="acc_approval_level">
                                                                        <option value="">--Select--</option>
                                                                        <option value="ARCS">AR</option>
                                                                        <option value="ADO">DR/JR</option>
                                                                        <option value="none">कोई नहीं</option>
                                                                ...
                                                                <td>
                                                                    <select name="acc_appointment_date" id="acc_appointment_date"
                                                                        class="form-control">
                                                                        <option value="">--Select--</option>
                                                                    <?php for ($i = 2022; $i >= 1975; $i--): ?>
                                                                            <option value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                                ...
                                                                <td><input type="text" name="acc_additional_approval_level"
                                                                        class="form-control" placeholder=""></td>
                                                                <td>
                                                                    <select class="form-control" name="acc_employee_type"
                                                                        id="acc_employee_type"
                                                                        onchange="hide_show(this.value, '#sec_112', '2')">
                                                                        <option value="">--Select--</option>
                                                                        <option value="1">नियमित</option>
                                                                        <option value="2">अस्थाई</option>
                                                                    </select>
                                                                ...
                                                                <td>
                                                                    <select class="form-control" name="acc_temporary_details"
                                                                        id="sec_112" style="display:none;">
                                                                        <option value="">--Select--</option>
                                                                        <option value="outsourced">आउटसोर्स</option>
                                                                        <option value="daily">दैनिक</option>
                                                                        <option value="contract">संविदा</option>
                                                            ...
                                                            <!-- Assistant Accountant Section -->
                                                            <tr>
                                                                <td>2. सहायक लेखाकार</td>
                                                                <td>
                                                                    <select class="form-control" id="assist_acc_secretary"
                                                                        name="assist_acc_secretary" onChange="toggleSections(this)">
                                                                        <option value="">--Select--</option>
                                                                        <option value="yes">हैं</option>
                                                                        <option value="no">नहीं</option>
                                                                    </select>
                                                                </td>
                                                                <td><input type="text" name="assist_acc_name" class="form-control"
                                                                        placeholder=""></td>
                                                                <td><input type="text" name="assist_acc_father_name"
                                                                        class="form-control" placeholder=""></td>
                                                                <td><input type="text" name="assist_acc_address"
                                                                        class="form-control" placeholder=""></td>
                                                                <td><input type="text" name="assist_acc_birth_date"
                                                                        class="form-control" placeholder=""></td>
                                                                <td>
                                                                    <select class="form-control"
                                                                        name="assist_acc_education_qualification"
                                                                        id="assist_acc_education_qualification">
                                                                        <option value="">--Select--</option>
                                                                        <option value="intermediate">इंटरमीडिएट</option>
                                                                        <option value="graduate">स्नातक</option>
                                                                        <option value="postgraduate">परास्नातक</option>
                                                                ...
                                                                <td>
                                                                    <select class="form-control" name="assist_acc_approval_level"
                                                                        id="assist_acc_approval_level">
                                                                        <option value="">--Select--</option>
                                                                        <option value="ARCS">AR</option>
                                                                        <option value="ADO">DR/JR</option>
                                                                        <option value="none">कोई नहीं</option>
                                                                ...
                                                                <td>
                                                                    <select name="assist_acc_appointment_date"
                                                                        id="assist_acc_appointment_date" class="form-control">
                                                                        <option value="">--Select--</option>
                                                                    <?php for ($i = 2022; $i >= 1975; $i--): ?>
                                                                            <option value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                                    <?php endfor; ?>
                                                                ...
                                                                <td><input type="text" name="assist_acc_additional_approval_level"
                                                                        class="form-control" placeholder=""></td>
                                                                <td>
                                                                    <select class="form-control" name="assist_acc_employee_type"
                                                                        id="assist_acc_employee_type"
                                                                        onchange="hide_show(this.value, '#sec_113', '2')">
                                                                        <option value="">--Select--</option>
                                                                        <option value="1">नियमित</option>
                                                                        <option value="2">अस्थाई</option>
                                                                    </select>
                                                                ...
                                                                <td>
                                                                    <select class="form-control" name="assist_acc_temporary_details"
                                                                        id="sec_113" style="display:none;">
                                                                        <option value="">--Select--</option>
                                                                        <option value="outsourced">आउटसोर्स</option>
                                                                        <option value="daily">दैनिक</option>
                                                                        <option value="contract">संविदा</option>
                                                            ...
                                                            <tr>
                                                                <td>8. रोकड़िया</td>
                                                                <td>
                                                                    <select class="form-control" id="sec_2_rokadiya"
                                                                        name="sec_2_rokadiya" onChange="toggleSections(this)">
                                                                        <option value="">--Select--</option>
                                                                        <option value="yes">हैं</option>
                                                                        <option value="no">नहीं</option>
                                                                    </select>
                                                                ...
                                                                <td>
                                                                    <select class="form-control" name="sec_2_employee_type"
                                                                        id="sec_2_employee_type"
                                                                        onchange="hide_show(this.value, '#sec_114', '2')">
                                                                        <option value="">--Select--</option>
                                                                        <option value="1">नियमित</option>
                                                                        <option value="2">अस्थाई</option>
                                                                    </select>
                                                                ...
                                                                <td>
                                                                    <select class="form-control" name="sec_2_temporary_details"
                                                                        id="sec_114" style="display:none;">
                                                                        <option value="">--Select--</option>
                                                                        <option value="outsourced">आउटसोर्स</option>
                                                                        <option value="daily">दैनिक</option>
                                                                        <option value="contract">संविदा</option>
                                                            ...
                                                            <tr>
                                                                <td>5. विक्रेता</td>
                                                                <td>
                                                                    <select class="form-control" id="sec_2_vendor"
                                                                        name="sec_2_vendor" onChange="toggleSections(this)">
                                                                        <option value="">--Select--</option>
                                                                        <option value="yes">हैं</option>
                                                                        <option value="no">नहीं</option>
                                                                    </select>
                                                                ...
                                                                <td>
                                                                    <select class="form-control" name="sec_2_employee_type"
                                                                        id="sec_2_employee_type"
                                                                        onchange="hide_show(this.value, '#sec_115', '2')">
                                                                        <option value="">--Select--</option>
                                                                        <option value="1">नियमित</option>
                                                                        <option value="2">अस्थाई</option>
                                                                    </select>
                                                            ...
                                                            <!-- कंप्युटर ऑपरेटर Section -->
                                                            <tr>
                                                                <td>6. कंप्यूटर ऑपरेटर</td>
                                                                <td>
                                                                    <select class="form-control" id="sec_2_computer_operator"
                                                                        name="sec_2_computer_operator"
                                                                ...
                                                                <td>
                                                                    <select class="form-control" name="sec_2_employee_type"
                                                                        id="sec_2_employee_type"
                                                                        onchange="hide_show(this.value, '#sec_116', '2')">
                                                                        <option value="">--Select--</option>
                                                                        <option value="1">नियमित</option>
                                                                        <option value="2">अस्थाई</option>
                                                                    </select>
                                                            ...
                                                            <tr>
                                                                <td>7. चौकीदार</td>
                                                                <td>
                                                                    <select class="form-control" id="sec_2_guard" name="sec_2_guard"
                                                                        onChange="toggleSections(this)">
                                                                        <option value="">--Select--</option>
                                                                        <option value="yes">हैं</option>
                                                                        <option value="no">नहीं</option>
                                                                ...
                                                                <td>
                                                                    <select class="form-control"
                                                                        ...
                                                                        id="sec_2_education_qualification">
                                                                        <option value="">--Select--</option>
                                                                        <option value="5th_pass">5वीं पास</option>
                                                                ...
                                                                <td>
                                                                    <select class="form-control" name="sec_2_employee_type"
                                                                        id="sec_2_employee_type"
                                                                        onchange="hide_show(this.value, '#sec_117', '2')">
                                                                        <option value="">--Select--</option>
                                                                        <option value="1">नियमित</option>
                                                                        <option value="2">अस्थाई</option>
                                                                    </select>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3 form-group" id="guard_count2" style="display:none;">
                                                            <label>प्रबंध कमेटी की प्रस्ताव संख्या</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3 form-group">
                                                            ...
                                                            <select name="sec_3_a_land_length" id="sec_3_a_land_length"
                                                                ...
                                                                <option value="">--Select--</option>
                                                                <option value="3" <?php echo $row_3_1['number_of_sides'] == '3' ? ' selected="selected" ' : ''; ?>>खुद के स्वामित्व में
                                                                </option>
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4 form-group" id="access_road_truck"
                                                            ...
                                                            <label>यदि समिति भवन तक ट्रक नही पहुंचता है तो पक्के मार्ग
                                                                से समिति
                                ...
                                <!---------------7th Start---------------------------------------------------------------->
                                            <div class="step">
                                                ...
                                                <h5>(VI) रेन वाटर हारवेस्टिंग की उपलब्धता</h5>
                                                <div class="col-sm-12">
                                                    <div class="row">
                                                        <div class="col-sm-3 form-group">
                                                            <label>रेन वाटर हारवेस्टिंग</label>
                                                            <select name="sec_6_narrow_tubes" id="sec_6_narrow_tubes"
                                                                tabindex="<?php echo $tab++; ?>" class="form-control"
                                                                color_change(this, 'yes' , '#42ecf5' , 'no' , '#f28546' );>
                                                                <option value="">--select-- </option>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    <div class="col-sm-6 form-group">
                                                        <label>क्या केंद्र सरकार की योजना अंतर्गत समिति चयनित है
                                                            ?</label>
                                                        <select class="form-control " type="select" value="yes"
                                                            name="sec_2_govt_program" id="sec_2_govt_program"
                                                            tabindex="<?php echo $tab++; ?>"
                                                            onchange="hide_show(this.value, '#hw_secure', ['first', 'second']); hide_show(this.value, '#comp_work_completed', ['first', 'second']);">
                                                            <option value="">--Select--</option>
                                                            ...
                                                            <option value="na" <?php echo $row_2_2['govt_program'] == 'na' ? ' selected="selected" ' : ''; ?>>अभी
                                                                चयनित नहीं</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-sm-6 form-group">
                                                        <label>अन्य विवरण (यदि आवश्यक हो)</label>
                                                        <input type="text" name="sec_2_other_description"
                                                            id="sec_2_other_description" tabindex="<?php echo $tab++; ?>"
                                                            class="form-control" tabindex="<?php echo $tab++; ?>"
                                                            value="<?php echo $row_2_2['other_description']; ?>">
                                                    </div>
                                                    <div class="col-sm-3 form-group" id="hw_secure" style="display: none;">
                                                        <label>क्या इंस्टाल्ड हार्डवेयर सुरक्षित है ?</label>
                                                        <select name="hw_secure" id="hw_secure" class="form-control"
                                                            onchange="color_change(this, 'yes', '#42ecf5', 'no', '#f28546');">
                                                            <option value="">--select--</option>
                                                            <option value="yes">हाँ</option>
                                                            <option value="no">नहीं</option>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3 form-group" id="comp_work_completed" style="display:none;">
                                                        <label>क्या बी-पैक्स ERP Go-Live हो चुकी है ?</label>
                                                        <select class="form-control" id="comp_work_completed"
                                                            name="comp_work_completed" tabindex="<?php echo $tab++; ?>"
                                                            onChange="hide_show(this.value, '#balance_sheet', 'yes');hide_show(this.value, '#day_end', 'yes'); color_change(this, 'yes', '#42ecf5', 'no', '#f28546');">
                                                            <option value="">--Select--</option>
                                                            <option value="yes">हाँ</option>
                                                            <option value="no">नहीं</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-sm-3 form-group date-field" id="balance_sheet"
                                                        style="display: none;">
                                                        <label>क्या 31-मार्च-2024 की बैलेंस शीट कंप्यूटर से बनी
                                                            ?</label>
                                                        <select name="balance_sheet" id="balance_sheet" class="form-control"
                                                            onchange="color_change(this, 'yes', '#42ecf5', 'no', '#f28546');">
                                                            <option value="">--select--</option>
                                                            <option value="yes">हाँ</option>
                                                            <option value="no">नहीं</option>
                                                    ...
                                                    <div class="col-sm-3 form-group date-field" id="day_end" style="display: none;">
                                                        <label>क्या 01-अप्रैल-2024 से नियमित डे-इन्ड हो रहा है ?</label>
                                                        <select name="day_end" id="day_end" class="form-control"
                                                            onchange="color_change(this, 'yes', '#42ecf5', 'no', '#f28546');">
                                                            <option value="">--select--</option>
                                                            <option value="yes">हाँ</option>
                                                            <option value="no">नहीं</option>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3 form-group">
                                                        <label>बी-पैक्स का निरीक्षण किसके द्वारा किया गया</label>
                                                        <select name="inspection_person" id="inspection_person" class="form-control"
                                                            onchange="hide_show(this.value, '#inspection_date', 'yes');">
                                                            <option value="">--Select--</option>
                                                            <option value="yes">ए० डी० ओ० (ADO)</option>
                                                            <option value="yes">ए० डी० सी० ओ० (ADCO)</option>
                                                            <option value="yes">ए० आर० (AR)</option>
                                                            <option value="yes">डी० आर० (DR)/ जॉइन्ट रजिस्ट्रार (JR)
                                                            </option>
                                                            <option value="yes">डी० जी० एम० (DGM)</option>
                                                            <option value="yes">शाखा प्रबंधक</option>
                                                            <option value="yes">जिला सहकारी बैंक मुख्य कार्यकारी अधिकारी </option>
                                                            <option value="no">नहीं किया गया</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-sm-3 form-group date-field" id="inspection_date">
                                                        <label>कब किया गया ?</label>
                                                        <input type="date" name="inspection_date" id="inspection_date"
                                                            class="form-control">
                                                    </div>
                                                    <div class="col-sm-3 form-group" id="last_inspection_date">
                                                        <label>अंतिम निरीक्षण की तिथि</label>
                                                        <input type="date" name="last_inspection_date" name="last_inspection_date"
                                                            class="form-control">
                                                    </div>
                                                    <div class="col-sm-3 form-group">
                                                        <label>निरीक्षण के महत्वपूर्ण बिन्दु</label>
                                                        <textarea name="remarks" class="form-control"></textarea>
                                                    </div>
                                                    <div class="col-sm-3 form-group">
                                                        <label>अनुपालन की स्थिति</label>
                                                        <textarea name="compliance" class="form-control"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div id="success">
                                    <div class="mt-5 text-center">
                                        ...
                                        <button class="btn btn-info" onclick="window.open('preview.php','_blank');">प्रपत्र पुनः
                                            निरीक्षण के लिये
                                            देखे</button>
                                    </div>
