...
<?php
$sql = "SELECT m.*, md.district_name, dv.division_name FROM marketing m LEFT JOIN master_district md ON m.district_id = md.sno LEFT JOIN master_division dv ON m.division_id = dv.sno WHERE 1=1";
