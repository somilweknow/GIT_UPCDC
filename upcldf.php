                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <select name="hq_ownership" id="hq_ownership" class="form-control"
                                                    ...
                                                    onchange="hide_show(this.value, '#hq_rent_block', 'kiraye_pe'); hide_show(this.value, '#hq_area_block', 'kiraye_pe');">
                                                    <option value="">--Select--</option>
                                            ...
                                            <div class="col-sm-3 form-group" id="hq_area_block" style="display: none;">
                                                <label>संस्था भवन का क्षेत्रफल (स्क्वायर मीटर में)</label>
                                                <input type="text" name="hq_area" id="hq_area"
                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                                    value="<?php echo htmlspecialchars($row_invoice['hq_area'] ?? ''); ?>">
                                            </div>
                                            <div class="col-sm-3 form-group" id="hq_rent_block" style="display: none;">
                                                <label>संस्था भवन का मासिक किराया</label>
                                                <input type="text" name="hq_rent" id="hq_rent"
                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                                    value="<?php echo htmlspecialchars($row_invoice['hq_rent'] ?? ''); ?>">
                                            </div>
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <thead>
                                                    <tr class="office-block-header bg-light">
                                                        ...
                                                        <th width="100%" style="color: black; font-weight: bold;">जोन की
                                                            फोटो GPS टैग के संलग्न करें</th>
                                                    </tr>
                                                </thead>
