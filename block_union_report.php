    ...
    <div class="table-container">
        <div class="table-wrap">
            <table id="general_stat_table" class="report-table">
                <thead>
                    <tr>
                        <th style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:100px;">S.No.
                        </th>
                        <th style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:100px;">NCD ID
                        </th>
                        <th style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:120px;">मण्डल
                        </th>
                        <th style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:120px;">जिला
                        </th>
                        <th style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:100px;">समिति
                            <br> सक्रिय?</th>
                        <th style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:300px;">समिति
                            का नाम</th>
                        <th style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:100px;">भूमि
                            क्षेत्रफल</th>
                        <th style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:100px;">भूमि
                            स्थिति</th>
                        <th style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:100px;">स्थान
                        </th>
                        <th style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:100px;">गोदाम
                            उपयुक्त</th>
                        <th style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:100px;">रैक
                            दूरी<br> (किमी)</th>
                        <th style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:100px;">पहुंच
                            मार्ग</th>
                        <th style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:120px;">
                            परिसमापक <br> का नाम</th>
                        <th style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:120px;">कब
                            से<br> परिसमापक</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    $sql = "SELECT s.*, dt.district_name, dv.division_name FROM block_union s LEFT JOIN master_district dt ON s.janpad_name = dt.sno LEFT JOIN master_division dv ON s.mandal_name = dv.sno WHERE 1=1 and s.is_deleted=0";
                    ...
                    if ($user_type === 'ar_dr') {
                        ...
                        if (!empty($dr_div_ids)) {
                            $sql .= " AND s.mandal_name IN (" . implode(',', $dr_div_ids) . ")";
                        } else {
                        ...
                        if (!empty($_SESSION['division_id'])) {
                            ...
                            if ($div_ids)
                                $sql .= " AND s.mandal_name IN (" . implode(',', $div_ids) . ")";
                        }
                    ...
                    if ($result) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<tr>";
                            echo "<td style='white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:100px;'></td>";
                            ...
                            if ($should_blink) {
                                ...
                                echo "<span class='blink-red'>" . h($row['land_area']) . "</span>";
                                echo "<br>";
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row, meta) {
                        // Continuous serial number across all pages
...
<script>
    function confirmLand(id, value) {
        ...
        xhr.send("id=" + id + "&value=" + value + "&table=block_union");
    }
</script>
<?php
page_footer_start();
