...
// }
        ?>
                            ...
                            <div class="row d-flex my-auto">
                                ...
                                <div class="step">
											...
											<div class="col-md-4">
												<div class="row">
													...
													<div class="col-sm-8 form-group" style="margin: 9px;"   id="sec_1_institute_name_container">
														...
														<input type="text" id="" name="" tabindex = "<?php echo $tab++; ?>" readonly value="उ०प्र० सहकारी ग्राम विकास बैक">
													</div>
												</div>
											</div>
											<div class="col-md-8">
                                        ...
                                        <div class="row">
											...
											<div class="col-sm-3 form-group">
												...
												<input type="date" name="sec_1_society_registration_date"
													id="sec_1_society_registration_date"
													tabindex="<?php echo $tab++; ?>" class="form-control"
													value="<?php echo $row_invoice['sec_1_society_registration_date']; ?>"
													>
											</div>
											<?php
											...
											?>
                                                        ...
                                                        <div class="row">
                                                            <!-- <div class="col-sm-3 form-group">
                                                                ...
                                                                <input type="text" name="sec_1_committees_member_no"
                                                                    id="sec_1_committees_member_no" tabindex="<?php echo $tab++; ?>"
                                                                    class="form-control" value="<?php echo $row_2_1['msp']; ?>">
                                                            </div>
                                                            <div class="col-sm-3 form-group">
                                                                <label><b>(II) सामान्य सदस्यों की संख्या</b></label>
                                                            ...
                                                            <!-- <div class="col-sm-3 form-group">
                                                                <label><b>(III) कृषक सदस्यों की संख्या :</b></label>
                                                                <input type="text" name="sec_1_farmer_members"
                                                                    id="sec_1_farmer_members" tabindex="<?php echo $tab++; ?>"
                                                                    class="form-control"
                                                                    value="<?php echo $row_2_1['msp_comm']; ?>">
                                                            </div> -->
                                                        ...
                                                        <!-- <small style="padding-left: 6px;"><b>(V) सदस्य समितियों की सूची </b></small>
                                                        <table class="table table-bordered table-striped table-hover">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>1.</td>
                                                                    <td><input type="text" name="sec_1_division_1"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_district_1"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_tehseel_1"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_block_1"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_committee_type_1"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_branches_no_1"
                                                                            class="form-control"></td>
                                                                </tr>                                                                
                                                                <tr>
                                                                    <td>2.</td>
                                                                    <td><input type="text" name="sec_1_division_2"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_district_2"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_tehseel_2"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_block_2"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_committee_type_2"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_branches_no_2"
                                                                            class="form-control"></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>3.</td>
                                                                    <td><input type="text" name="sec_1_division_3"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_district_3"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_tehseel_3"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_block_3"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_committee_type_3"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_branches_no_3"
                                                                            class="form-control"></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>4.</td>
                                                                    <td><input type="text" name="sec_1_division_4"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_district_4"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_tehseel_4"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_block_4"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_committee_type_4"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_branches_no_4"
                                                                            class="form-control"></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>5.</td>
                                                                    <td><input type="text" name="sec_1_division_5"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_district_5"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_tehseel_5"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_block_5"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_committee_type_5"
                                                                            class="form-control"></td>
                                                                    <td><input type="text" name="sec_1_branches_no_5"
                                                                            class="form-control"></td>
                                                                </tr>                                                               
                                                            </tbody>
                                                        </table> 
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <select name="sec_2_stock_insurance"
                                                                                            class="form-control">
                                                                                            <option value="">--select--</option>
                                                                                            <option value="yes">शाखा</option>
                                                                                            <option value="no">ट्रैनिंग सेंटर</option>
                                                                                            <option value="no">जनपदीय कार्यालय</option>
                                                                                            <option value="no">क्षेत्रीय कार्यालय
                                                                                            </option>
                                                                                            <option value="no">अन्य कार्यालय</option>
                                                                                        </select>
                                                                                    </td>
                                                                                    <td><input type="text"
                                                                                            name="sec_1_2_name<?php echo $i; ?>"
                                                                                            class="form-control"></td>
                                                                                    <td><input type="text"
                                                                                            name="sec_1_2_division<?php echo $i; ?>"
                                                                                            class="form-control"></td>
                                                                                    <td><input type="text"
                                                                                            name="sec_1_2_district<?php echo $i; ?>"
                                                                                            class="form-control"></td>
                                                                                    <td><input type="text"
                                                                                            name="sec_1_2_tehsil<?php echo $i; ?>"
                                                                                            class="form-control"></td>
                                                                                    <td><input type="text"
                                                                                            name="sec_1_2_address<?php echo $i; ?>"
                                                                                            class="form-control"></td>
                                                                                    <td><input type="text"
                                                                                            name="sec_1_2_mobile<?php echo $i; ?>"
                                                                                            class="form-control"></td>
                                                                                    <td><input type="text"
                                                                                            name="sec_1_2_email<?php echo $i; ?>"
                                                                                            class="form-control"></td>
                                                                                    <td><input type="text"
                                                                                            name="sec_1_2_pincode<?php echo $i; ?>"
                                                                                            class="form-control"></td>
                                                                                    <td><input type="text"
                                                                                            name="sec_1_2_latitude<?php echo $i; ?>"
                                                                                            class="form-control"></td>
                                                                                    <td><input type="text"
                                                                                            name="sec_1_2_longitude<?php echo $i; ?>"
                                                                                            class="form-control"></td>
                                                                                </tr>
                                                                        <?php endfor; ?>
                                                                        </tbody>
                                                ...
                                                <div class="col-sm-12">
                                                    <!-- <div class="row">
                                                        <div class="col-sm-4 form-group">
                                                            <label>क्या ट्रेडिंग स्टॉक का बीमा हुआ है ?</label>
                                ...
                                <div class="step">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2 form-group">
                                                ...
                                                <select name="sec2_financial_audit" class="form-control"
                                                    ...
                                                    <option value="no">लागू नहीं है</option>
                                                </select>
                                            </div>
                                        ...
                                        <h5><img src="images/logo/training.png" alt="text" class="img-fluid stat-icon"
                                                style="height:60px; width:60px;">3(II) मूल्य समर्थन योजना</h5><br>
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th>वर्ष</th>
                                                        <th>विवरण </th>
                                                        <th>लक्ष्य (मैं० टन मे )</th>
                                                        <th>पूर्ति (मैं० टन मे )</th>
                                                        <th>लाभान्वित कृषकों की संख्या </th>
                                                        <th>कृषकों को भुगतान (धनं० लाख मे )</th>
                                                    </tr>
                                                    <tr>
                                                        <th>1</th>
                                                        <th>2</th>
                                                ...
                                                <tbody>
                                                        ...
                                                        <table class="table table-bordered table-striped">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>पूर्ति (मैं० टन मे )</th>
                                                                    <th>लाभान्वित कृषकों की संख्या </th>
                                                                    <th>कृषकों को भुगतान (धनं० करोड़ मे )</th>
                                                                </tr>
                                                                <tr>
                                                                    <th>1</th>
                                                                    <th>2</th>
                                                    ...
                                                    <!-- <div class="row"> -->
                                                    <div class="col-sm-3 form-group">
                                                        <label><b>(III) राष्ट्रीय को - आपरेटिव सोसायटी</b></label>
                                                        <select name="sec_new_3_pds_1" id="sec_new_3_pds_1"
                                                            tabindex="<?php echo $tab++; ?>" class="form-control"
                                                            onChange="hide_show(this.value, '#sec_2_pds_tornover', 'yes'); handleDropdownColorChange(this, 'yes', '#42ecf5', 'no', '#f28546');">
                                                            <option value="">--Select--</option>
                                                            <option value="yes" <?php echo isset($row_new_3['sec_new_3_pds_1']) && $row_new_3['sec_new_3_pds_1'] == 'yes' ? 'selected="selected"' : '' ?>
                                                                style="background:#0f0">हाँ</option>
                                                            <option value="no" <?php echo isset($row_new_3['sec_new_3_pds_1']) && $row_new_3['sec_new_3_pds_1'] == 'no' ? 'selected="selected"' : '' ?>
                                                                style="background:#f00">नहीं</option>
                                                        </select>
                                                    </div>

                                                    <?php
                                                    $displayStyle_sec_new_3_pds_1 = $row_new_3['sec_new_3_pds_1'] == "yes" ? "display: block;" : "display: none;";
                                                    ?>

                                                    <div class="col-sm-12" id="sec_2_pds_tornover"
                                                        style="<?php echo $displayStyle_sec_new_3_pds_1; ?>">
                                                        <div class="row">
                                                            <div class="col-sm-3 form-group">
                                                                <label>1. भारतीय बीज सहकारी समिति</label>
                                                                <select name="sec_3_seed" id="sec_3_seed"
                                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                                                    onChange="hide_show(this.value, '#sec_3_seed_anshdhan', 'yes'); handleDropdownColorChange(this, 'yes', '#42ecf5', 'no', '#f28546');">
                                                                    <option value="">--Select--</option>
                                                                    <option value="yes" <?php echo isset($row_new_3['sec_new_3_pds_1']) && $row_new_3['sec_new_3_pds_1'] == 'yes' ? 'selected="selected"' : '' ?> style="background:#0f0">हाँ</option>
                                                                    <option value="no" <?php echo isset($row_new_3['sec_new_3_pds_1']) && $row_new_3['sec_new_3_pds_1'] == 'no' ? 'selected="selected"' : '' ?> style="background:#f00">नहीं</option>
                                                                </select>
                                                            </div>
                                                            <div class="col-sm-3 form-group" id="sec_3_seed_anshdhan"
                                                                style="display:none">
                                                                <label>अंशधन</label>
                                                                <input type="text" name="sec_3_seed_anshdhan"
                                                                    id="sec_3_seed_anshdhan" tabindex="<?php echo $tab++; ?>"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-3 form-group">
                                                                <label>2. राष्ट्रीय सहकारी ऑर्गेनिक्स लिमिटेड</label>
                                                                <select name="sec_3_organics" id="sec_3_organics"
                                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                                                    onChange="hide_show(this.value, '#sec_3_organics_anshdhan', 'yes'); handleDropdownColorChange(this, 'yes', '#42ecf5', 'no', '#f28546');">
                                                                    <option value="">--Select--</option>
                                                                    <option value="yes" <?php echo isset($row_new_3['sec_new_3_pds_1']) && $row_new_3['sec_new_3_pds_1'] == 'yes' ? 'selected="selected"' : '' ?> style="background:#0f0">हाँ</option>
                                                                    <option value="no" <?php echo isset($row_new_3['sec_new_3_pds_1']) && $row_new_3['sec_new_3_pds_1'] == 'no' ? 'selected="selected"' : '' ?> style="background:#f00">नहीं</option>
                                                                </select>
                                                            ...
                                                            <div class="col-sm-3 form-group" id="sec_3_organics_anshdhan"
                                                                style="display:none">
                                                                <label>अंशधन</label>
                                                                <input type="text" name="sec_3_organics_anshdhan"
                                                                    id="sec_3_organics_anshdhan" tabindex="<?php echo $tab++; ?>"
                                                                    class="form-control chk_decimal"
                                                                    data-type="डेबिट धनराशि (को रु० लाख मे भरे)"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-3 form-group">
                                                                <label>3. राष्ट्रीय सहकारी निर्यात लिमिटेड</label>
                                                                <select name="sec_3_exports" id="sec_3_exports"
                                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                                                    onChange="hide_show(this.value, '#sec_3_exports_anshdhan', 'yes'); handleDropdownColorChange(this, 'yes', '#42ecf5', 'no', '#f28546');">
                                                                    <option value="">--Select--</option>
                                                                    <option value="yes" <?php echo isset($row_new_3['sec_new_3_pds_1']) && $row_new_3['sec_new_3_pds_1'] == 'yes' ? 'selected="selected"' : '' ?> style="background:#0f0">हाँ</option>
                                                                    <option value="no" <?php echo isset($row_new_3['sec_new_3_pds_1']) && $row_new_3['sec_new_3_pds_1'] == 'no' ? 'selected="selected"' : '' ?> style="background:#f00">नहीं</option>
                                                                </select>
                                                            ...
                                                            <div class="col-sm-3 form-group" id="sec_3_exports_anshdhan"
                                                                style="display:none">
                                                                <label>अंशधन</label>
                                                                <input type="text" name="sec_3_exports_anshdhan"
                                                                    id="sec_3_exports_anshdhan" tabindex="<?php echo $tab++; ?>"
                                                                    class="form-control chk_decimal"
                                                                    data-type="डेबिट धनराशि (को रु० लाख मे भरे)"
                                                                    value="<?php echo $row_3_loan_limit['sec_new_3_debit_amt_cur_2']; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3 form-group">
                                                            <label><b>(IV) क्या जन सेवा केंद्र (CSC) संचालित है ?</b></label>
                                                            <select name="sec_new_3_csc" id="sec_new_3_csc"
                                                                tabindex="<?php echo $tab++; ?>" class="form-control"
                                                                onChange="hide_show(this.value, '#sec_3_csc_transactions', 'yes'); hide_show(this.value, '#sec_3_csc_amt', 'yes'); hide_show(this.value, '#sec_3_csc_commission', 'yes'); handleDropdownColorChange(this, 'yes', '#42ecf5', 'no', '#f28546');">
                                                                <option value="">--Select--</option>
                                                                <option value="yes" <?php echo isset($row_new_3['csc']) && $row_new_3['csc'] == 'yes' ? 'selected="selected"' : '' ?>
                                                                    style="background:#0f0">हाँ</option>
                                                                <option value="no" <?php echo isset($row_new_3['csc']) && $row_new_3['csc'] == 'no' ? 'selected="selected"' : '' ?>
                                                                    style="background:#f00">नहीं</option>
                                                            </select>
                                                        </div>
                                                        <?php
                                                        $displayStyle_sec_new_3_csc = $row_new_3['csc'] == "yes" ? "display: block;" : "display: none;";

                                                        ?>
                                                        <div class="col-sm-3 form-group" id="sec_3_csc_transactions"
                                                            style="<?php echo $displayStyle_sec_new_3_csc; ?>">
                                                            <label>ट्रांजैक्शन की संख्या </label>
                                                            <input type="text" name="sec_new_3_csc_transactions"
                                                                id="sec_3_csc_transactions" tabindex="<?php echo $tab++; ?>"
                                                                class="form-control chk_number"
                                                                data-type="ट्रांजैक्शन की संख्या को अंक मे भरे"
                                                                value="<?php echo $row_new_3['sec_new_3_csc_transactions']; ?>">
                                                        </div>
                                                        <div class="col-sm-3 form-group" id="sec_3_csc_amt"
                                                            style="<?php echo $displayStyle_sec_new_3_csc; ?>">
                                                            <label>धनराशि (रु० लाख मे)</label>
                                                            <input type="text" name="sec_new_3_csc_amt" id="sec_3_csc_amt"
                                                                tabindex="<?php echo $tab++; ?>" class="form-control chk_decimal"
                                                                data-type="धनराशि (को रु० लाख मे भरे)"
                                                                value="<?php echo $row_new_3['sec_new_3_csc_amt']; ?>">
                                                        </div>
                                                        <div class="col-sm-3 form-group" id="sec_3_csc_commission"
                                                            style="<?php echo $displayStyle_sec_new_3_csc; ?>">
                                                            <label>कमीशन (धनराशि लाख मे)</label>
                                                            <input type="text" name="sec_new_3_csc_commission"
                                                                id="sec_3_csc_commission" tabindex="<?php echo $tab++; ?>"
                                                                class="form-control chk_decimal"
                                                                data-type="कमीशन धनराशि (को रु० लाख मे भरे)"
                                                                value="<?php echo $row_new_3['sec_new_3_csc_commission']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-3 form-group">
                                                            <label><b>(V) जन औसाधि केंद्र</b></label>
                                                            <select name="sec_new_3_csc" id="sec_new_3_csc"
                                                                tabindex="<?php echo $tab++; ?>" class="form-control"
                                                                onChange="hide_show(this.value, '#sec_3_1', 'yes'); hide_show(this.value, '#sec_3_2', 'yes'); hide_show(this.value, '#sec_3_2', 'yes'); handleDropdownColorChange(this, 'yes', '#42ecf5', 'no', '#f28546');">
                                                                <option value="">--Select--</option>
                                                                <option value="yes" <?php echo isset($row_new_3['csc']) && $row_new_3['csc'] == 'yes' ? 'selected="selected"' : '' ?>
                                                                    style="background:#0f0">हाँ</option>
                                                                <option value="no" <?php echo isset($row_new_3['csc']) && $row_new_3['csc'] == 'no' ? 'selected="selected"' : '' ?>
                                                        ...
                                                        ?>
                                                        <div class="col-sm-3 form-group" id="sec_3_1"
                                                            style="<?php echo $displayStyle_sec_new_3_csc; ?>">
                                                            <label>धनराशि (रु० लाख मे)</label>
                                                            <input type="text" name="sec_new_3_csc_transactions"
                                                                id="sec_3_csc_transactions" tabindex="<?php echo $tab++; ?>"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3 form-group">
                                                            <label><b>(VI) कृषक उत्पादक संगठन (एफ० पी० ओ०)</b></label>
                                                            <select name="sec_new_3_csc" id="sec_new_3_csc"
                                                                tabindex="<?php echo $tab++; ?>" class="form-control"
                                                                onChange="hide_show(this.value, '#sec_3_4', 'yes'); hide_show(this.value, '#sec_3_5', 'yes'); hide_show(this.value, '#sec_3_6', 'yes'); handleDropdownColorChange(this, 'yes', '#42ecf5', 'no', '#f28546');">
                                                                <option value="">--Select--</option>
                                                                <option value="yes" <?php echo isset($row_new_3['csc']) && $row_new_3['csc'] == 'yes' ? 'selected="selected"' : '' ?>
                                                                    style="background:#0f0">हाँ</option>
                                                                <option value="no" <?php echo isset($row_new_3['csc']) && $row_new_3['csc'] == 'no' ? 'selected="selected"' : '' ?>
                                                        ...
                                                        ?>
                                                        <div class="col-sm-3 form-group" id="sec_3_4"
                                                            style="<?php echo $displayStyle_sec_new_3_csc; ?>">
                                                            <label>स्वीकृत (एफ० पी० ओ०)</label>
                                                            <input type="text" name="sec_new_3_csc_transactions"
                                                                id="sec_3_csc_transactions" tabindex="<?php echo $tab++; ?>"
                                                                class="form-control chk_number"
                                                                data-type="ट्रांजैक्शन की संख्या को अंक मे भरे"
                                                        ...
                                                        <div class="col-sm-3 form-group" id="sec_3_5"
                                                            style="<?php echo $displayStyle_sec_new_3_csc; ?>">
                                                            <label>धनराशि (रु० लाख मे)</label>
                                                            <input type="text" name="sec_new_3_csc_transactions"
                                                                id="sec_3_csc_transactions" tabindex="<?php echo $tab++; ?>"
                                                        ...
                                                        <div class="col-sm-3 form-group" id="sec_3_6"
                                                            style="<?php echo $displayStyle_sec_new_3_csc; ?>">
                                                            <label>शेष</label>
                                                            <input type="text" name="sec_new_3_csc_transactions"
                                                                id="sec_3_csc_transactions" tabindex="<?php echo $tab++; ?>"
                                ...
                                <div class="step">
                                    ...
                                    <div class="col-sm-12">
                                        <h5>
                                            <img src="images/logo/training.png" alt="text" class="img-fluid stat-icon"
                                        ...
                                        <div id="dynamic-rows">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            ...
                                                            <input name="sec_3_hostel_no_<?php echo $i; ?>"
                                                                id="sec_3_hostel_no" tabindex="<?php echo $tab++; ?>"
                                                                class="form-control"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            ...
                                                            <input name="sec_3_library_no_<?php echo $i; ?>"
                                                                id="sec_3_library_no" tabindex="<?php echo $tab++; ?>"
                                                                class="form-control"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            ...
                                                            <input name="sec_3_teacher_no_<?php echo $i; ?>"
                                                                id="sec_3_teacher_no" tabindex="<?php echo $tab++; ?>"
                                                                class="form-control"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <label>विभागीय प्रशिक्षण शुल्क</label>
                                                            <input
                                                        ...
                                                        <div class="col-sm-4">
                                                            <label>गैर-विभागीय प्रशिक्षण शुल्क</label>
                                                            <input
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3 form-group">
                                                            ...
                                                            <select name="sec_2_stock_insurance" class="form-control"
                                                                onchange="color_change(this, 'yes', '#42ecf5', 'no', '#f28546');">
                                                                <option value="">--select-- </option>
                                                                <option value="yes">उ० प्र० कोआपरेटिव यूनियन</option>
                                                    ...
                                                    <div class="col-sm-2 form-group my-auto" id="sec_3_add_rows">
                                                        <button type="button" class="btn btn-info" onClick="addRow()">नई
                                                            पंक्ति जोड़े [+]</button>
                                            ...
                                            <div class="step">
                                                ...
                                                <div class="col-sm-12">
                                                        ...
                                                        <table>
                                                            ...
                                                            <tbody id="postTableBody">
                                                                ...
                                                                <tr id="gmRow">
                                                                    <td>महाप्रबंधक</td>
                                                                    <!-- <td colspan="2"></td> -->
                                                                    <td><input type="number" class="count_gm"
                                                                            oninput="handleCountInput(this, 'gm')"></td>
                                                                ...
                                                                <tr id="dgmRow">
                                                                    <td>उप-महाप्रबंधक</td>
                                                                    <!-- <td colspan="2"></td> -->
                                                                    <td><input type="number" class="count_dgm"
                                                                            oninput="handleCountInput(this, 'dgm')"></td>
                                                                ...
                                                                <tr id="agmRow">
                                                                    ...
                                                                    <!-- <td colspan="2"></td> -->
                                                                    <td><input type="number" class="count_agm"
                                                                            oninput="handleCountInput(this, 'agm')"></td>
                                                        ...
                                                        <table class="table table-bordered table-striped">
                                                            <thead>
                                                                <tr>
                                                                    <th>क्रं.</th>
                                                                    <th>नाम संवर्ग &nbsp;&nbsp;&nbsp;</th>
                                                                    <th>पी०सी०यू० में स्वीकृत संख्या</th>
                                                                    <th>पी०सी०यू० में कार्यरत</th>
                                                                    <th>पी०सी०यू० में रिक्त</th>
                                                                    <th>प्राधिकारी में स्वीकृत संख्या</th>
                                                                    <th>प्राधिकारी में कार्यरत</th>
                                                                    <th>प्राधिकारी में रिक्त</th>
                                                                    <th>अन्य विवरण</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <!-- <td></td> -->
                                                                    <td colspan="2">कुल स्वीकृत संख्या</td>
                                                                    <td><input type="text" class="form-control" name="" id=""
                                                                            value="" readonly></td>
                                                                    <td><input type="text" class="form-control" name="" id=""
                                                                            value="" readonly></td>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <!-- <div class="col-sm-3 form-group" id="guard_count2"
                                                                style="display:none;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-2 form-group">
                                                            ...
                                                            <select class="form-control" type="checkbox" id="sec_2_guard"
                                                                ...
                                                                name="sec_2_guard" value="" tabindex="<?php echo $tab++; ?>" size="4" style="height:auto;">
                                                                <option value="">--Select--</option>
                                                        ...
                                                        <div class="col-sm-2 form-group">
                                                            <label>पदनाम</label>
                                                            <select class="form-control " type="checkbox" id="sec_2_guard"
                                                                name="sec_2_guard" value="yes" tabindex="<?php echo $tab++; ?>" size="4" style="height:auto;">
                                                                <option value="">--Select--</option>
                                                                <option value="yes" <?php $guard_display = 'none';
                                                                if ($row_2_2['guard'] != '') {
                                                                    echo ' selected="selected" ';
                                                    ...
                                                    <div class="row">
                                                        <!-- <div class="col-md-3"><label for="">प्राधिकारी कमेटी निर्वाचित है?</label>
                                                            <select name="" id="" class="form-control"
                                                                onChange="hide_show(this.value, '#guard_count123', '0');hide_show(this.value, '#guard_count2', '0');hide_show(this.value, '#guard_count3', '0');">
                                                                <option value="">--Select--</option>
                                                                <option value="0">निर्वाचित है</option>
                                                    ...
                                                    <div class="row">
                                                        <!-- <div class="col-md-3"><label for="">प्रशासनिक कमेटी निर्वाचित है?</label>
                                                            <select name="" id="" class="form-control"
                                                                onChange="hide_show(this.value, '#guard_count123', '0');hide_show(this.value, '#guard_count2', '0');hide_show(this.value, '#guard_count3', '0');">
                                                                <option value="">--Select--</option>
                                                                <option value="0">निर्वाचित है</option>
                                                ...
                                                <div class="row">
                                                    <!-- <div class="col-sm-3 form-group">
                                                        <select name="sec_2_stock_insurance" class="form-control"
                                                            onchange="color_change(this, 'yes', '#42ecf5', 'no', '#f28546');">
                                                            <option value="">--select-- </option>
                                                            <option value="yes">सभागार</option>
                                                            <option value="no">जन औषधि केंद्र</option>
                                                            <option value="no">जन सुविधा केंद्र</option>
                                                            <option value="no">प्रिंटिंग प्रेस</option>
                                                        </select>
                                                    </div> -->
                                                    <div class="col-sm-3 form-group">
                                                        <label>सभागार</label>
            ...
            <script type="text/javascript" src="js/multistepform_ldb.js?v=1">
