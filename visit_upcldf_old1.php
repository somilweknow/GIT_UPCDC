...
if (isset($_GET['exdid'])) {
    ...
    SELECT 
        c.*,
        GROUP_CONCAT(d.district_id ORDER BY d.district_id) AS district_ids
    FROM apex_si_1_4_contacts c
    LEFT JOIN apex_si_1_4_contact_districts d 
        ON d.contact_id = c.sno
    WHERE c.survey_id = '".$row_invoice['sno']."'
    GROUP BY c.sno
    ";
                            ...
                            <div id="steps-container">
                                ...
                                <div class="step">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <table class="table table-bordered table-striped table-hover"
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th>स०</th>
                                                        <th>प्रखण्ड</th>
                                                        <th>प्रखण्ड कार्यालय का पता</th>
                                                        <th>संपर्क सूत्र</th>
                                                        <th>ई-मेल आई.डी.</th>
                                                        <th>अक्षांश</th>
                                                        <th>देशान्तर</th>
                                                        <th>प्रखण्ड के अन्तर्गत जिलों के नाम</th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody id="contact_rows">
                                                    ...
                                                    foreach ($contact_rows as $r):
                                                        ...
                                                        $selected_districts = [];
                                                        if (!empty($r['district_ids'])) {
                                                            $selected_districts = explode(',', $r['district_ids']);
                                                        }
                                                        ?>
                                                        <tr id="contact_row_<?php echo $i; ?>">
                                                            ...
                                                            <td>
                                                                <select class="form-control" name="division_id[]">
                                                                    <option value="">--select--</option>
                                                                    <?php
                                                                    $q = mysqli_query($db, "SELECT * FROM master_division");
                                                                    while ($d = mysqli_fetch_assoc($q)) {
                                                                        $sel = ($r['division_id'] == $d['s_no']) ? 'selected' : '';
                                                                        echo '<option value="' . $d['s_no'] . '" ' . $sel . '>' . $d['division_name'] . '</option>';
                                                                    }
                                                                    ?>
                                                                </select>
                                                            </td>
                                                            ...
                                                            <td><input type="text" name="address[]" class="form-control"
                                                                    value="<?php echo $r['address']; ?>"></td>
                                                            <td><input type="text" name="mobile[]" class="form-control"
                                                                    value="<?php echo $r['mobile']; ?>"></td>
                                                            <td><input type="text" name="email[]" class="form-control"
                                                                    value="<?php echo $r['email']; ?>"></td>
                                                            <td><input type="text" name="latitude[]" class="form-control"
                                                                    value="<?php echo $r['latitude']; ?>"></td>
                                                            <td><input type="text" name="longitude[]" class="form-control"
                                                                    value="<?php echo $r['longitude']; ?>"></td>

                                                            <td>
                                                                <select class="form-control"
                                                                    name="district_name[<?php echo $i; ?>][]" multiple
                                                                    size="6">

                                                                    <?php
                                                                    $q2 = mysqli_query($db, "SELECT * FROM master_district ORDER BY district_name");
                                                                    while ($dd = mysqli_fetch_assoc($q2)) {
                                                                        $sel = in_array($dd['s_no'], $selected_districts) ? 'selected' : '';
                                                                        echo '<option value="' . $dd['s_no'] . '" ' . $sel . '>' . $dd['district_name'] . '</option>';
                                                                    }
                                                                    ?>
                                                                </select>
                                                            </td>
                                            ...
                                            <input type="hidden" id="contact_row_count"
                                                value="<?php echo count($contact_rows); ?>">
                                            <button type="button" onclick="addContactRow()" class="btn btn-info">नई
                                                पंक्ति जोड़े [+]</button>
                                        </div>
                                    </div>
                                ...
                                <div class="step">
                                   ...
                                   <div class="col-sm-12">
                                    ...
                                    <h4><img src="images/logo/7.png" alt="text" class="img-fluid stat-icon"
                                            style="height:50px; width:50px;"> 2. प्रबंध कमेटी</h4>
                                    <div class="col-sm-12">
                                        <div class="row">
                                ...
                                <div class="step">
                                    <h4><img src="images/logo/11.png" alt="text" class="img-fluid stat-icon"
                                            style="height:50px; width:50px;"> 6. समिति भवन/सम्पत्ति का विवरण</h4>
                                        <div class="col-sm-12">
                                            <div class="row">
                                                <div class="col-sm-12">
                                            ...
                                            <div class="row" id="sec_3" style="display: <?php echo $sec_3_display; ?>;">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div id="sec_2_nirmit_godown">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-2 form-group">
                                                                <label>लम्बाई (मीटर में)</label>
                                                                <input type="text"
                                                                    name="sec_3_b_godown_year_<?php echo $i; ?>"
                                                                    id="sec_3_b_godown_year_<?php echo $i; ?>"
                                                                    tabindex="<?php echo $tab++; ?>"
                                                                    class="form-control chk_number"
                                                                    data-type="2. VI.क्षमता मेट्रिक टन में भरे"
                                                                    value="<?php echo $row_3_4['sec_3_b_godown_year_' . $i]; ?>">
                                                            </div>
                                                            <div class="col-sm-2 form-group">
                                                                <label>चौड़ाई (मीटर में)</label>
                                                                <input type="text"
                                                                    name="sec_3_b_wdra_certified_<?php echo $i; ?>"
                                                                    id="sec_3_b_wdra_certified_<?php echo $i; ?>"
                                                                    tabindex="<?php echo $tab++; ?>"
                                                                    class="form-control chk_number"
                                                                    data-type="2. VI.क्षमता मेट्रिक टन में भरे"
                                                                    value="<?php echo $row_3_4['sec_3_b_wdra_certified_' . $i]; ?>">
                                                            </div>
...
<script>
    ...
    function sec_2_nirmit_godown_add_rows() {
        ...
        txt += '<div class="col-sm-2 form-group"><label>क्षमता (मेट्रिक टन में)</label><input type="text" name="sec_3_b_godown_year_' + id + '" id="sec_3_b_godown_year_' + id + '" class="form-control chk_number" data-type="क्षमता मेट्रिक टन में भरे"></div>';
        txt += '<div class="col-sm-2 form-group"><label>क्षमता (मेट्रिक टन में)</label><input type="text" name="sec_3_b_wdra_certified_' + id + '" id="sec_3_b_wdra_certified_' + id + '" class="form-control chk_number" data-type="क्षमता मेट्रिक टन में भरे"></div>';
...
<script>
    function addContactRow() {
        let id = parseInt($("#contact_row_count").val(), 10);
        if (isNaN(id)) id = 0;
        id++;

        // Clone options safely from first row
