...
if (!isset($_SESSION['admin_session']) && !isset($_SESSION['act_session_id'])) {
    ...
    /* Mobile view - different background image */
    @media (max-width: 768px) {
        .full-page {
            background-image: url('images/UPCDS (Mobile View).png.');
        ...
        <div class="full-page section-image">
            ...
            <div class="welcome-card-container" id="welcomeCard">
                <div class="welcome-card">
                    ...
                    <button class="open-login-btn" onclick="openLogin()">Open Login</button>
                </div>
            </div>
                    ...
                    <form id="loginform" name="login" autocomplete="off" enctype="multipart/form-data" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                        <div class="card card-login" style="background: rgba(223, 212, 212, 0.9);">
                            <div class="card-header card-header-rose"style="margin-left: 0px;">
                                <h2 class="header" style="font-size: 22px; color: #fff; margin: 0;">उत्तर प्रदेश को-आपरेटिव डेटाबेस सेंटर &trade;</h2>
                                <?php echo $msg; ?>
                            </div>
                            <div class="card-body">
