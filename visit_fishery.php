                                            ...
                                            द्वारा परीक्षण कर 10 तारीख तक अनुमोदन करना आवश्यक है।
                                                ...
                                                <div?php echo $msg; ?>
                                                    ...
                                                    <div class="col-sm-12">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8 form-group" style="margin: 9px;"   id="sec_1_institute_name_container">
                                                                        ...
                                                                        <input type="text" id="" name="" tabindex = "<?php echo $tab++; ?>" readonly value="मत्स्य विभाग, उ०प्र०">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-8">
                                                        ...
                                                        <hr />
                                                        <label><b>समिति के वर्तमान अध्यक्ष का विवरण</b></label>
                                                        <div class="row">
                                                        ...
                                                        <label><b>समिति के वर्तमान सचिव का विवरण</b></label>
                                                        <div class="row">
                                                            <div class="col-sm-3 form-group" style="margin-block: -6px;">
                                                                <label>नाम</label>
                                                                <br />
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-3 form-group" style="margin-block: -6px;">
                                                                <label>समिति कार्यालय की स्थिति</label>
                                                                <br />
                                                                <input type="text" name="society_registration_no"
                                                                    id="society_registration_no" tabindex="<?php echo $tab++; ?>"
                                                                    class="form-control"
                                                            ...
                                                            <div class="col-sm-3 form-group" style="margin-block: -6px;">
                                                                <label>समिति के बैंक खाता का विवरण</label>
                                                                <br />
                                                                <input type="text" name="society_registration_no"
                                                                    id="society_registration_no" tabindex="<?php echo $tab++; ?>"
                                                                    class="form-control"
                                                        ...
                                                        <!-- <div class="row"> -->
                                                            <div class="col-sm-3">
                                                                <label>पता</label>
                                                                <input name="sec_1_address<?php echo $i; ?>"
                                                                    id="sec_1_address<?php echo $i; ?>"
                                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                                                    value="<?php echo $row_invoice['sec_1_address']; ?>">
                                                            </div>
                                                            <div class="col-sm-3">
                                                                <label>पिनकोड</label>
                                                                <input name="sec_1_pincode<?php echo $i; ?>"
                                                                    id="sec_1_pincode<?php echo $i; ?>"
                                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                                                    value="<?php echo $row_invoice['sec_3_address_' . $i]; ?>">
                                                             </div>
                                                            <!--<div class="col-sm-3 form-group">
                                                                <label>पैन न०</label>
                                                                <input type="text" name="sec_1_pan" id="sec_1_pan"
                                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                                                    value="<?php echo $row_invoice['email_id']; ?>">
                                                            </div>
                                                            <div class="col-sm-3 form-group">
                                                                <label>टैन न०</label>
                                                                <input type="text" name="sec_1_tan" id="sec_1_tan"
                                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                                                    value="<?php echo $row_invoice['email_id']; ?>">
                                                            </div>
                                                            <div class="col-sm-3 form-group">
                                                                <label>जी० एस० टी० न०</label>
                                                                <input type="text" name="sec_1_gst" id="sec_1_gst"
                                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                                                    value="<?php echo $row_invoice['email_id']; ?>">
                                                            </div> -->
                                                            <div class="col-sm-3 form-group">
                                                            ...
                                                            <div class="col-sm-3 form-group">
                                                                ...
                                                                <input type="text" name="sec_1_mobile" id="sec_1_mobile"
                                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                                                    value="<?php echo $row_invoice['email_id']; ?>">
                                                            </div>
                                                            <div class="col-sm-3 form-group">
                                                                <label>वेबसाईट</label>
                                                                <input type="text" name="sec_1_website" id="sec_1_website"
                                                                    tabindex="<?php echo $tab++; ?>" class="form-control"
                                                                    value="<?php echo $row_invoice['email_id']; ?>">
                                                            </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <small><b>(I) समिति सदस्यों का विवरण :</b></small><br>
                                                            <div class="row">
                                                                <div class="col-sm-3 form-group">
                                                                    <label>सक्रिय सदस्यो की संख्या</label>
                                                                    <input type="text" name="sec_1_1_active_members_no"
                                                                        id="sec_1_1_active_members_no" tabindex="<?php echo $tab++; ?>"
                                                                        class="form-control chk_number" data-type="सक्रिय सदस्यो की संख्या को अंक मे भरे" value="<?php echo $row_invoice['active_members']; ?>" oninput="calculateTotal()">
                                                                </div>
                                                                <div class="col-sm-3 form-group">
                                                                    <label>निष्क्रिय सदस्यो की संख्या</label>
                                                                    <input type="text" name="sec_1_1_inactive_members_no"
                                                                        id="sec_1_1_inactive_members_no" tabindex="<?php echo $tab++; ?>"
                                                                        class="form-control chk_number" data-type="निष्क्रिय सदस्यो की संख्या अंक मे भरे"
                                                                        value="<?php echo $row_invoice['inactive_members']; ?>" oninput="calculateTotal()">
                                                                </div>
                                                                <div class="col-sm-3 form-group">
                                                                    <label>कुल मत्स्य पालक सदस्यों की संख्या</label>
                                                                    <input type="text" name="sec_1_1_kcc_members_no" id="sec_1_1_kcc_members_no"
                                                                        tabindex="<?php echo $tab++; ?>" class="form-control chk_number" data-type="सक्रिय सदस्यों की संख्या जिनको के० सी० सी० निर्गत की गई को अंक मे भरे"
                                                                        value="<?php echo $row_invoice['kcc_members']; ?>" oninput="calculateTotal()" readonly>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-4 form-group">
                                                                    ...
                                                                    <input type="text" name="sec_1_1_new_members" id="sec_1_1_new_members"
                                                                        tabindex="<?php echo $tab++; ?>" class="form-control chk_number"
                                                                        value="<?php echo $row_invoice['new_members']; ?>" oninput="calculateTotal_1()">
                                                                </div>
                                                                <div class="col-sm-4 form-group">
                                                                    <label>01-अप्रैल-2024 से प्राप्त अंशधन </label>
                                                                    <input type="text" name="sec_1_1_contribution_received_capital"
                                                                        id="sec_1_1_contribution_received_capital" tabindex="<?php echo $tab++; ?>"
                                                                        class="form-control chk_decimal" data-type="01-अप्रैल-2024 से प्राप्त अंशधन लाख मे भरे"
                                                                        value="<?php echo $row_invoice['contribution_received_capital']; ?>">
                                                                </div>
                                                                <div class="col-sm-4 form-group">
                                                                    <label>01-अप्रैल-2024 से निष्क्रिय से सक्रिय किए गए सदस्यों की
                                                                        संख्या</label>
                                                                    <input type="text" name="sec_1_1_inactive_to_active_members"
                                                                        id="sec_1_1_inactive_to_active_members" tabindex="<?php echo $tab++; ?>"
                                                                        class="form-control chk_number" data-type="01-अप्रैल-2024 से निष्क्रिय से सक्रिय किए गए सदस्यों की संख्या को अंक मे भरे" value="<?php echo $row_invoice['inactive_to_active_members']; ?>"oninput="calculateTotal_1()">
                                                                </div>
                                                            </div>
                                                        </div>

                                                        </div>
                                                        <small><b> (III) कुल सदस्य</b></small>
                                                        <div class="row">
                                                            <div class="col-sm-3 form-group">
                                                        ...
                                                        <small><b> (IV) कुल परिवारों की संख्या</b></small>
                                                        <div class="row">
                                                            <div class="col-sm-3 form-group">
                                                                <input type="text" name="sec_1_all_members" id="sec_1_all_members"
                                                                    tabindex="<?php echo $tab++; ?>" class="form-control" disabled
                                                            ...
                                                            <div class="col-sm-12">
                                                                ...
                                                                <table class="table table-bordered table-striped table-hover">
                                                                    <thead>
                                                                        <tr>
                                                                            <th>क्र० स०</th>
                                                                            <th>प्रशिक्षण का नाम</th>
                                                                            <th>अध्यक्ष / सचिव / सदस्य</th>
                                                                            <th>प्रशिक्षण की अवधि</th>
                                                                            <th>अभियुक्ति</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                ...
                                <!----------------5th start-------------------------------------------------------->
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<select class="form-control"
															name="sec_2_computer_qualification"
													...
													<td>
														<select class="form-control" name="sec_2_employee_type"
															id="sec_2_employee_type" onchange="hide_show(this.value, '#sec_111', '2')">
															<option value="">--Select--</option>
													...
													<td>
														<select class="form-control" name="sec_111"
															id="sec_111" style="display:none;">
															<option value="">--Select--</option>
												...
												<tr>
													...
													<td>
														<select class="form-control" name="acc_employee_type"
															id="acc_employee_type" onchange="hide_show(this.value, '#sec_112', '2')">
															<option value="">--Select--</option>
															<option value="1">नियमित</option>
															<option value="2">अस्थाई</option>
														</select>
												...
												<tr>
													...
													<td>
														<select class="form-control" name="assist_acc_employee_type"
															id="assist_acc_employee_type" onchange="hide_show(this.value, '#sec_113', '2')">
															<option value="">--Select--</option>
															<option value="1">नियमित</option>
															<option value="2">अस्थाई</option>
														</select>
												...
												<tr>
													...
													<td>
														<select class="form-control" name="sec_2_employee_type"
															id="sec_2_employee_type" onchange="hide_show(this.value, '#sec_114', '2')">
															<option value="">--Select--</option>
															<option value="1">नियमित</option>
															<option value="2">अस्थाई</option>
														</select>
												...
												<tr>
													...
													<td>
														<select class="form-control" name="sec_2_employee_type"
															id="sec_2_employee_type" onchange="hide_show(this.value, '#sec_115', '2')">
															<option value="">--Select--</option>
															<option value="1">नियमित</option>
															<option value="2">अस्थाई</option>
														</select>
												...
												<tr>
													...
													<td>
														<select class="form-control" name="sec_2_employee_type"
															id="sec_2_employee_type" onchange="hide_show(this.value, '#sec_116', '2')">
															<option value="">--Select--</option>
															<option value="1">नियमित</option>
															<option value="2">अस्थाई</option>
														</select>
												...
												<tr>
													...
													<td>
														<select class="form-control" name="sec_2_employee_type"
															id="sec_2_employee_type" onchange="hide_show(this.value, '#sec_117', '2')">
															<option value="">--Select--</option>
															<option value="1">नियमित</option>
															<option value="2">अस्थाई</option>
														</select>
                                    ...
                                    <h4><img src="images/logo/11.png" alt="text" class="img-fluid stat-icon"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="col-sm-3 form-group">
                                                        <label>(I)समिति के जल क्षेत्र के प्रकार </label>
                                                    ...
                                                    <!-- <div class="col-sm-3 form-group">
                                                        <label>(II)समिति भवन का स्वामित्व </label> 
                                                        <select name="sec_3_ownership" id="sec_3_ownership"
                                                            tabindex="<?php echo $tab++; ?>" class="form-control"
                                            ...
                                            <div class="row" id="sec_3" style="display: <?php echo $sec_3_display; ?>;">
                                                <div class="col-sm-12">
                                                    <h5> (I) जलक्षेत्र स्वामित्व का विवरण </h5>
                                                    <div class="row">
                                                        <div class="col-sm-3 form-group">
                                                            <label>जलक्षेत्र स्वामित्व की स्थिति</label>
                                            ...
                                            <div class="row" id="sec_3" style="display: <?php echo $sec_3_display; ?>;">
                                                <h="col-sm-12">
                                                    <h5> (II) जलक्षेत्र स्वामित्व का विवरण </h5>
                                                    <div class="row">
                                                        <!-- <div class="col-sm-3 form-group">
