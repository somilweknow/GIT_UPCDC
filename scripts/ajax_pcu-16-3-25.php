...
if ($id == 'type') {
	...
	if ($_POST['survey_id'] == '') {
        ...
        $sql = 'INSERT INTO `apex_si_1_1` (`apex_id`,`longitude`,`latitude`,`committee_status`,`email_id`,`society_registration_no`,`society_registration_date`,`address`,`pincode`,`pan_no`,`tan_no`,`mobile_number`,`website`,`membership_fee`,`nominal_member`,`lifetime_member`, total_members, liquidation, liquidation_date, liquidation_status, photo_id) VALUES ("' . $_POST['apex_code'] . '","' . $_POST['longitude'] . '","' . $_POST['latitude'] . '","' . $_POST['committee_status'] . '","' . $_POST['email_id'] . '","' . $_POST['society_registration_no'] . '","' . $_POST['society_registration_date'] . '","' . $_POST['address'] . '","' . $_POST['pincode'] . '","' . $_POST['pan_no'] . '","' . $_POST['tan_no'] . '","' . $_POST['mobile_number'] . '","' . $_POST['website'] . '","' . $_POST['membership_fee'] . '","' . $_POST['nominal_member'] . '","' . $_POST['lifetime_member'] .'","' . $_POST['total_members'] .'","'. $_POST['liquidation'].'", "'.($_POST['liquidation_date']).'", "'.($_POST['liquidation_status']).'" , "'.( $_FILES['society_photo']['name']).'" )';
		execute_query($sql);
		if (mysqli_error($db)) {
