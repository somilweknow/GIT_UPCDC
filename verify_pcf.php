            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="scripts/ajax_pcf.php" method="post" enctype="multipart/form-data" id="user_form"
                            name="user_form">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <!-- <div class="col-sm-3 form-group">
                                                ...
                                                <select readonly class="form-control" id="committee_status"
                                            ...
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <select readonly name="hq_ownership" id="hq_ownership" class="form-control"
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 form-group">
                                                    ...
                                                    <input readonly type="text" id="global_other_office_count"
                                                        class="form-control"
                                        ...
                                        <table class="table table-bordered" id="officeContainer"
                                            ...
                                            <thead>
                                                <tr class="office-block-header bg-light">
                                                    ...
                                                    <th width="15%"
                                                        style="color: black; font-size:14px; font-weight: bold;">जनपद
                                                    </th>
                                                    <th width="15%"
                                                        style="color: black; font-size:14px; font-weight: bold;"> दूरभाष
                                                        न०</th>
                                                    <th width="20%"
                                                        style="color: black; font-size:14px; font-weight: bold;"> का
                                                        ई-मेल आई.डी.</th>
                                                    <th width="20%"
                                                        style="color: black;font-size:14px;  font-weight: bold;">पता
                                                    </th>
                                                    <th width="100%"
                                                        style="color: black;font-size:14px; font-weight: bold;">शाखाओं
                                                ...
                                                <tr>
                                                    <td style="padding: 5px;">
                                                        <input readonly type="text" name="zone_name[]"
                                                            class="form-control zone-name" placeholder="शाखाओं का नाम">
                                                    </td>
                                                    <td style="padding: 5px;">
                                                        <input readonly type="text" name="zone_district[]"
                                                            class="form-control zone-name" placeholder="जनपद">
                                                    </td>
                                                    <td style="padding: 5px;">
                                                    ...
                                                    <td style="padding: 5px;">
                                                        <input readonly type="file" name="zone_image[]" class="form-control"  onchange="previewImage(this)">
                                                        <img class="image-preview" style="display:none; margin-top:5px; max-width:120px;">
                                                        <input readonly type="hidden" name="existing_zone_image[]" value="">                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                        ...
                                        <table class="table table-bordered" id="otherOfficeContainer"
                                            ...
                                            <tbody id="other-office-main-tbody">
                                                <tr class="other-office-row-template">
                                                    <td><input readonly type="text" name="other_office_name[]"
                                                            class="form-control" placeholder="अन्य कार्यालयों का नाम">
                                                    </td>
                                                    <td><input readonly type="text" name="other_office_district[]"
                                                            class="form-control" placeholder="जनपद"></td>
                                                    <td><input readonly type="text" name="other_office_mobile[]"
                                                            class="form-control"
                                                            placeholder="अन्य कार्यालयों का दूरभाष"></td>
                                                    <td><input readonly type="text" name="other_office_email[]"
                                                            class="form-control" placeholder="अन्य कार्यालयों का ई-मेल">
                                                    </td>
                                                    <td><input readonly type="text" name="other_office_address[]"
                                                            class="form-control" placeholder="अन्य कार्यालयों का पता">
                                                    </td>
                                                    <td><input readonly type="file" name="other_office_image[]"
                                                            class="form-control" onchange="previewImage(this)">
                                                        <img class="image-preview" style="display:none; margin-top:5px; max-width:120px;">
                                                        <input readonly type="hidden" name="existing_other_image[]" value="<?= $office['prakhand_image'] ?? '' ?>">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            for ($i = 1; $i <= $row_6_2['count']; $i++) {
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2 form-group">
                                                        ...
                                                        <input readonly type="text" name="sec_6_2_father_name_<?php echo $i; ?>"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <input readonly type="text" name="sec_4_total_personnel" class="form-control"
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped" id="employees_table">
                                                <thead>
                                                    <tr>
                                                        <th style="color: #000">क्रमांक</th>
                                                        <th style="color: #000">पद</th>
                                                        <th style="color: #000">नाम</th>
                                                        <th style="color: #000">पिता का नाम</th>
                                                        <th style="color: #000">दूरभाष नम्बर</th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody id="employees_tbody">
                                                    ...
                                                    <?php for ($i = 1; $i <= $employees['count']; $i++) { ?>
                                                        <tr id="employees_row_<?php echo $i; ?>">
                                                            ...
                                                            <td><input readonly type="text" name="employee_post_<?php echo $i; ?>"
                                                                    class="form-control"
                                                                    value="<?php echo $employees['post_' . $i]; ?>"></td>

                                                            <td><input readonly type="text" name="employee_name_<?php echo $i; ?>"
                                                                    class="form-control"
                                                            ...
                                                            <td><input readonly type="text" name="employee_phone_<?php echo $i; ?>"
                                                                    class="form-control"
                                            ...
                                            <div class="d-flex justify-content-end">
                                                ...
                                                <input readonly type="hidden" id="employees_row_count" name="employees_row_count"
                                                ...
                                                <tbody id="purchase_sale_tbody">
                                                    ...
                                                    for ($i = 1; $i <= $purchase_sale['count']; $i++) { ?>
                                                        <tr id="purchase_sale_row_<?php echo $i; ?>">
                                                            ...
                                                            <td><input readonly type="text" name="wheat_purchase_<?php echo $i; ?>"
                                                                    class="form-control"
                                                                    value="<?php echo $purchase_sale['wheat_purchase_' . $i]; ?>">
                                                            </td>

                                                            <td><input readonly type="text" name="rice_purchase_<?php echo $i; ?>"
                                                                    class="form-control"
                                                                    value="<?php echo $purchase_sale['rice_purchase_' . $i]; ?>">
                                                            </td>

                                                            <td><input readonly type="text" name="seed_<?php echo $i; ?>"
                                                                    class="form-control"
                                                                    value="<?php echo $purchase_sale['seed_' . $i]; ?>">
                                                            </td>

                                                            <td><input readonly type="text" name="fertilizer_<?php echo $i; ?>"
                                                                    class="form-control"
                                                                    value="<?php echo $purchase_sale['fertilizer_' . $i]; ?>">
                                                            </td>

                                                            <td><input readonly type="text" name="godown_rent_<?php echo $i; ?>"
                                                                    class="form-control"
                                                                    value="<?php echo $purchase_sale['godown_rent_' . $i]; ?>">
                                                            </td>

                                                            <td><input readonly type="text" name="nefed_<?php echo $i; ?>"
                                                                    class="form-control"
                                                                    value="<?php echo $purchase_sale['nefed_' . $i]; ?>">
                                                            </td>

                                                            <td><input readonly type="text"
                                                                    name="farmer_service_center_<?php echo $i; ?>"
                                                                    class="form-control"
                                                                    value="<?php echo $purchase_sale['farmer_service_center_' . $i]; ?>">
                                                            </td>

                                                            <td><input readonly type="text" name="other_business_<?php echo $i; ?>"
                                                                    class="form-control"
                                                                    value="<?php echo $purchase_sale['other_business_' . $i]; ?>">
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped"
                                                id="sec_7_yearly_business_table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>उपलब्धि</th>
                                                        <th style="min-width: 100px;">करायवही</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                        ...
                                                        <tr class="yearly_business_row">
                                                            ...
                                                            <td>
                                                                <input readonly type="text"
                                                                    ...
                                                                    class="form-control"
                                                                    value="<?php echo $y['business_name'] ?? ''; ?>">
                                                            </td>
                                                            <td>
                                                                <input readonly type="text"
                                                                    name="sec_7_annual_target_<?php echo $i; ?>"
                                                                    class="form-control"
                                                                    value="<?php echo $y['annual_target'] ?? ''; ?>">
                                                            </td>
                                                            <td>
                                                                <input readonly type="text"
                                                                    name="sec_7_achievement_<?php echo $i; ?>"
                                                                    class="form-control"
                                                                    value="<?php echo $y['achievement'] ?? ''; ?>">
                                                            </td>
                                                            <td class="text-center">
                                                                <?php if ($i == $count) { ?>
                                                                    <button type="button" class="btn btn-info btn-sm"
                                                                        onclick="addYearlyBusinessRow()">नई पंक्ति जोड़े
                                                                        [+]</button>
                                                                    <input readonly type="hidden" id="sec_7_row_count"
                                                                        name="sec_7_row_count" value="<?php echo $count; ?>">
                                                                <?php } else { ?>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3 form-group">
                                                        ...
                                                        <select readonly name="sec_6_access_road" id="sec_6_access_road"
                                                            ...
                                                            <option value="ordinary" <?php echo ($row_2_1['sec_6_access_road'] == 'ordinary') ? 'selected' : ''; ?>>कच्ची
                                                                सडक</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-sm-2 form-group">
                            ...
                            <div id="success">
                                ...
                                <div class="col-sm-12 form-group my-auto" id="send_otp_button2" style="display: none">
                                    <button type="button" name="verify_otp_btn" id="verify_otp_btn"
                                        ...
                                        onClick="verify_otp_pcf($('#survey_id').val());">आगे प्रेषित करे
                                    </button>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    function addRegionalOfficeRow() {
        ...
        txt += '<div class="col-sm-2 form-group"><label>क्षेत्रीय/जिला कार्यालय</label>' +
            '<input readonly type="text" name="office_name_' + id + '" id="office_name_' + id + '" class="form-control"></div>';

        txt += '<div class="col-sm-2 form-group"><label>जनपद</label>' +
            '<input readonly type="text" name="district_' + id + '" id="district_' + id + '" class="form-control"></div>';

        txt += '<div class="col-sm-2 form-group"><label>मण्डल</label>' +
            '<input readonly type="text" name="division_' + id + '" id="division_' + id + '" class="form-control"></div>';

        txt += '<div class="col-sm-2 form-group"><label>तहसील</label>' +
            '<input readonly type="text" name="tehsil_' + id + '" id="tehsil_' + id + '" class="form-control"></div>';

        txt += '<div class="col-sm-2 form-group"><label>पता</label>' +
            '<input readonly type="text" name="address_' + id + '" id="address_' + id + '" class="form-control"></div>';

        txt += '<div class="col-sm-2 form-group"><label>दूरभाष नंबर</label>' +
            '<input readonly type="text" name="phone_' + id + '" id="phone_' + id + '" class="form-control"></div>';

        txt += '<div class="col-sm-2 form-group"><label>पिन कोड</label>' +
            '<input readonly type="text" name="pincode_' + id + '" id="pincode_' + id + '" class="form-control"></div>';

        txt += '<div class="col-sm-2 form-group"><label>ई-मेल</label>' +
            '<input readonly type="text" name="email_' + id + '" id="email_' + id + '" class="form-control"></div>';
        ...
        txt += '<div class="col-sm-2 form-group my-auto" id="regional_office_btn">' +
            ...
            '<input readonly type="hidden" id="regional_office_count" name="regional_office_count" value="' + id + '">' +
            '</div>';
    ...
    function addHumanRow() {
        ...
        let rowHTML = `
            <div class="row human_row mb-2" id="human_row_${id}">
                <div class="col-md-3 form-group">
                    <label>पद</label>
                    <select readonly name="post_id[]" id="post_id_${id}" class="form-control">
                        ${postOptions}
                    </select>
                </div>
                ...
                <div class="col-md-3 form-group">
                    ...
                    <input readonly type="number" name="sanctioned_post[]" id="sanctioned_post_${id}" class="form-control">
                </div>

                <div class="col-md-3 form-group">
                    <label>रिक्त पद</label>
                    <input readonly type="number" name="vacant_post[]" id="vacant_post_${id}" class="form-control">
                </div>
...
<script>
    function sec_2_nirmit_godown_add_rows() {
        ...
        txt += '<div class="col-sm-2 form-group"><label>क्षमता (मेट्रिक टन में)</label><input readonly type="text" name="sec_3_b_storage_capacity_' + id + '" id="sec_3_b_storage_capacity_' + id + '" class="form-control chk_number" data-type="क्षमता मेट्रिक टन में भरे"></div>';
        txt += '<div class="col-sm-2 form-group"><label>निर्माण का वर्ष</label><select readonly name="sec_3_b_godown_year_' + id + '" id="sec_3_b_godown_year_' + id + '" class="form-control"><option value="">--Select--</option><option value="1999">2000 से पूर्व</option>';
        for (var a = 2000; a <= 2024; a++) {
            txt += '<option value="' + a + '">' + a + '</option>';
        }
        txt += '</select></div>';

        txt += '<div class="col-sm-2 form-group"><label>WDRA से प्रमाणित है?</label><select readonly name="sec_3_b_wdra_certified_' + id + '" id="sec_3_b_wdra_certified_' + id + '" class="form-control"><option value="">--select--</option><option value="yes">हाँ</option><option value="no">नहीं</option></select></div>';
        txt += '<div class="col-sm-2 form-group"><label>किस योजना के तहत बना है</label><input readonly type="text" name="sec_3_b_godown_type_of_fund_' + id + '" id="sec_3_b_godown_type_of_fund_' + id + '" class="form-control chk_text" data-type="योजना का नाम शब्दों में भरे"></div>';
        txt += '<div class="col-sm-2 form-group"><label>गोदाम की भौतिक स्थिति</label><select readonly name="sec_3_b_godown_status_' + id + '" id="sec_3_b_godown_status_' + id + '" class="form-control"><option value="">--select--</option><option value="good">अच्छा</option><option value="repairable">खराब/मरम्मत योग्य</option><option value="discarded">जर्जर/निष्प्रयोज्य्य</option></select></div>';
        txt += '<div class="col-sm-1 form-group"><label>टिप्पणी</label><input readonly type="text" name="sec_3_b_godown_comment_' + id + '" id="sec_3_b_godown_comment_' + id + '" class="form-control"></div>';
        txt += '<div class="col-sm-1 form-group my-auto" id="sec_2_nirmit_godown_rows"><button type="button" class="btn btn-info" onClick="sec_2_nirmit_godown_add_rows()">नई पंक्ति जोड़े [+]</button><input readonly type="hidden" name="sec_2_nirmit_godown_id" id="sec_2_nirmit_godown_id" value="' + id + '"></div>';
        txt += '</div>';
    ...
    function addEmployeeRow() {
        ...
        row += '<td>' + id + '</td>';
        row += '<td><input readonly type="text" name="employee_post_' + id + '" id="employee_post_' + id + '" class="form-control"></td>';
        row += '<td><input readonly type="text" name="employee_name_' + id + '" id="employee_name_' + id + '" class="form-control"></td>';
        row += '<td><input readonly type="text" name="employee_father_name_' + id + '" id="employee_father_name_' + id + '" class="form-control"></td>';
        row += '<td><input readonly type="text" name="employee_phone_' + id + '" id="employee_phone_' + id + '" class="form-control"></td>';
        row += '</tr>';
    ...
    function addDistrictAddressRow() {
        ...
        tr += '<td>' + id + '</td>';
        tr += '<td><input readonly type="text" name="district_post_' + id + '" class="form-control"></td>';
        tr += '<td><input readonly type="text" name="district_number_' + id + '" class="form-control"></td>';
        tr += '<td><input readonly type="text" name="district_vacant_' + id + '" class="form-control"></td>';
        tr += '<td><input readonly type="text" name="district_approved_' + id + '" class="form-control"></td>';
        tr += '</tr>';
    ...
    function addPurchaseSaleRow() {
        ...
        // Existing rows count
        var id = $("#purchase_sale_tbody tr").length;
        ...
        <tr id="purchase_sale_row_${newId}">
            <td>${newId}</td>
            <td><input readonly type="text" name="wheat_purchase_${newId}" class="form-control"></td>
            <td><input readonly type="text" name="rice_purchase_${newId}" class="form-control"></td>
            <td><input readonly type="text" name="seed_${newId}" class="form-control"></td>
            <td><input readonly type="text" name="fertilizer_${newId}" class="form-control"></td>
            <td><input readonly type="text" name="godown_rent_${newId}" class="form-control"></td>
            <td><input readonly type="text" name="nefed_${newId}" class="form-control"></td>
            <td><input readonly type="text" name="farmer_service_center_${newId}" class="form-control"></td>
            <td><input readonly type="text" name="other_business_${newId}" class="form-control"></td>
        </tr>
    `;

        $("#purchase_sale_tbody").append(row);
        $("#purchase_sale_row_count").val(newId);
    }
    ...
    function stock_add_rows() {
        ...
        txt += '<div class="col-sm-1 form-group"><label>क्रमांक</label>' +
            '<input readonly class="form-control" value="' + id + '" readonly></div>';

        txt += '<div class="col-sm-3 form-group"><label>स्टॉक आइटम</label>' +
            '<input readonly type="text" name="stock_item_' + id + '" id="stock_item_' + id + '" class="form-control"></div>';

        txt += '<div class="col-sm-3 form-group"><label>31 मार्च 2020 को समापन स्टॉक</label>' +
            '<input readonly type="text" name="stock_closing_' + id + '" id="stock_closing_' + id + '" class="form-control"></div>';

        txt += '<div class="col-sm-3 form-group"><label>बुक वैल्यू</label>' +
            '<input readonly type="text" name="stock_book_' + id + '" id="stock_book_' + id + '" class="form-control chk_number"></div>';


        txt += '<div class="col-sm-3 form-group"><label>31 मार्च 2020 को अंतिम स्टॉक</label>' +
            '<input readonly type="text" name="final_stock_' + id + '" id="final_stock_' + id + '" class="form-control"></div>';

        txt += '<div class="col-sm-3 form-group"><label>बुक वैल्यू</label>' +
            '<input readonly type="text" name="final_book_' + id + '" id="final_book_' + id + '" class="form-control chk_number"></div>';
        ...
        txt += '<input readonly type="hidden" id="stock_row_count" name="stock_row_count" value="' + id + '">';
        txt += '</div>';
    ...
    function useless_add_rows() {
        ...
        txt += '<div class="col-sm-3 form-group"><label>वस्तु का नाम</label>' +
            '<input readonly type="text" name="useless_item_' + id + '" id="useless_item_' + id + '" class="form-control"></div>';

        txt += '<div class="col-sm-3 form-group"><label>31 मार्च 2023 को समापन स्टॉक</label>' +
            '<input readonly type="text" name="useless_closing_' + id + '" id="useless_closing_' + id + '" class="form-control"></div>';

        txt += '<div class="col-sm-3 form-group"><label>बुक वैल्यू</label>' +
            '<input readonly type="text" name="useless_book_' + id + '" id="useless_book_' + id + '" class="form-control chk_number"></div>';
        ...
        txt += '<input readonly type="hidden" id="useless_row_count" name="useless_row_count" value="' + id + '">';
        txt += '</div>';
    ...
    function purchase_add_rows() {
        ...
        txt += '<div class="col-sm-1 form-group"><label>क्रमांक</label><input readonly class="form-control" value="' + id + '" readonly></div>';

        txt += '<div class="col-sm-2 form-group"><label>आइटम नंबर</label><input readonly type="text" name="purchase_item_no_' + id + '" id="purchase_item_no_' + id + '" class="form-control"></div>';

        txt += '<div class="col-sm-3 form-group"><label>आइटम विवरण</label><input readonly type="text" name="purchase_item_desc_' + id + '" id="purchase_item_desc_' + id + '" class="form-control"></div>';

        txt += '<div class="col-sm-2 form-group"><label>दिनांक</label><input readonly type="date" name="purchase_date_' + id + '" id="purchase_date_' + id + '" class="form-control"></div>';

        txt += '<div class="col-sm-2 form-group"><label>वैल्यू</label><input readonly type="text" name="purchase_value_' + id + '" id="purchase_value_' + id + '" class="form-control chk_number"></div>';

        txt += '<div class="col-sm-1 form-group"><label>संख्या</label><input readonly type="text" name="purchase_qty_' + id + '" id="purchase_qty_' + id + '" class="form-control chk_number"></div>';
        ...
        txt += '<input readonly type="hidden" id="purchase_row_count" name="purchase_row_count" value="' + id + '">';
        txt += '</div>';
...
<script>
    function sec_3_c_add_rowss() {
        ...
        var txt = '<div class="row mb-2 sec3c_row">' +
            '<div class="col-sm-2 form-group"><label>जनपद</label><select readonly name="sec_3_c_district_' + id + '" class="form-control"><option value="">--Select--</option>' + districtOptions + '</select></div>' +
            '<div class="col-sm-3 form-group"><label>क्षेत्रफल (हेक्टेयर में)</label><input readonly type="text" name="sec_3_c_area_' + id + '" class="form-control"></div>' +
            '<div class="col-sm-3 form-group"><label>स्थान (समिति प्रांगण या अन्य स्थान)</label><select readonly name="sec_3_c_land_location_' + id + '" class="form-control"><option value="">--select--</option><option value="inpremise">समिति प्रांगण</option><option value="other">अन्य स्थान</option></select></div>' +
            '<div class="col-sm-3 form-group"><label>पहुच मार्ग का प्रकार</label><select readonly name="sec_3_c_paved_road_' + id + '" class="form-control"><option value="">--select--</option><option value="ordinary">कच्ची सड़क</option><option value="nh">नेशनल हाईवे</option><option value="sh">स्टेट हाईवे</option><option value="mdr">एम.डी.आर.</option><option value="odr">ओ.डी.आर.</option><option value="rural_road">ग्रामीण सड़क</option><option value="other">अन्य</option></select></div>' +
            '<div class="col-sm-3 form-group"><label>संस्था का फोटो GPS टैग के साथ संलग्न करे</label><input readonly type="file" name="sec_3_c_image_' + id + '" class="form-control"></div>' +
...
<script>
    ...
    function prefillZones(){
        ...
        zoneData.forEach(function(zone,index){
            ...
            row.querySelector("input[name='zone_mobile[]']").value = zone.zone_mobile || "";
    ...
    function prefillOtherOffices(){
        ...
        updateOtherOfficeRows(otherOfficeData.length);
        ...
        otherOfficeData.forEach(function(office,index){
            ...
            row.querySelector("input[name='other_office_mobile[]']").value = office.prakhand_mobile || "";
...
<script>
    ...
    let tbody = document.getElementById("purchase_sale_tbody");

    tbody.innerHTML = "";   // clear anything already inside
    ...
    purchaseData.forEach((row,index)=>{
        ...
        let html = `
<tr id="purchase_sale_row_${rowNo}">

<td>${rowNo}</td>

<td><input readonly type="text" name="wheat_purchase_${rowNo}" class="form-control" value="${row.wheat_purchase ?? ''}"></td>

<td><input readonly type="text" name="rice_purchase_${rowNo}" class="form-control" value="${row.rice_purchase ?? ''}"></td>

<td><input readonly type="text" name="seed_${rowNo}" class="form-control" value="${row.seed ?? ''}"></td>

<td><input readonly type="text" name="fertilizer_${rowNo}" class="form-control" value="${row.fertilizer ?? ''}"></td>

<td><input readonly type="text" name="godown_rent_${rowNo}" class="form-control" value="${row.godown_rent ?? ''}"></td>

<td><input readonly type="text" name="nefed_${rowNo}" class="form-control" value="${row.nefed ?? ''}"></td>

<td><input readonly type="text" name="farmer_service_center_${rowNo}" class="form-control" value="${row.farmer_service_center ?? ''}"></td>

<td><input readonly type="text" name="other_business_${rowNo}" class="form-control" value="${row.other_business ?? ''}"></td>
