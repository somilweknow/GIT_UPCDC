...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($_POST['emp']['name'])) {
        foreach ($_POST['emp']['name'] as $idx => $name) {
            ...
            $normalized_emps[] = [
                ...
                'parent_name' => $_POST['emp']['parent_name'][$idx],
    ...
    if (!empty($_POST['assets_loan']['loan_date'])) {
        foreach ($_POST['assets_loan']['loan_date'] as $idx => $ldate) {
            if (empty($ldate) && empty($_POST['assets_loan']['principal'][$idx])) continue;
            $normalized_assets[] = [
                'loan_date' => $_POST['assets_loan']['loan_date'][$idx],
                'principal' => $_POST['assets_loan']['principal'][$idx],
                'interest' => $_POST['assets_loan']['interest'][$idx],
                'nearby_prop' => $_POST['assets_loan']['nearby_prop'][$idx],
                'khet' => $_POST['assets_loan']['khet'][$idx],
                'cropping' => $_POST['assets_loan']['cropping'][$idx],
                'boundary' => $_POST['assets_loan']['boundary'][$idx],
                'other' => $_POST['assets_loan']['other'][$idx]
            ];
        }
    }
    ...
    if ($is_edit) {
        ...
        $sql = "INSERT INTO cold_storage_entries (
            ...
            has_loan, ncdc_loan, bank_loan, upcb_loan, dcb_loan, other_loan_desc, other_loan_amount, employees_data, employees, assets_loan_data, action_plan, is_approved
        ) VALUES (
...
<div class="row">
        ...
        <div id="historyCard" class="card" style="<?php echo (isset($show_success) && $show_success) ? 'display:none;' : 'display:block;'; ?>">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="card-title text-center" style="font-weight: bold;">निष्क्रिय शीतगृहों की सूचना एवं कार्ययोजना</h4>

                    </div>
                    <div class="col-md-4 text-right">
                        <a href="cold_storage_export.php" class="btn" style="background-color: #10b981; border-color: #10b981; color: white; background-image: none !important; font-size: 14px; padding: 8px 10px; width: 180px; margin-bottom: 5px;">
                            <i class="fa fa-file-excel-o"></i> Export to Excel
                        </a>
                        <?php if (isset($_SESSION['username']) && ($_SESSION['user_type'] == 'ar' || $_SESSION['usertype'] == '3' || $_SESSION['usertype'] == 'sadmin')) { ?>
                            <button id="addNewBtn" class="btn" style="background-color: #007bff; border-color: #007bff; color: white; background-image: none !important; font-size: 14px; padding: 8px 10px; width: 180px;">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group mb-2">
                                <label class="mb-0" style="font-size: 15px; font-weight: bold; color: #333;">मंडल (Mandal)</label>
                                <select name="f_division" id="f_division" class="form-control" onchange="filter_fill_district(this.value);" style="height: 40px !important; font-size: 15px !important; max-width: 100% !important;">
                        ...
                        <div class="col-md-3">
                            <div class="form-group mb-2">
                                <label class="mb-0" style="font-size: 15px; font-weight: bold; color: #333;">जनपद (District)</label>
                                <select name="f_district" id="f_district" class="form-control" onchange="filter_fill_tehseel(this.value);" style="height: 40px  !important; font-size: 15px !important; max-width: 100% !important;">
                                    <option value="">All</option>
                                    <?php
                        ...
                        <div class="col-md-3">
                            <div class="form-group mb-2">
                                <label class="mb-0" style="font-size: 15px; font-weight: bold; color: #333;">तहसील (Tehsil)</label>
                                <select name="f_tehseel" id="f_tehseel" class="form-control" onchange="filter_fill_block(this.value);" style="height: 40px !important; font-size: 15px !important; max-width: 100% !important;">
                                    <option value="">All</option>
                                    <?php
                        ...
                        <div class="col-md-3">
                            <div class="form-group mb-2">
                                <label class="mb-0" style="font-size: 15px; font-weight: bold; color: #333;">विकासखंड (Block)</label>
                                <select name="f_block" id="f_block" class="form-control" style="height: 40px !important; font-size: 15px !important; max-width: 100% !important;">
                                    <option value="">All</option>
                                    <?php
                        ...
                        <div class="col-md-2">
                            <div class="form-group mb-2">
                                <label class="mb-0" style="font-size: 15px; font-weight: bold; color: #333;">शीतगृह की स्थिति</label>
                                <select name="f_building_status" class="form-control" style="height: 40px !important; font-size: 15px !important;">
                                    <option value="">All</option>
                        ...
                        <div class="col-md-2">
                            <div class="form-group mb-2">
                                <label class="mb-0" style="font-size: 15px; font-weight: bold; color: #333;">क्षमता </label>
                                <div class="input-group">
                                    <select name="f_cap_op" class="form-control p-1" style="max-width: 45px !important; height: 40px !important; font-size: 15px !important;">
                                    ...
                                    <input type="number" step="0.01" name="f_capacity" class="form-control" value="<?php echo $_GET['f_capacity'] ?? ''; ?>" style="height: 40px !important; font-size: 15px !important;">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group mb-2">
                                <label class="mb-0" style="font-size: 15px; font-weight: bold; color: #333;">भूमि क्षेत्रफल</label>
                                <div class="input-group">
                                    <select name="f_land_op" class="form-control p-1" style="max-width: 45px !important; height: 40px !important; font-size: 15px !important;">
                                    ...
                                    <input type="number" step="0.0001" name="f_land_area" class="form-control" value="<?php echo $_GET['f_land_area'] ?? ''; ?>" style="height: 40px !important; font-size: 15px !important;">
                                </div>
                            </div>
                        </div>
        ...
        <?php if (isset($_SESSION['username']) && ($_SESSION['user_type'] == 'ar' || $_SESSION['usertype'] == '3' || $_SESSION['usertype'] == 'sadmin')) { ?>
            <div id="formCard" class="card" style="display:none;">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h4 class="card-title text-center" style="font-weight: bold;">शीतगृह विवरण (Cold Storage Details)</h4>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="mb-2">
                                        <input type="text" name="lat" class="form-control" placeholder="Latitude" value="<?php echo isset($row_invoice['latitude']) ? $row_invoice['latitude'] : ''; ?>">
                                    </div>
                                    <div class="mb-2">
                                        <input type="text" name="long" class="form-control" placeholder="Longitude" value="<?php echo isset($row_invoice['longitude']) ? $row_invoice['longitude'] : ''; ?>">
                                    </div>
                                    <div>
                                        <button class="btn btn-success" type="button" style="width: 100%;" onClick="getLocation();">लोकेशन रिफ्रेश करे</button>
                                    </div>
  ...
  margin-right: 10px;">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>भूमि के निर्माण की तिथि</label>
                            <input type="date" name="land_construction_date" class="form-control" value="<?php echo val('land_construction_date'); ?>">
                        </div>
                    </div>
  ...
  margin-right: 10px;">
                    ...
                    <div class="col-md-4 rented_only" style="<?php echo (val('ownership_type') == 'rented') ? 'display:block;' : 'display:none;'; ?>">
                        <div class="form-group">
                    ...
                    <div class="col-md-4" id="ownership_other_div" style="<?php echo (val('ownership_type') == 'other') ? 'display:block;' : 'display:none;'; ?>">
                        <div class="form-group">
                    ...
                    <div class="col-md-4" id="approach_other_div" style="<?php echo (val('approach_road_type') == 'other') ? 'display:block;' : 'display:none;'; ?>">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>सड़क की चौड़ाई (मीटर में)</label>
                            <input type="number" step="0.01" name="road_width" class="form-control" value="<?php echo val('road_width'); ?>">
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
                            <label>ए.आर. द्वारा व्यावसायिक विचार</label>
                            <textarea name="ar_business_idea" class="form-control"><?php echo val('ar_business_idea'); ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div style="margin-bottom: 20px; margin-left: 10px; margin-right: 10px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 elec_yes_row" style="<?php echo (val('elec_conn') == 'yes') ? 'display:block;' : 'display:none;'; ?>">
                            <div class="form-group">
                        ...
                        <div class="col-md-4 elec_no_row" style="<?php echo (val('elec_conn') == 'no') ? 'display:block;' : 'display:none;'; ?>">
                            <div class="form-group">
                        ...
                        <!-- Show if working NO -->
                        <div class="col-md-4 elec_working_no" style="<?php echo (val('elec_working') == 'no') ? 'display:block;' : 'display:none;'; ?>">
                            <div class="form-group">
                        ...
                        <!-- Show if working YES -->
                        <div class="col-md-4 elec_working_yes" style="<?php echo (val('elec_working') == 'yes') ? 'display:block;' : 'display:none;'; ?>">
                            <div class="form-group">
  ...
  margin-right: 10px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 solar_yes_row" style="<?php echo (val('solar_conn') == 'yes') ? 'display:block;' : 'display:none;'; ?>">
                            <div class="form-group">
                                <label>यदि है तो चालू है या नहीं ?</label>
                        ...
                        <div class="col-md-4 solar_working_yes" style="<?php echo (val('solar_working') == 'yes') ? 'display:block;' : 'display:none;'; ?>">
                            <div class="form-group">
                ...
                <div style="margin-bottom: 20px; margin-left: 10px;
  margin-right: 10px;">
                    <h6 style="font-weight: bold; border-bottom: 1px solid #eee; padding-bottom: 5px; color: #333;">(III) इंटरनेट कनेक्शन</h6>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4 internet_yes_row" style="<?php echo (val('internet_conn') == 'yes') ? 'display:block;' : 'display:none;'; ?>">
                            <div class="form-group">
  ...
  margin-right: 10px;">
                ...
                <h5 class="section-title"></i> 5. क्या शीतगृह मैं कोई ऋण हैं?</h5>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <hr>
                        <label style="font-weight: bold; font-size: 15px; color: #333;">Assets & Loan History (एसेट्स एवं ऋण विवरण):</label>
                        <div class="table-responsive" >
                            <table class="table table-bordered" id="assets_loan_table">
                                <thead class="bg-light">
                                    <tr style="background:#fef3e2">
                                        ...
                                        <th>ब्याज धनराशि (₹)</th>
                                        <th>ब्याज अवशेष (₹)</th>
                                        <th>समिति के कार्यक्षेत्र की जनसंख्या कितनी है?</th>
                                        <th>खेत कितने हैं?</th>
                                        <th>बाउंड्री वॉल</th>
                                        <th>अन्य संपत्ति</th>
                                        <th>एक्शन</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($assets_data as $ad): ?>
                                        <tr>
                                            <td><input type="date" step="0.01" name="assets_loan[loan_date][]" class="form-control" value="<?php echo isset($ad['loan_date']) ? $ad['loan_date'] : ''; ?>"></td>
                                            <td><input type="number" step="0.01" name="assets_loan[principal_amt][]" class="form-control" value="<?php echo isset($ad['principal_amt']) ? $ad['principal_amt'] : ''; ?>" placeholder="0.00"></td>
                                            <td><input type="number" step="0.01" name="assets_loan[principal_pending][]" class="form-control" value="<?php echo isset($ad['principal_pending']) ? $ad['principal_pending'] : ''; ?>" placeholder="0.00"></td>
                                            <td><input type="number" step="0.01" name="assets_loan[interest_amt][]" class="form-control" value="<?php echo isset($ad['interest_amt']) ? $ad['interest_amt'] : ''; ?>" placeholder="0.00"></td>
                                            <td><input type="number" step="0.01" name="assets_loan[interest_pending][]" class="form-control" value="<?php echo isset($ad['interest_pending']) ? $ad['interest_pending'] : ''; ?>" placeholder="0.00"></td>
                                            <td><input type="text" name="assets_loan[population][]" class="form-control" value="<?php echo isset($ad['population']) ? $ad['population'] : ''; ?>"></td>
                                            <td><input type="text" name="assets_loan[land_area][]" class="form-control" value="<?php echo isset($ad['land_area']) ? $ad['land_area'] : ''; ?>"></td>
                                            <td>
                                                <select name="assets_loan[boundary][]" class="form-control">
                                                    <option value="yes" <?php if (isset($ad['boundary']) && $ad['boundary'] == 'yes') echo 'selected'; ?>>हाँ</option>
                                                    <option value="no" <?php if (isset($ad['boundary']) && $ad['boundary'] == 'no') echo 'selected'; ?>>नहीं</option>
                                                </select>
                                            </td>
                                            <td><input type="text" name="assets_loan[other][]" class="form-control" value="<?php echo isset($ad['other']) ? $ad['other'] : ''; ?>"></td>
                        ...
                        <button type="button" class="btn btn-success btn-sm mb-3" onclick="addAssetsLoanRow()"><i class="fa fa-plus"></i> नई लाइन जोड़ें (Add Asset/Loan)</button>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <table class="table table-bordered" id="employee_table" style="margin-left: 10px;margin-right: 10px;">
                            <thead class="bg-light">
                                <tr>
                                    <th>पदनाम</th>
                                    <th>नाम</th>
                        ...
                        <button type="button" class="btn btn-success btn-sm mb-3" onclick="addEmployeeRow()"><i class="fa fa-plus"></i> कर्मचारी जोड़ें</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-primary btn-fill"><i class="fa fa-save"></i> सुरक्षित करें (Submit)</button>
                </div>
                </form>
...
<script>
    ...
    function addAssetsLoanRow() {
        var row = `<tr>
            ...
            <td><input type="text" name="assets_loan[population][]" class="form-control"></td>
            <td><input type="text" name="assets_loan[land_area][]" class="form-control"></td>
            <td>
                <select name="assets_loan[boundary][]" class="form-control">
            ...
            <td><input type="text" name="assets_loan[other][]" class="form-control"></td>
            <td><button type="button" class="btn btn-danger btn-sm" onclick="$(this).closest('tr').remove()"><i class="fa fa-times"></i></button></td>
        </tr>`;
