            ...
            <div class="card-body">
                <div class="row d-flex my-auto">
                    <div class="col-md-12">
                        ...
                        <form action="scripts/ajax_upcldf.php" method="post" enctype="multipart/form-data"
                            ...
                            <div id="steps-container">
                                ...
                                <!-- <div class="step"> -->
                                    ...
                                    <div class="col-sm-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        ...
                                                        <input readonly type="text" id="long" disabled="disabled"
                                                               ...
                                                               class="form-control">
                                                        <button disabled type="button" class="btn btn-info btn-sm mt-2"
                                        ...
                                        <div class="table-responsive" id="zoneTableWrapper">
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>ई-मेल आई.डी.</th>
                                                    <th>पता</th>
                                                    <th>जोन की फोटो GPS टैग के संलग्न करें</th>
                                                </tr>
                                                </thead>
                                                <tbody id="zoneTbody">
                                                <?php
                                        ...
                                        <div class="table-responsive" id="prakhandTableWrapper">
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>ई-मेल आई.डी.</th>
                                                    <th>पता</th>
                                                    <th>प्रखण्ड की फोटो GPS टैग के संलग्न करें</th>
                                                </tr>
                                                </thead>
                                        ...
                                        <h5
                                                style="background: linear-gradient(135deg, #e3f2fd 0%, #bbdefb 100%); padding: 12px 20px; border-radius: 8px; font-weight: bold; color: #1565c0; margin: 20px 0 15px 0; border-left: 4px solid #1976d2;">
                                            1.2 संस्था के सदस्यों का विवरण</h5>
                                        <br>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3 form-group">
                                                    ...
                                                    <input readonly type="text" name="indivisual_members" id="indivisual_members"
                                                           tabindex="<?php echo $tab++; ?>" class="form-control"
                                                           value="<?php echo ($row_invoice['indivisual_members']); ?>">
                                                </div>
                                                <div class="col-sm-3 form-group">
                                                    <label>सदस्य समितियो कि संख्या</label>
                                                    <input readonly type="text" name="committee_members" id="committee_members"
                                                           tabindex="<?php echo $tab++; ?>" class="form-control"
                                                           value="<?php echo ($row_invoice['committee_members']); ?>">
                                                </div>
                                                <div class="col-sm-3 form-group">
                                                    <label>केंद्रीय समितियो की संख्या</label>
                                                    <input readonly type="text" name="central_soc_members"
                                                ...
                                                <div class="col-sm-3 form-group">
                                                    ...
                                                    <input readonly type="text" name="primary_soc_members"
                                                ...
                                                <!-- <div class="col-sm-3 form-group">
                                                    <label>सदस्य समितियो कि संख्या</label>
                                                    <select readonly name="samiti_prakar" id="samiti_prakar"
                                                ...
                                                <div class="col-sm-3 form-group" id="sankhya_div" style="display:none;">
                                                    ...
                                                    <input readonly type="text" name="samiti_sankhya" id="samiti_sankhya"
                                                ...
                                                <!-- <div class="col-sm-3 form-group">
                                                    ...
                                                    <input readonly type="text" name="inactive_members_no"
                            ...
                            <div id="success">
                                ...
                                <div class="col-sm-12 form-group my-auto" id="send_otp_button2" style="display: none">
                                    <button type="button" name="verify_otp_btn" id="verify_otp_btn"
                                            ...
                                            onClick="verify_otp_upcldf($('#survey_id').val());">आगे प्रेषित करे
                                    </button>
                                </div>
                            </div>
                    </div>
                ...
                <!-- <div id="q-box__buttons" class="text-center">
                    ...
                    <button id="submit-btn" class="btn btn-danger" type="submit" onClick="validate_input(); save_draft();">Submit</button>
                </div> -->
                ...
                <input type="hidden" id="id" name="id" value="submit_form_upcldf">
    ...
    function updateOfficeRows(count) {
        ...
        if (count > current) {
            for (var i = current; i < count; i++) {
                ...
                row.innerHTML = `
                <td><input readonly type="text" name="zone_name[]" class="form-control"></td>
                <td><input readonly type="text" name="zone_mobile[]" class="form-control"></td>
                <td><input readonly type="text" name="zone_email[]" class="form-control"></td>
                <td><input readonly type="text" name="zone_address[]" class="form-control"></td>
    ...
    function updateSeparatePrakhandRows(count) {
        ...
        if (count > current) {
            for (var i = current; i < count; i++) {
                ...
                row.innerHTML = `
                <td><input readonly type="text" name="prakhand_name[]" class="form-control" placeholder="प्रखण्ड का नाम"></td>
                <td><input readonly type="text" name="prakhand_mobile[]" class="form-control" placeholder="प्रखण्ड का दूरभाष"></td>
                <td><input readonly type="text" name="prakhand_email[]" class="form-control" placeholder="प्रखण्ड का ईमेल"></td>
                <td><input readonly type="text" name="prakhand_address[]" class="form-control" placeholder="प्रखण्ड का पता"></td>
