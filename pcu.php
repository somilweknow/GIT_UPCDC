                        ...
                        <form action="scripts/ajax_pcu.php" method="post" enctype="multipart/form-data" id="user_form"
                            ...
                            <div id="steps-container">
                                    ...
                                    <div class="col-sm-12">
                                                ...
                                                <thead>
                                                    <tr class="bg-light">
                                                        <th width="15%" style="color: black; font-weight: bold;">
                                                            ट्रेनिंग सेंटर का नाम</th>
                                                        <th width="15%" style="color: black; font-weight: bold;">
                                                            ट्रेनिंग सेंटर का दूरभाष न०</th>
                                                        <th width="20%" style="color: black; font-weight: bold;">
                                                            ट्रेनिंग सेंटर का ई-मेल आई.डी.</th>
                                                        <th width="20%" style="color: black; font-weight: bold;">
                                                            ट्रेनिंग सेंटर का पता</th>
                                        ...
                                        <div class="table-responsive" id="otherOfficeTableWrapper"
                                            ...
                                            <table class="table table-bordered" id="otherOfficeContainer"
                                                ...
                                                <thead>
                                                    <tr class="bg-light">
                                                        <th width="15%" style="color: black; font-weight: bold;">अन्य
                                                            कार्यालयों का नाम</th>
                                                        <th width="15%" style="color: black; font-weight: bold;">अन्य
                                                            कार्यालयों का दूरभाष न०</th>
                                                        <th width="20%" style="color: black; font-weight: bold;">अन्य
                                                            कार्यालयों का ई-मेल आई.डी.</th>
                                                        <th width="20%" style="color: black; font-weight: bold;">अन्य
                                                            कार्यालयों का पता</th>
                                ...
                                <!-- <div class="step"> -->
                                                    ...
                                                    <tr class="business_matrix_row" id="business_row_<?php echo $i; ?>">
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <button type="button" class="btn btn-info btn-sm"
                                                                onclick="add_more_business();">+</button>
                                    ...
                                    <!-- <h4> <img src="images/logo/2.png" class="img-fluid stat-icon"
                                            style="height:50px; width:50px;"> 4. शाखाओं / ट्रेनिंग सेंटर / अन्य
                                        कार्यालयों का विवरण </h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12">
                                        <h5>
                                            ...
                                            4.1. सहकारी प्रबंध प्रशिक्षण केंद्र
                                        </h5>
                                ...
                                <!-- <div class="step"> -->
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <br>
                                        <h5><img src="images/logo/7.png" class="img-fluid stat-icon"
                                                style="height:50px; width:50px;"> 5.1. प्रबंध कमेटी</h5>
                                        <div class="row">
                                            <div class="col-sm-3 form-group">
                                                <label>श्रेणी</label>
