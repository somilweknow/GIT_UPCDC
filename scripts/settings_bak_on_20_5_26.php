...
//                        in_array($_SESSION['user_type'], ['ncd_admin'])
//                    ): ?>
<!---->
...
<!--                    --><?php //if (
//                        isset($_SESSION['user_type']) &&
//                        in_array($_SESSION['user_type'], ['ncd_checker'])
//                    ): ?>
<!---->
<!--                        <li class="nav-item active">-->
<!--                            <a class="nav-link"-->
...
<!--                    --><?php //endif; ?>
                    ...
                    <?php if (
                        isset($_SESSION['user_type']) &&
                        in_array($_SESSION['user_type'], ['ncd_admin', 'ncd_checker', 'ncd_maker', 'sadmin'])
                    ): ?>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="ncdUserManagement">
                                ...
                                <ul class="nav">
                                    ...
                                    <?php if ($_SESSION['user_type'] === 'ncd_admin'): ?>
                                    ...
                                    <?php if ($_SESSION['user_type'] === 'ncd_checker'): ?>
